...
public class Router extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Router\",\"namespace\":\"converTor.relay\",\"fields\":[{\"name\":\"nickname\",\"type\":[\"null\",\"string\"]},{\"name\":\"address\",\"type\":[\"null\",\"string\"]},{\"name\":\"or_port\",\"type\":[\"null\",\"int\"]},{\"name\":\"socks_port\",\"type\":[\"null\",\"int\"]},{\"name\":\"dir_port\",\"type\":[\"null\",\"int\"]}]}");
  ...
  public static converTor.relay.Router.Builder newBuilder() {
    return new converTor.relay.Router.Builder();
  }
  
  /** Creates a new Router RecordBuilder by copying an existing Builder */
  public static converTor.relay.Router.Builder newBuilder(converTor.relay.Router.Builder other) {
    return new converTor.relay.Router.Builder(other);
  }
  
  /** Creates a new Router RecordBuilder by copying an existing Router instance */
  public static converTor.relay.Router.Builder newBuilder(converTor.relay.Router other) {
    return new converTor.relay.Router.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Router>
    ...
    private Builder() {
      super(converTor.relay.Router.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(converTor.relay.Router.Builder other) {
      super(other);
    ...
    private Builder(converTor.relay.Router other) {
            super(converTor.relay.Router.SCHEMA$);
      if (isValidValue(fields()[0], other.nickname)) {
        this.nickname = data().deepCopy(fields()[0].schema(), other.nickname);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'nickname' field */
    public converTor.relay.Router.Builder setNickname(java.lang.CharSequence value) {
    ...
    public converTor.relay.Router.Builder clearNickname() {
      nickname = null;
    ...
    /** Sets the value of the 'address' field */
    public converTor.relay.Router.Builder setAddress(java.lang.CharSequence value) {
    ...
    public converTor.relay.Router.Builder clearAddress() {
      address = null;
    ...
    /** Sets the value of the 'or_port' field */
    public converTor.relay.Router.Builder setOrPort(java.lang.Integer value) {
    ...
    public converTor.relay.Router.Builder clearOrPort() {
      or_port = null;
    ...
    /** Sets the value of the 'socks_port' field */
    public converTor.relay.Router.Builder setSocksPort(java.lang.Integer value) {
    ...
    public converTor.relay.Router.Builder clearSocksPort() {
      socks_port = null;
    ...
    /** Sets the value of the 'dir_port' field */
    public converTor.relay.Router.Builder setDirPort(java.lang.Integer value) {
    ...
    public converTor.relay.Router.Builder clearDirPort() {
      dir_port = null;
