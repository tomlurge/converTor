...
public class OrAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrAddress\",\"namespace\":\"converTor.relay\",\"fields\":[{\"name\":\"adress\",\"type\":\"string\"},{\"name\":\"port\",\"type\":\"int\"}]}");
  ...
  public static converTor.relay.OrAddress.Builder newBuilder() {
    return new converTor.relay.OrAddress.Builder();
  }
  
  /** Creates a new OrAddress RecordBuilder by copying an existing Builder */
  public static converTor.relay.OrAddress.Builder newBuilder(converTor.relay.OrAddress.Builder other) {
    return new converTor.relay.OrAddress.Builder(other);
  }
  
  /** Creates a new OrAddress RecordBuilder by copying an existing OrAddress instance */
  public static converTor.relay.OrAddress.Builder newBuilder(converTor.relay.OrAddress other) {
    return new converTor.relay.OrAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrAddress>
    ...
    private Builder() {
      super(converTor.relay.OrAddress.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(converTor.relay.OrAddress.Builder other) {
      super(other);
    ...
    private Builder(converTor.relay.OrAddress other) {
            super(converTor.relay.OrAddress.SCHEMA$);
      if (isValidValue(fields()[0], other.adress)) {
        this.adress = data().deepCopy(fields()[0].schema(), other.adress);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'adress' field */
    public converTor.relay.OrAddress.Builder setAdress(java.lang.CharSequence value) {
    ...
    public converTor.relay.OrAddress.Builder clearAdress() {
      adress = null;
    ...
    /** Sets the value of the 'port' field */
    public converTor.relay.OrAddress.Builder setPort(int value) {
    ...
    public converTor.relay.OrAddress.Builder clearPort() {
