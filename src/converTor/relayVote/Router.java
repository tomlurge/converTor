...
public class Router extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Router(converTor.relayVote.R r, java.util.List<java.lang.CharSequence> a, java.util.List<java.lang.CharSequence> s, java.lang.CharSequence v, converTor.relayVote.W w, converTor.relayVote.Policy p, java.lang.CharSequence id) {
    this.r = r;
    this.a = a;
    this.s = s;
    this.v = v;
  ...
  public static converTor.relayVote.Router.Builder newBuilder() {
    return new converTor.relayVote.Router.Builder();
  }
  
  /** Creates a new Router RecordBuilder by copying an existing Builder */
  public static converTor.relayVote.Router.Builder newBuilder(converTor.relayVote.Router.Builder other) {
    return new converTor.relayVote.Router.Builder(other);
  }
  
  /** Creates a new Router RecordBuilder by copying an existing Router instance */
  public static converTor.relayVote.Router.Builder newBuilder(converTor.relayVote.Router other) {
    return new converTor.relayVote.Router.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Router>
    ...
    private Builder() {
      super(converTor.relayVote.Router.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(converTor.relayVote.Router.Builder other) {
      super(other);
    ...
    private Builder(converTor.relayVote.Router other) {
            super(converTor.relayVote.Router.SCHEMA$);
      if (isValidValue(fields()[0], other.r)) {
        this.r = data().deepCopy(fields()[0].schema(), other.r);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'r' field */
    public converTor.relayVote.Router.Builder setR(converTor.relayVote.R value) {
    ...
    public converTor.relayVote.Router.Builder clearR() {
      r = null;
    ...
    /** Sets the value of the 'a' field */
    public converTor.relayVote.Router.Builder setA(java.util.List<java.lang.CharSequence> value) {
    ...
    public converTor.relayVote.Router.Builder clearA() {
      a = null;
    ...
    /** Sets the value of the 's' field */
    public converTor.relayVote.Router.Builder setS(java.util.List<java.lang.CharSequence> value) {
    ...
    public converTor.relayVote.Router.Builder clearS() {
      s = null;
    ...
    /** Sets the value of the 'v' field */
    public converTor.relayVote.Router.Builder setV(java.lang.CharSequence value) {
    ...
    public converTor.relayVote.Router.Builder clearV() {
      v = null;
    ...
    /** Sets the value of the 'w' field */
    public converTor.relayVote.Router.Builder setW(converTor.relayVote.W value) {
    ...
    public converTor.relayVote.Router.Builder clearW() {
      w = null;
    ...
    /** Sets the value of the 'p' field */
    public converTor.relayVote.Router.Builder setP(converTor.relayVote.Policy value) {
    ...
    public converTor.relayVote.Router.Builder clearP() {
      p = null;
    ...
    /** Sets the value of the 'id' field */
    public converTor.relayVote.Router.Builder setId(java.lang.CharSequence value) {
    ...
    public converTor.relayVote.Router.Builder clearId() {
      id = null;
