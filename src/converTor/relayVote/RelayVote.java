...
public class RelayVote extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<converTor.relayVote.Router> router_status;
   ...
   */
  public RelayVote(java.lang.CharSequence descriptor_type, java.lang.Integer network_status_version, java.lang.Integer vote_status, java.util.List<java.lang.Integer> consensus_methods, java.lang.CharSequence published, java.lang.CharSequence valid_after, converTor.relayVote.FlagTresholds flag_tresholds, java.lang.CharSequence fresh_until, java.lang.CharSequence valid_until, converTor.relayVote.Vote voting_delay, java.util.List<java.lang.CharSequence> client_versions, java.util.List<java.lang.CharSequence> server_versions, java.util.List<java.lang.CharSequence> known_flags, java.util.Map<java.lang.CharSequence,java.lang.Integer> params, converTor.relayVote.DirSource dir_source, java.lang.CharSequence contact, java.lang.CharSequence legacy_dir_key, converTor.relayVote.DirKey directory_key, java.util.List<converTor.relayVote.Router> router_status, converTor.relayVote.DirFooter directory_footer) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 18: router_status = (java.util.List<converTor.relayVote.Router>)value$; break;
   ...
   */
  public java.util.List<converTor.relayVote.Router> getRouterStatus() {
   ...
   * @param value the value to set.
   */
  public void setRouterStatus(java.util.List<converTor.relayVote.Router> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RelayVote>
    ...
    private java.util.List<converTor.relayVote.Router> router_status;
    ...
    /** Sets the value of the 'vote_status' field */
    public converTor.relayVote.RelayVote.Builder setVoteStatus(java.lang.Integer value) {
    ...
    /** Sets the value of the 'router_status' field */
    public converTor.relayVote.RelayVote.Builder setRouterStatus(java.util.List<converTor.relayVote.Router> value) {
    ...
    public converTor.relayVote.RelayVote.Builder clearRouterStatus() {
      router_status = null;
    ...
    public RelayVote build() {
      try {
        ...
        record.router_status = fieldSetFlags()[18] ? this.router_status : (java.util.List<converTor.relayVote.Router>) defaultValue(fields()[18]);
