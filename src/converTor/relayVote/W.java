...
public class W extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"W\",\"namespace\":\"converTor.relayVote\",\"fields\":[{\"name\":\"bandwidth\",\"type\":[\"null\",\"long\"]},{\"name\":\"measured\",\"type\":[\"null\",\"long\"]},{\"name\":\"unmeasured\",\"type\":[\"null\",\"boolean\"]}]}");
  ...
  public static converTor.relayVote.W.Builder newBuilder() {
    return new converTor.relayVote.W.Builder();
  }
  
  /** Creates a new W RecordBuilder by copying an existing Builder */
  public static converTor.relayVote.W.Builder newBuilder(converTor.relayVote.W.Builder other) {
    return new converTor.relayVote.W.Builder(other);
  }
  
  /** Creates a new W RecordBuilder by copying an existing W instance */
  public static converTor.relayVote.W.Builder newBuilder(converTor.relayVote.W other) {
    return new converTor.relayVote.W.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<W>
    ...
    private Builder() {
      super(converTor.relayVote.W.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(converTor.relayVote.W.Builder other) {
      super(other);
    ...
    private Builder(converTor.relayVote.W other) {
            super(converTor.relayVote.W.SCHEMA$);
      if (isValidValue(fields()[0], other.bandwidth)) {
        this.bandwidth = data().deepCopy(fields()[0].schema(), other.bandwidth);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'bandwidth' field */
    public converTor.relayVote.W.Builder setBandwidth(java.lang.Long value) {
    ...
    public converTor.relayVote.W.Builder clearBandwidth() {
      bandwidth = null;
    ...
    /** Sets the value of the 'measured' field */
    public converTor.relayVote.W.Builder setMeasured(java.lang.Long value) {
    ...
    public converTor.relayVote.W.Builder clearMeasured() {
      measured = null;
    ...
    /** Sets the value of the 'unmeasured' field */
    public converTor.relayVote.W.Builder setUnmeasured(java.lang.Boolean value) {
    ...
    public converTor.relayVote.W.Builder clearUnmeasured() {
      unmeasured = null;
