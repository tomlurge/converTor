...
public class WriteHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4413473574706203932L;
   ...
   */
  public static converTor.encoders.java.relay.WriteHistory.Builder newBuilder() {
    return new converTor.encoders.java.relay.WriteHistory.Builder();
  }
   ...
   * @return A new WriteHistory RecordBuilder
   */
  public static converTor.encoders.java.relay.WriteHistory.Builder newBuilder(converTor.encoders.java.relay.WriteHistory.Builder other) {
    return new converTor.encoders.java.relay.WriteHistory.Builder(other);
  }
   ...
   * @return A new WriteHistory RecordBuilder
   */
  public static converTor.encoders.java.relay.WriteHistory.Builder newBuilder(converTor.encoders.java.relay.WriteHistory other) {
    return new converTor.encoders.java.relay.WriteHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WriteHistory>
    ...
    private Builder() {
      super(converTor.encoders.java.relay.WriteHistory.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relay.WriteHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relay.WriteHistory other) {
            super(converTor.encoders.java.relay.WriteHistory.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relay.WriteHistory.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relay.WriteHistory.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relay.WriteHistory.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relay.WriteHistory.Builder clearInterval() {
      interval = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relay.WriteHistory.Builder setBytes(java.util.List<java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relay.WriteHistory.Builder clearBytes() {
      bytes = null;
