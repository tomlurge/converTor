...
public class OrAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 168624784982238265L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrAddress\",\"namespace\":\"converTor.encoders.java.relay\",\"fields\":[{\"name\":\"address\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"implementation specific\"},{\"name\":\"port\",\"type\":[\"null\",\"int\"],\"doc\":\"implementation specific\"}]}");
   ...
   */
  public static converTor.encoders.java.relay.OrAddress.Builder newBuilder() {
    return new converTor.encoders.java.relay.OrAddress.Builder();
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static converTor.encoders.java.relay.OrAddress.Builder newBuilder(converTor.encoders.java.relay.OrAddress.Builder other) {
    return new converTor.encoders.java.relay.OrAddress.Builder(other);
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static converTor.encoders.java.relay.OrAddress.Builder newBuilder(converTor.encoders.java.relay.OrAddress other) {
    return new converTor.encoders.java.relay.OrAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrAddress>
    ...
    private Builder() {
      super(converTor.encoders.java.relay.OrAddress.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relay.OrAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relay.OrAddress other) {
            super(converTor.encoders.java.relay.OrAddress.SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relay.OrAddress.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relay.OrAddress.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relay.OrAddress.Builder setPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relay.OrAddress.Builder clearPort() {
      port = null;
