...
public class HidservDirOnionsSeen extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 821296918048695593L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"HidservDirOnionsSeen\",\"namespace\":\"converTor.encoders.java.relayExtra\",\"fields\":[{\"name\":\"onions\",\"type\":[\"null\",\"double\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: Double getHidservDirOnionsSeen()\"},{\"name\":\"obfuscation\",\"type\":[\"null\",{\"type\":\"map\",\"values\":\"double\",\"avro.java.string\":\"String\"}],\"doc\":\"metrics-lib/ExtraInfoDescriptor: Map<String, Double> getHidservDirOnionsSeenParameters()\"}]}");
   ...
   */
  public static converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder newBuilder() {
    return new converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder();
  }
   ...
   * @return A new HidservDirOnionsSeen RecordBuilder
   */
  public static converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder newBuilder(converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder other) {
    return new converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder(other);
  }
   ...
   * @return A new HidservDirOnionsSeen RecordBuilder
   */
  public static converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder newBuilder(converTor.encoders.java.relayExtra.HidservDirOnionsSeen other) {
    return new converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservDirOnionsSeen>
    ...
    private Builder() {
      super(converTor.encoders.java.relayExtra.HidservDirOnionsSeen.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayExtra.HidservDirOnionsSeen other) {
            super(converTor.encoders.java.relayExtra.HidservDirOnionsSeen.SCHEMA$);
      if (isValidValue(fields()[0], other.onions)) {
        this.onions = data().deepCopy(fields()[0].schema(), other.onions);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder setOnions(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder clearOnions() {
      onions = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder setObfuscation(java.util.Map<java.lang.String,java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.HidservDirOnionsSeen.Builder clearObfuscation() {
      obfuscation = null;
