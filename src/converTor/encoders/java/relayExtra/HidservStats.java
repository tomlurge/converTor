...
public class HidservStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 955292053557886027L;
   ...
   * @param date metrics-lib/ExtraInfoDescriptor: long getHidservStatsEndMillis()
   * @param interval metrics-lib/ExtraInfoDescriptor: long getHidservStatsIntervalLength()
   */
  public HidservStats(java.lang.Long date, java.lang.Long interval) {
    this.date = date;
   ...
   * @return metrics-lib/ExtraInfoDescriptor: long getHidservStatsEndMillis()
   */
   ...
   * @return metrics-lib/ExtraInfoDescriptor: long getHidservStatsIntervalLength()
   */
   ...
   */
  public static converTor.encoders.java.relayExtra.HidservStats.Builder newBuilder() {
    return new converTor.encoders.java.relayExtra.HidservStats.Builder();
  }
   ...
   * @return A new HidservStats RecordBuilder
   */
  public static converTor.encoders.java.relayExtra.HidservStats.Builder newBuilder(converTor.encoders.java.relayExtra.HidservStats.Builder other) {
    return new converTor.encoders.java.relayExtra.HidservStats.Builder(other);
  }
   ...
   * @return A new HidservStats RecordBuilder
   */
  public static converTor.encoders.java.relayExtra.HidservStats.Builder newBuilder(converTor.encoders.java.relayExtra.HidservStats other) {
    return new converTor.encoders.java.relayExtra.HidservStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservStats>
    ...
    private Builder() {
      super(converTor.encoders.java.relayExtra.HidservStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayExtra.HidservStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayExtra.HidservStats other) {
            super(converTor.encoders.java.relayExtra.HidservStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.HidservStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.HidservStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.HidservStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.HidservStats.Builder clearInterval() {
      interval = null;
