...
public class DirreqReadHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static converTor.encoders.java.relayExtra.DirreqReadHistory.Builder newBuilder() {
    return new converTor.encoders.java.relayExtra.DirreqReadHistory.Builder();
  }
   ...
   * @return A new DirreqReadHistory RecordBuilder
   */
  public static converTor.encoders.java.relayExtra.DirreqReadHistory.Builder newBuilder(converTor.encoders.java.relayExtra.DirreqReadHistory.Builder other) {
    return new converTor.encoders.java.relayExtra.DirreqReadHistory.Builder(other);
  }
   ...
   * @return A new DirreqReadHistory RecordBuilder
   */
  public static converTor.encoders.java.relayExtra.DirreqReadHistory.Builder newBuilder(converTor.encoders.java.relayExtra.DirreqReadHistory other) {
    return new converTor.encoders.java.relayExtra.DirreqReadHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirreqReadHistory>
    ...
    private Builder() {
      super(converTor.encoders.java.relayExtra.DirreqReadHistory.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayExtra.DirreqReadHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayExtra.DirreqReadHistory other) {
            super(converTor.encoders.java.relayExtra.DirreqReadHistory.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.DirreqReadHistory.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.DirreqReadHistory.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.DirreqReadHistory.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.DirreqReadHistory.Builder clearInterval() {
      interval = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.DirreqReadHistory.Builder setBytes(java.util.List<java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.DirreqReadHistory.Builder clearBytes() {
      bytes = null;
