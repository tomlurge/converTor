...
public class ExitStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7867497619521384274L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ExitStats\",\"namespace\":\"converTor.encoders.java.relayExtra\",\"fields\":[{\"name\":\"date\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getExitStatsEndMillis()\"},{\"name\":\"interval\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getExitStatsIntervalLength()\"}]}");
   ...
   */
  public static converTor.encoders.java.relayExtra.ExitStats.Builder newBuilder() {
    return new converTor.encoders.java.relayExtra.ExitStats.Builder();
  }
   ...
   * @return A new ExitStats RecordBuilder
   */
  public static converTor.encoders.java.relayExtra.ExitStats.Builder newBuilder(converTor.encoders.java.relayExtra.ExitStats.Builder other) {
    return new converTor.encoders.java.relayExtra.ExitStats.Builder(other);
  }
   ...
   * @return A new ExitStats RecordBuilder
   */
  public static converTor.encoders.java.relayExtra.ExitStats.Builder newBuilder(converTor.encoders.java.relayExtra.ExitStats other) {
    return new converTor.encoders.java.relayExtra.ExitStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExitStats>
    ...
    private Builder() {
      super(converTor.encoders.java.relayExtra.ExitStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayExtra.ExitStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayExtra.ExitStats other) {
            super(converTor.encoders.java.relayExtra.ExitStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.ExitStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.ExitStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.ExitStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayExtra.ExitStats.Builder clearInterval() {
      interval = null;
