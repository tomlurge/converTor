...
public class Vote extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7417326607315814533L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Vote\",\"namespace\":\"converTor.encoders.java.relayVote\",\"fields\":[{\"name\":\"vote_seconds\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/RelayNetworkStatusVote: long getVoteSeconds()\"},{\"name\":\"dist_seconds\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/RelayNetworkStatusVote: long getDistSeconds()\"}]}");
   ...
   */
  public static converTor.encoders.java.relayVote.Vote.Builder newBuilder() {
    return new converTor.encoders.java.relayVote.Vote.Builder();
  }
   ...
   * @return A new Vote RecordBuilder
   */
  public static converTor.encoders.java.relayVote.Vote.Builder newBuilder(converTor.encoders.java.relayVote.Vote.Builder other) {
    return new converTor.encoders.java.relayVote.Vote.Builder(other);
  }
   ...
   * @return A new Vote RecordBuilder
   */
  public static converTor.encoders.java.relayVote.Vote.Builder newBuilder(converTor.encoders.java.relayVote.Vote other) {
    return new converTor.encoders.java.relayVote.Vote.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Vote>
    ...
    private Builder() {
      super(converTor.encoders.java.relayVote.Vote.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayVote.Vote.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayVote.Vote other) {
            super(converTor.encoders.java.relayVote.Vote.SCHEMA$);
      if (isValidValue(fields()[0], other.vote_seconds)) {
        this.vote_seconds = data().deepCopy(fields()[0].schema(), other.vote_seconds);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.Vote.Builder setVoteSeconds(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.Vote.Builder clearVoteSeconds() {
      vote_seconds = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.Vote.Builder setDistSeconds(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.Vote.Builder clearDistSeconds() {
      dist_seconds = null;
