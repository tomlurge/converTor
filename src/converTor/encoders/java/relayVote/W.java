...
public class W extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static converTor.encoders.java.relayVote.W.Builder newBuilder() {
    return new converTor.encoders.java.relayVote.W.Builder();
  }
   ...
   * @return A new W RecordBuilder
   */
  public static converTor.encoders.java.relayVote.W.Builder newBuilder(converTor.encoders.java.relayVote.W.Builder other) {
    return new converTor.encoders.java.relayVote.W.Builder(other);
  }
   ...
   * @return A new W RecordBuilder
   */
  public static converTor.encoders.java.relayVote.W.Builder newBuilder(converTor.encoders.java.relayVote.W other) {
    return new converTor.encoders.java.relayVote.W.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<W>
    ...
    private Builder() {
      super(converTor.encoders.java.relayVote.W.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayVote.W.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayVote.W other) {
            super(converTor.encoders.java.relayVote.W.SCHEMA$);
      if (isValidValue(fields()[0], other.bandwidth)) {
        this.bandwidth = data().deepCopy(fields()[0].schema(), other.bandwidth);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.W.Builder setBandwidth(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.W.Builder clearBandwidth() {
      bandwidth = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.W.Builder setMeasured(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.W.Builder clearMeasured() {
      measured = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.W.Builder setUnmeasured(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.W.Builder clearUnmeasured() {
      unmeasured = null;
