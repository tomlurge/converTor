...
public class OrAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -284914967327421215L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrAddress\",\"namespace\":\"converTor.encoders.java.relayVote\",\"fields\":[{\"name\":\"address\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"implementation specific, see actual converter\"},{\"name\":\"port\",\"type\":[\"null\",\"int\"],\"doc\":\"implementation specific, see actual converter\"}]}");
   ...
   */
  public static converTor.encoders.java.relayVote.OrAddress.Builder newBuilder() {
    return new converTor.encoders.java.relayVote.OrAddress.Builder();
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static converTor.encoders.java.relayVote.OrAddress.Builder newBuilder(converTor.encoders.java.relayVote.OrAddress.Builder other) {
    return new converTor.encoders.java.relayVote.OrAddress.Builder(other);
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static converTor.encoders.java.relayVote.OrAddress.Builder newBuilder(converTor.encoders.java.relayVote.OrAddress other) {
    return new converTor.encoders.java.relayVote.OrAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrAddress>
    ...
    private Builder() {
      super(converTor.encoders.java.relayVote.OrAddress.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayVote.OrAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayVote.OrAddress other) {
            super(converTor.encoders.java.relayVote.OrAddress.SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.OrAddress.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.OrAddress.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.OrAddress.Builder setPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.OrAddress.Builder clearPort() {
      port = null;
