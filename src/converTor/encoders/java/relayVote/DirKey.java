...
public class DirKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static converTor.encoders.java.relayVote.DirKey.Builder newBuilder() {
    return new converTor.encoders.java.relayVote.DirKey.Builder();
  }
   ...
   * @return A new DirKey RecordBuilder
   */
  public static converTor.encoders.java.relayVote.DirKey.Builder newBuilder(converTor.encoders.java.relayVote.DirKey.Builder other) {
    return new converTor.encoders.java.relayVote.DirKey.Builder(other);
  }
   ...
   * @return A new DirKey RecordBuilder
   */
  public static converTor.encoders.java.relayVote.DirKey.Builder newBuilder(converTor.encoders.java.relayVote.DirKey other) {
    return new converTor.encoders.java.relayVote.DirKey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirKey>
    ...
    private Builder() {
      super(converTor.encoders.java.relayVote.DirKey.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayVote.DirKey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayVote.DirKey other) {
            super(converTor.encoders.java.relayVote.DirKey.SCHEMA$);
      if (isValidValue(fields()[0], other.version)) {
        this.version = data().deepCopy(fields()[0].schema(), other.version);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.DirKey.Builder setVersion(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.DirKey.Builder clearVersion() {
      version = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.DirKey.Builder setDirKeyPublished(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.DirKey.Builder clearDirKeyPublished() {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.DirKey.Builder setDirKeyExpires(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.DirKey.Builder clearDirKeyExpires() {
