...
public class ID extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3430484672261420079L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ID\",\"namespace\":\"converTor.encoders.java.relayVote\",\"fields\":[{\"name\":\"ed25519\",\"type\":[\"null\",\"boolean\"],\"doc\":\"metrics-lib/NetworkStatusEntry: String getMasterKeyEd25519()\"}]}");
   ...
   */
  public static converTor.encoders.java.relayVote.ID.Builder newBuilder() {
    return new converTor.encoders.java.relayVote.ID.Builder();
  }
   ...
   * @return A new ID RecordBuilder
   */
  public static converTor.encoders.java.relayVote.ID.Builder newBuilder(converTor.encoders.java.relayVote.ID.Builder other) {
    return new converTor.encoders.java.relayVote.ID.Builder(other);
  }
   ...
   * @return A new ID RecordBuilder
   */
  public static converTor.encoders.java.relayVote.ID.Builder newBuilder(converTor.encoders.java.relayVote.ID other) {
    return new converTor.encoders.java.relayVote.ID.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ID>
    ...
    private Builder() {
      super(converTor.encoders.java.relayVote.ID.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayVote.ID.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayVote.ID other) {
            super(converTor.encoders.java.relayVote.ID.SCHEMA$);
      if (isValidValue(fields()[0], other.ed25519)) {
        this.ed25519 = data().deepCopy(fields()[0].schema(), other.ed25519);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.ID.Builder setEd25519(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayVote.ID.Builder clearEd25519() {
      ed25519 = null;
