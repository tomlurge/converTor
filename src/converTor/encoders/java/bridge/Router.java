...
public class Router extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4462967556294464050L;
   ...
   */
  public static converTor.encoders.java.bridge.Router.Builder newBuilder() {
    return new converTor.encoders.java.bridge.Router.Builder();
  }
   ...
   * @return A new Router RecordBuilder
   */
  public static converTor.encoders.java.bridge.Router.Builder newBuilder(converTor.encoders.java.bridge.Router.Builder other) {
    return new converTor.encoders.java.bridge.Router.Builder(other);
  }
   ...
   * @return A new Router RecordBuilder
   */
  public static converTor.encoders.java.bridge.Router.Builder newBuilder(converTor.encoders.java.bridge.Router other) {
    return new converTor.encoders.java.bridge.Router.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Router>
    ...
    private Builder() {
      super(converTor.encoders.java.bridge.Router.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.bridge.Router.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.bridge.Router other) {
            super(converTor.encoders.java.bridge.Router.SCHEMA$);
      if (isValidValue(fields()[0], other.nickname)) {
        this.nickname = data().deepCopy(fields()[0].schema(), other.nickname);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Router.Builder setNickname(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Router.Builder clearNickname() {
      nickname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Router.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Router.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Router.Builder setOrPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Router.Builder clearOrPort() {
      or_port = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Router.Builder setSocksPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Router.Builder clearSocksPort() {
      socks_port = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Router.Builder setDirPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Router.Builder clearDirPort() {
      dir_port = null;
