...
public class Bandwidth extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static converTor.encoders.java.bridge.Bandwidth.Builder newBuilder() {
    return new converTor.encoders.java.bridge.Bandwidth.Builder();
  }
   ...
   * @return A new Bandwidth RecordBuilder
   */
  public static converTor.encoders.java.bridge.Bandwidth.Builder newBuilder(converTor.encoders.java.bridge.Bandwidth.Builder other) {
    return new converTor.encoders.java.bridge.Bandwidth.Builder(other);
  }
   ...
   * @return A new Bandwidth RecordBuilder
   */
  public static converTor.encoders.java.bridge.Bandwidth.Builder newBuilder(converTor.encoders.java.bridge.Bandwidth other) {
    return new converTor.encoders.java.bridge.Bandwidth.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Bandwidth>
    ...
    private Builder() {
      super(converTor.encoders.java.bridge.Bandwidth.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.bridge.Bandwidth.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.bridge.Bandwidth other) {
            super(converTor.encoders.java.bridge.Bandwidth.SCHEMA$);
      if (isValidValue(fields()[0], other.avg)) {
        this.avg = data().deepCopy(fields()[0].schema(), other.avg);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Bandwidth.Builder setAvg(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Bandwidth.Builder clearAvg() {
      avg = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Bandwidth.Builder setBurst(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Bandwidth.Builder clearBurst() {
      burst = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Bandwidth.Builder setObserved(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridge.Bandwidth.Builder clearObserved() {
      observed = null;
