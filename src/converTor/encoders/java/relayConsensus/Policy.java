...
public class Policy extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7884866086649961106L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Policy\",\"namespace\":\"converTor.encoders.java.relayConsensus\",\"fields\":[{\"name\":\"default_policy\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"metrics-lib/NetworkStatusEntry: String getDefaultPolicy()\"},{\"name\":\"port_summary\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"metrics-lib/NetworkStatusEntry: String getPortList()\"}]}");
   ...
   */
  public static converTor.encoders.java.relayConsensus.Policy.Builder newBuilder() {
    return new converTor.encoders.java.relayConsensus.Policy.Builder();
  }
   ...
   * @return A new Policy RecordBuilder
   */
  public static converTor.encoders.java.relayConsensus.Policy.Builder newBuilder(converTor.encoders.java.relayConsensus.Policy.Builder other) {
    return new converTor.encoders.java.relayConsensus.Policy.Builder(other);
  }
   ...
   * @return A new Policy RecordBuilder
   */
  public static converTor.encoders.java.relayConsensus.Policy.Builder newBuilder(converTor.encoders.java.relayConsensus.Policy other) {
    return new converTor.encoders.java.relayConsensus.Policy.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Policy>
    ...
    private Builder() {
      super(converTor.encoders.java.relayConsensus.Policy.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayConsensus.Policy.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayConsensus.Policy other) {
            super(converTor.encoders.java.relayConsensus.Policy.SCHEMA$);
      if (isValidValue(fields()[0], other.default_policy)) {
        this.default_policy = data().deepCopy(fields()[0].schema(), other.default_policy);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Policy.Builder setDefaultPolicy(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Policy.Builder clearDefaultPolicy() {
      default_policy = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Policy.Builder setPortSummary(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Policy.Builder clearPortSummary() {
      port_summary = null;
