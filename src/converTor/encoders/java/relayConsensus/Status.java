...
public class Status extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public converTor.encoders.java.relayConsensus.W w;
  @Deprecated public converTor.encoders.java.relayConsensus.Policy p;
   ...
   */
  public Status(converTor.encoders.java.relayConsensus.R r, java.util.List<converTor.encoders.java.relayConsensus.OrAddress> a, java.util.List<java.lang.String> s, java.lang.String v, converTor.encoders.java.relayConsensus.W w, converTor.encoders.java.relayConsensus.Policy p) {
    this.r = r;
    this.a = a;
    this.s = s;
    this.v = v;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: r = (converTor.encoders.java.relayConsensus.R)value$; break;
    case 1: a = (java.util.List<converTor.encoders.java.relayConsensus.OrAddress>)value$; break;
    case 2: s = (java.util.List<java.lang.String>)value$; break;
    case 3: v = (java.lang.String)value$; break;
    case 4: w = (converTor.encoders.java.relayConsensus.W)value$; break;
    case 5: p = (converTor.encoders.java.relayConsensus.Policy)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public converTor.encoders.java.relayConsensus.R getR() {
    return r;
  }
   ...
   */
  public void setR(converTor.encoders.java.relayConsensus.R value) {
    this.r = value;
  }
   ...
   */
  public java.util.List<converTor.encoders.java.relayConsensus.OrAddress> getA() {
    return a;
  }
   ...
   * @param value the value to set.
   */
  public void setA(java.util.List<converTor.encoders.java.relayConsensus.OrAddress> value) {
    this.a = value;
  }
   ...
   */
  public converTor.encoders.java.relayConsensus.W getW() {
    return w;
  }
   ...
   * @param value the value to set.
   */
  public void setW(converTor.encoders.java.relayConsensus.W value) {
    this.w = value;
  }
   ...
   */
  public converTor.encoders.java.relayConsensus.Policy getP() {
    return p;
  }
   ...
   * @param value the value to set.
   */
  public void setP(converTor.encoders.java.relayConsensus.Policy value) {
    this.p = value;
  }
   ...
   */
  public static converTor.encoders.java.relayConsensus.Status.Builder newBuilder() {
    return new converTor.encoders.java.relayConsensus.Status.Builder();
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static converTor.encoders.java.relayConsensus.Status.Builder newBuilder(converTor.encoders.java.relayConsensus.Status.Builder other) {
    return new converTor.encoders.java.relayConsensus.Status.Builder(other);
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static converTor.encoders.java.relayConsensus.Status.Builder newBuilder(converTor.encoders.java.relayConsensus.Status other) {
    return new converTor.encoders.java.relayConsensus.Status.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Status>
    ...
    private converTor.encoders.java.relayConsensus.R r;
    private converTor.encoders.java.relayConsensus.R.Builder rBuilder;
    private java.util.List<converTor.encoders.java.relayConsensus.OrAddress> a;
    /** metrics-lib/NetworkStatusEntry: SortedSet<String> getFlags() */
    private java.util.List<java.lang.String> s;
    /** metrics-lib/NetworkStatusEntry: String getVersion() */
    private java.lang.String v;
    private converTor.encoders.java.relayConsensus.W w;
    private converTor.encoders.java.relayConsensus.W.Builder wBuilder;
    private converTor.encoders.java.relayConsensus.Policy p;
    private converTor.encoders.java.relayConsensus.Policy.Builder pBuilder;

    /** Creates a new Builder */
    private Builder() {
      super(converTor.encoders.java.relayConsensus.Status.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayConsensus.Status.Builder other) {
      super(other);
      ...
      if (other.hasRBuilder()) {
        this.rBuilder = converTor.encoders.java.relayConsensus.R.newBuilder(other.getRBuilder());
      }
      ...
      if (other.hasWBuilder()) {
        this.wBuilder = converTor.encoders.java.relayConsensus.W.newBuilder(other.getWBuilder());
      }
      ...
      if (other.hasPBuilder()) {
        this.pBuilder = converTor.encoders.java.relayConsensus.Policy.newBuilder(other.getPBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayConsensus.Status other) {
            super(converTor.encoders.java.relayConsensus.Status.SCHEMA$);
      if (isValidValue(fields()[0], other.r)) {
        this.r = data().deepCopy(fields()[0].schema(), other.r);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder setR(converTor.encoders.java.relayConsensus.R value) {
     ...
     * @return This builder.
     */
    public converTor.encoders.java.relayConsensus.R.Builder getRBuilder() {
      if (rBuilder == null) {
        if (hasR()) {
          setRBuilder(converTor.encoders.java.relayConsensus.R.newBuilder(r));
        } else {
          setRBuilder(converTor.encoders.java.relayConsensus.R.newBuilder());
        }
      }
      return rBuilder;
    }
     ...
     * @return This builder.
     */
    public converTor.encoders.java.relayConsensus.Status.Builder setRBuilder(converTor.encoders.java.relayConsensus.R.Builder value) {
      clearR();
      rBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder clearR() {
      r = null;
      rBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder setA(java.util.List<converTor.encoders.java.relayConsensus.OrAddress> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder clearA() {
      a = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder setS(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder clearS() {
      s = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder setV(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder clearV() {
      v = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder setW(converTor.encoders.java.relayConsensus.W value) {
     ...
     * @return This builder.
     */
    public converTor.encoders.java.relayConsensus.W.Builder getWBuilder() {
      if (wBuilder == null) {
        if (hasW()) {
          setWBuilder(converTor.encoders.java.relayConsensus.W.newBuilder(w));
        } else {
          setWBuilder(converTor.encoders.java.relayConsensus.W.newBuilder());
        }
      }
      return wBuilder;
    }
     ...
     * @return This builder.
     */
    public converTor.encoders.java.relayConsensus.Status.Builder setWBuilder(converTor.encoders.java.relayConsensus.W.Builder value) {
      clearW();
      wBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder clearW() {
      w = null;
      wBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder setP(converTor.encoders.java.relayConsensus.Policy value) {
     ...
     * @return This builder.
     */
    public converTor.encoders.java.relayConsensus.Policy.Builder getPBuilder() {
      if (pBuilder == null) {
        if (hasP()) {
          setPBuilder(converTor.encoders.java.relayConsensus.Policy.newBuilder(p));
        } else {
          setPBuilder(converTor.encoders.java.relayConsensus.Policy.newBuilder());
        }
      }
      return pBuilder;
    }
     ...
     * @return This builder.
     */
    public converTor.encoders.java.relayConsensus.Status.Builder setPBuilder(converTor.encoders.java.relayConsensus.Policy.Builder value) {
      clearP();
      pBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.Status.Builder clearP() {
      p = null;
      pBuilder = null;
    ...
    public Status build() {
      try {
        ...
        if (rBuilder != null) {
          ...
          record.r = fieldSetFlags()[0] ? this.r : (converTor.encoders.java.relayConsensus.R) defaultValue(fields()[0]);
        }
        record.a = fieldSetFlags()[1] ? this.a : (java.util.List<converTor.encoders.java.relayConsensus.OrAddress>) defaultValue(fields()[1]);
        ...
        if (wBuilder != null) {
          ...
          record.w = fieldSetFlags()[4] ? this.w : (converTor.encoders.java.relayConsensus.W) defaultValue(fields()[4]);
        }
        if (pBuilder != null) {
          record.p = this.pBuilder.build();
        } else {
          record.p = fieldSetFlags()[5] ? this.p : (converTor.encoders.java.relayConsensus.Policy) defaultValue(fields()[5]);
        }
        return record;
      } catch (Exception e) {
