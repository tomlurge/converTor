...
public class RelayConsensus extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public converTor.encoders.java.relayConsensus.Vote voting_delay;
  ...
  @Deprecated public java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Authority> authorities;
  /** metrics-lib/RelayNetworkStatusConsensus:
        SortedMap<String, NetworkStatusEntry> getStatusEntries()
        status entries, one for each contained relay */
  @Deprecated public java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Status> status;
  @Deprecated public converTor.encoders.java.relayConsensus.DirFooter directory_footer;
   ...
   * @param client_versions metrics-lib/RelayNetworkStatusConsensus:
        List<String> getRecommendedClientVersions()
   * @param server_versions metrics-lib/RelayNetworkStatusConsensus:
        List<String> getRecommendedServerVersions()
   * @param known_flags metrics-lib/RelayNetworkStatusConsensus:
        SortedSet<String> getKnownFlags()
   * @param params metrics-lib/RelayNetworkStatusConsensus:
        SortedMap<String, Integer> getConsensusParams()
   * @param authorities metrics-lib/RelayNetworkStatusConsensus:
        SortedMap<String, DirSourceEntry> getDirSourceEntries()
        dir-source entries representing the directories of which votes are
        contained in this consensus
   * @param status metrics-lib/RelayNetworkStatusConsensus:
        SortedMap<String, NetworkStatusEntry> getStatusEntries()
        status entries, one for each contained relay
   */
  public RelayConsensus(java.lang.String descriptor_type, java.lang.Integer network_status_version, java.lang.String vote_status, java.lang.Integer consensus_method, java.lang.String consensus_flavor, java.lang.Long valid_after, java.lang.Long fresh_until, java.lang.Long valid_until, converTor.encoders.java.relayConsensus.Vote voting_delay, java.util.List<java.lang.String> client_versions, java.util.List<java.lang.String> server_versions, java.util.List<java.lang.String> known_flags, java.util.Map<java.lang.String,java.lang.Integer> params, java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Authority> authorities, java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Status> status, converTor.encoders.java.relayConsensus.DirFooter directory_footer) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: fresh_until = (java.lang.Long)value$; break;
    case 7: valid_until = (java.lang.Long)value$; break;
    case 8: voting_delay = (converTor.encoders.java.relayConsensus.Vote)value$; break;
    ...
    case 13: authorities = (java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Authority>)value$; break;
    case 14: status = (java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Status>)value$; break;
    case 15: directory_footer = (converTor.encoders.java.relayConsensus.DirFooter)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public converTor.encoders.java.relayConsensus.Vote getVotingDelay() {
    return voting_delay;
  }
   ...
   * @param value the value to set.
   */
  public void setVotingDelay(converTor.encoders.java.relayConsensus.Vote value) {
   ...
   * @return metrics-lib/RelayNetworkStatusConsensus:
        ...
        contained in this consensus
   */
  public java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Authority> getAuthorities() {
    return authorities;
  }
   ...
   * @param value the value to set.
   */
  public void setAuthorities(java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Authority> value) {
   ...
   * @return metrics-lib/RelayNetworkStatusConsensus:
        ...
        status entries, one for each contained relay
   */
  public java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Status> getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Status> value) {
    this.status = value;
  }
   ...
   */
  public converTor.encoders.java.relayConsensus.DirFooter getDirectoryFooter() {
   ...
   * @param value the value to set.
   */
  public void setDirectoryFooter(converTor.encoders.java.relayConsensus.DirFooter value) {
   ...
   */
  public static converTor.encoders.java.relayConsensus.RelayConsensus.Builder newBuilder() {
    return new converTor.encoders.java.relayConsensus.RelayConsensus.Builder();
  }
   ...
   * @return A new RelayConsensus RecordBuilder
   */
  public static converTor.encoders.java.relayConsensus.RelayConsensus.Builder newBuilder(converTor.encoders.java.relayConsensus.RelayConsensus.Builder other) {
    return new converTor.encoders.java.relayConsensus.RelayConsensus.Builder(other);
  }
   ...
   * @return A new RelayConsensus RecordBuilder
   */
  public static converTor.encoders.java.relayConsensus.RelayConsensus.Builder newBuilder(converTor.encoders.java.relayConsensus.RelayConsensus other) {
    return new converTor.encoders.java.relayConsensus.RelayConsensus.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RelayConsensus>
    ...
    private converTor.encoders.java.relayConsensus.Vote voting_delay;
    private converTor.encoders.java.relayConsensus.Vote.Builder voting_delayBuilder;
    /** metrics-lib/RelayNetworkStatusConsensus:
        List<String> getRecommendedClientVersions() */
    ...
    /** metrics-lib/RelayNetworkStatusConsensus:
        ...
        dir-source entries representing the directories of which votes are
        contained in this consensus */
    private java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Authority> authorities;
    /** metrics-lib/RelayNetworkStatusConsensus:
        SortedMap<String, NetworkStatusEntry> getStatusEntries()
        status entries, one for each contained relay */
    private java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Status> status;
    private converTor.encoders.java.relayConsensus.DirFooter directory_footer;
    private converTor.encoders.java.relayConsensus.DirFooter.Builder directory_footerBuilder;

    /** Creates a new Builder */
    private Builder() {
      super(converTor.encoders.java.relayConsensus.RelayConsensus.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.relayConsensus.RelayConsensus.Builder other) {
      super(other);
      ...
      if (other.hasVotingDelayBuilder()) {
        this.voting_delayBuilder = converTor.encoders.java.relayConsensus.Vote.newBuilder(other.getVotingDelayBuilder());
      }
      ...
      if (other.hasDirectoryFooterBuilder()) {
        this.directory_footerBuilder = converTor.encoders.java.relayConsensus.DirFooter.newBuilder(other.getDirectoryFooterBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.relayConsensus.RelayConsensus other) {
            super(converTor.encoders.java.relayConsensus.RelayConsensus.SCHEMA$);
      if (isValidValue(fields()[0], other.descriptor_type)) {
        this.descriptor_type = data().deepCopy(fields()[0].schema(), other.descriptor_type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setDescriptorType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearDescriptorType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setNetworkStatusVersion(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearNetworkStatusVersion() {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setVoteStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearVoteStatus() {
      vote_status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setConsensusMethod(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearConsensusMethod() {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setConsensusFlavor(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearConsensusFlavor() {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setValidAfter(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearValidAfter() {
      valid_after = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setFreshUntil(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearFreshUntil() {
      fresh_until = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setValidUntil(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearValidUntil() {
      valid_until = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setVotingDelay(converTor.encoders.java.relayConsensus.Vote value) {
     ...
     * @return This builder.
     */
    public converTor.encoders.java.relayConsensus.Vote.Builder getVotingDelayBuilder() {
      if (voting_delayBuilder == null) {
        if (hasVotingDelay()) {
          setVotingDelayBuilder(converTor.encoders.java.relayConsensus.Vote.newBuilder(voting_delay));
        } else {
          setVotingDelayBuilder(converTor.encoders.java.relayConsensus.Vote.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setVotingDelayBuilder(converTor.encoders.java.relayConsensus.Vote.Builder value) {
      clearVotingDelay();
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearVotingDelay() {
      voting_delay = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setClientVersions(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearClientVersions() {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setServerVersions(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearServerVersions() {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setKnownFlags(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearKnownFlags() {
      known_flags = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setParams(java.util.Map<java.lang.String,java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearParams() {
      params = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setAuthorities(java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Authority> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearAuthorities() {
      authorities = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setStatus(java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Status> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setDirectoryFooter(converTor.encoders.java.relayConsensus.DirFooter value) {
     ...
     * @return This builder.
     */
    public converTor.encoders.java.relayConsensus.DirFooter.Builder getDirectoryFooterBuilder() {
      if (directory_footerBuilder == null) {
        if (hasDirectoryFooter()) {
          setDirectoryFooterBuilder(converTor.encoders.java.relayConsensus.DirFooter.newBuilder(directory_footer));
        } else {
          setDirectoryFooterBuilder(converTor.encoders.java.relayConsensus.DirFooter.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder setDirectoryFooterBuilder(converTor.encoders.java.relayConsensus.DirFooter.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.relayConsensus.RelayConsensus.Builder clearDirectoryFooter() {
    ...
    public RelayConsensus build() {
      try {
        ...
        record.fresh_until = fieldSetFlags()[6] ? this.fresh_until : (java.lang.Long) defaultValue(fields()[6]);
        record.valid_until = fieldSetFlags()[7] ? this.valid_until : (java.lang.Long) defaultValue(fields()[7]);
        if (voting_delayBuilder != null) {
          record.voting_delay = this.voting_delayBuilder.build();
        } else {
          record.voting_delay = fieldSetFlags()[8] ? this.voting_delay : (converTor.encoders.java.relayConsensus.Vote) defaultValue(fields()[8]);
        }
        ...
        record.authorities = fieldSetFlags()[13] ? this.authorities : (java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Authority>) defaultValue(fields()[13]);
        record.status = fieldSetFlags()[14] ? this.status : (java.util.Map<java.lang.String,converTor.encoders.java.relayConsensus.Status>) defaultValue(fields()[14]);
        if (directory_footerBuilder != null) {
          record.directory_footer = this.directory_footerBuilder.build();
        } else {
          record.directory_footer = fieldSetFlags()[15] ? this.directory_footer : (converTor.encoders.java.relayConsensus.DirFooter) defaultValue(fields()[15]);
        }
        return record;
      } catch (Exception e) {
