...
public class Policy extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static converTor.encoders.java.bridgeStatus.Policy.Builder newBuilder() {
    return new converTor.encoders.java.bridgeStatus.Policy.Builder();
  }
   ...
   * @return A new Policy RecordBuilder
   */
  public static converTor.encoders.java.bridgeStatus.Policy.Builder newBuilder(converTor.encoders.java.bridgeStatus.Policy.Builder other) {
    return new converTor.encoders.java.bridgeStatus.Policy.Builder(other);
  }
   ...
   * @return A new Policy RecordBuilder
   */
  public static converTor.encoders.java.bridgeStatus.Policy.Builder newBuilder(converTor.encoders.java.bridgeStatus.Policy other) {
    return new converTor.encoders.java.bridgeStatus.Policy.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Policy>
    ...
    private Builder() {
      super(converTor.encoders.java.bridgeStatus.Policy.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.bridgeStatus.Policy.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.bridgeStatus.Policy other) {
            super(converTor.encoders.java.bridgeStatus.Policy.SCHEMA$);
      if (isValidValue(fields()[0], other.default_policy)) {
        this.default_policy = data().deepCopy(fields()[0].schema(), other.default_policy);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeStatus.Policy.Builder setDefaultPolicy(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeStatus.Policy.Builder clearDefaultPolicy() {
      default_policy = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeStatus.Policy.Builder setPortSummary(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeStatus.Policy.Builder clearPortSummary() {
      port_summary = null;
