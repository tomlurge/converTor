...
public class BridgeStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1961917295407619910L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BridgeStats\",\"namespace\":\"converTor.encoders.java.bridgeExtra\",\"fields\":[{\"name\":\"date\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getBridgeStatsEndMillis()\"},{\"name\":\"interval\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getBridgeStatsIntervalLength()\"}]}");
   ...
   */
  public static converTor.encoders.java.bridgeExtra.BridgeStats.Builder newBuilder() {
    return new converTor.encoders.java.bridgeExtra.BridgeStats.Builder();
  }
   ...
   * @return A new BridgeStats RecordBuilder
   */
  public static converTor.encoders.java.bridgeExtra.BridgeStats.Builder newBuilder(converTor.encoders.java.bridgeExtra.BridgeStats.Builder other) {
    return new converTor.encoders.java.bridgeExtra.BridgeStats.Builder(other);
  }
   ...
   * @return A new BridgeStats RecordBuilder
   */
  public static converTor.encoders.java.bridgeExtra.BridgeStats.Builder newBuilder(converTor.encoders.java.bridgeExtra.BridgeStats other) {
    return new converTor.encoders.java.bridgeExtra.BridgeStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BridgeStats>
    ...
    private Builder() {
      super(converTor.encoders.java.bridgeExtra.BridgeStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.bridgeExtra.BridgeStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.bridgeExtra.BridgeStats other) {
            super(converTor.encoders.java.bridgeExtra.BridgeStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.BridgeStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.BridgeStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.BridgeStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.BridgeStats.Builder clearInterval() {
      interval = null;
