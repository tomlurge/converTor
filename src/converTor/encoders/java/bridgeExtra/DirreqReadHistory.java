...
public class DirreqReadHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder newBuilder() {
    return new converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder();
  }
   ...
   * @return A new DirreqReadHistory RecordBuilder
   */
  public static converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder newBuilder(converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder other) {
    return new converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder(other);
  }
   ...
   * @return A new DirreqReadHistory RecordBuilder
   */
  public static converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder newBuilder(converTor.encoders.java.bridgeExtra.DirreqReadHistory other) {
    return new converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirreqReadHistory>
    ...
    private Builder() {
      super(converTor.encoders.java.bridgeExtra.DirreqReadHistory.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.bridgeExtra.DirreqReadHistory other) {
            super(converTor.encoders.java.bridgeExtra.DirreqReadHistory.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder clearInterval() {
      interval = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder setBytes(java.util.List<java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.DirreqReadHistory.Builder clearBytes() {
      bytes = null;
