...
public class CellStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8452715393893271509L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CellStats\",\"namespace\":\"converTor.encoders.java.bridgeExtra\",\"fields\":[{\"name\":\"date\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getCellStatsEndMillis()\"},{\"name\":\"interval\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getCellStatsIntervalLength()\"}]}");
   ...
   */
  public static converTor.encoders.java.bridgeExtra.CellStats.Builder newBuilder() {
    return new converTor.encoders.java.bridgeExtra.CellStats.Builder();
  }
   ...
   * @return A new CellStats RecordBuilder
   */
  public static converTor.encoders.java.bridgeExtra.CellStats.Builder newBuilder(converTor.encoders.java.bridgeExtra.CellStats.Builder other) {
    return new converTor.encoders.java.bridgeExtra.CellStats.Builder(other);
  }
   ...
   * @return A new CellStats RecordBuilder
   */
  public static converTor.encoders.java.bridgeExtra.CellStats.Builder newBuilder(converTor.encoders.java.bridgeExtra.CellStats other) {
    return new converTor.encoders.java.bridgeExtra.CellStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CellStats>
    ...
    private Builder() {
      super(converTor.encoders.java.bridgeExtra.CellStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.bridgeExtra.CellStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.bridgeExtra.CellStats other) {
            super(converTor.encoders.java.bridgeExtra.CellStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.CellStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.CellStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.CellStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.CellStats.Builder clearInterval() {
      interval = null;
