...
public class HidservStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2884207618700301200L;
   ...
   */
  public static converTor.encoders.java.bridgeExtra.HidservStats.Builder newBuilder() {
    return new converTor.encoders.java.bridgeExtra.HidservStats.Builder();
  }
   ...
   * @return A new HidservStats RecordBuilder
   */
  public static converTor.encoders.java.bridgeExtra.HidservStats.Builder newBuilder(converTor.encoders.java.bridgeExtra.HidservStats.Builder other) {
    return new converTor.encoders.java.bridgeExtra.HidservStats.Builder(other);
  }
   ...
   * @return A new HidservStats RecordBuilder
   */
  public static converTor.encoders.java.bridgeExtra.HidservStats.Builder newBuilder(converTor.encoders.java.bridgeExtra.HidservStats other) {
    return new converTor.encoders.java.bridgeExtra.HidservStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservStats>
    ...
    private Builder() {
      super(converTor.encoders.java.bridgeExtra.HidservStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.java.bridgeExtra.HidservStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.java.bridgeExtra.HidservStats other) {
            super(converTor.encoders.java.bridgeExtra.HidservStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.HidservStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.HidservStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.HidservStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.java.bridgeExtra.HidservStats.Builder clearInterval() {
      interval = null;
