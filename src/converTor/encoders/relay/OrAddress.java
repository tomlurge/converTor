...
public class OrAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static convertor.encoders.relay.OrAddress.Builder newBuilder() {
    return new convertor.encoders.relay.OrAddress.Builder();
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static convertor.encoders.relay.OrAddress.Builder newBuilder(convertor.encoders.relay.OrAddress.Builder other) {
    return new convertor.encoders.relay.OrAddress.Builder(other);
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static convertor.encoders.relay.OrAddress.Builder newBuilder(convertor.encoders.relay.OrAddress other) {
    return new convertor.encoders.relay.OrAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrAddress>
    ...
    private Builder() {
      super(convertor.encoders.relay.OrAddress.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(convertor.encoders.relay.OrAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(convertor.encoders.relay.OrAddress other) {
            super(convertor.encoders.relay.OrAddress.SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relay.OrAddress.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relay.OrAddress.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relay.OrAddress.Builder setPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relay.OrAddress.Builder clearPort() {
      port = null;
