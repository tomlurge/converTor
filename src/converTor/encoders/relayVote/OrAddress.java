...
public class OrAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static converTor.encoders.relayVote.OrAddress.Builder newBuilder() {
    return new converTor.encoders.relayVote.OrAddress.Builder();
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static converTor.encoders.relayVote.OrAddress.Builder newBuilder(converTor.encoders.relayVote.OrAddress.Builder other) {
    return new converTor.encoders.relayVote.OrAddress.Builder(other);
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static converTor.encoders.relayVote.OrAddress.Builder newBuilder(converTor.encoders.relayVote.OrAddress other) {
    return new converTor.encoders.relayVote.OrAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrAddress>
    ...
    private Builder() {
      super(converTor.encoders.relayVote.OrAddress.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.encoders.relayVote.OrAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.encoders.relayVote.OrAddress other) {
            super(converTor.encoders.relayVote.OrAddress.SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.relayVote.OrAddress.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.relayVote.OrAddress.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.relayVote.OrAddress.Builder setPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.encoders.relayVote.OrAddress.Builder clearPort() {
      port = null;
