...
public class ExtraInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ExtraInfo\",\"namespace\":\"org.torproject.metrics.converTor.relayExtra\",\"fields\":[{\"name\":\"nickname\",\"type\":[\"null\",\"string\"]},{\"name\":\"fingerprint\",\"type\":[\"null\",\"string\"]}]}");
  ...
  public static org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder();
  }
  
  /** Creates a new ExtraInfo RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder newBuilder(org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder other) {
    return new org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder(other);
  }
  
  /** Creates a new ExtraInfo RecordBuilder by copying an existing ExtraInfo instance */
  public static org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder newBuilder(org.torproject.metrics.converTor.relayExtra.ExtraInfo other) {
    return new org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExtraInfo>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relayExtra.ExtraInfo.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relayExtra.ExtraInfo other) {
            super(org.torproject.metrics.converTor.relayExtra.ExtraInfo.SCHEMA$);
      if (isValidValue(fields()[0], other.nickname)) {
        this.nickname = data().deepCopy(fields()[0].schema(), other.nickname);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'nickname' field */
    public org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder setNickname(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder clearNickname() {
      nickname = null;
    ...
    /** Sets the value of the 'fingerprint' field */
    public org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder setFingerprint(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayExtra.ExtraInfo.Builder clearFingerprint() {
      fingerprint = null;
