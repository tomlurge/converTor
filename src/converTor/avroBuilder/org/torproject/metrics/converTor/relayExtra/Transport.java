...
public class Transport extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Transport\",\"namespace\":\"org.torproject.metrics.converTor.relayExtra\",\"fields\":[{\"name\":\"transportname\",\"type\":[\"null\",\"string\"]},{\"name\":\"address\",\"type\":[\"null\",\"string\"]},{\"name\":\"port\",\"type\":[\"null\",\"int\"]},{\"name\":\"args\",\"type\":[\"null\",\"string\"]}]}");
  ...
  public static org.torproject.metrics.converTor.relayExtra.Transport.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relayExtra.Transport.Builder();
  }
  
  /** Creates a new Transport RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relayExtra.Transport.Builder newBuilder(org.torproject.metrics.converTor.relayExtra.Transport.Builder other) {
    return new org.torproject.metrics.converTor.relayExtra.Transport.Builder(other);
  }
  
  /** Creates a new Transport RecordBuilder by copying an existing Transport instance */
  public static org.torproject.metrics.converTor.relayExtra.Transport.Builder newBuilder(org.torproject.metrics.converTor.relayExtra.Transport other) {
    return new org.torproject.metrics.converTor.relayExtra.Transport.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Transport>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relayExtra.Transport.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relayExtra.Transport.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relayExtra.Transport other) {
            super(org.torproject.metrics.converTor.relayExtra.Transport.SCHEMA$);
      if (isValidValue(fields()[0], other.transportname)) {
        this.transportname = data().deepCopy(fields()[0].schema(), other.transportname);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'transportname' field */
    public org.torproject.metrics.converTor.relayExtra.Transport.Builder setTransportname(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayExtra.Transport.Builder clearTransportname() {
      transportname = null;
    ...
    /** Sets the value of the 'address' field */
    public org.torproject.metrics.converTor.relayExtra.Transport.Builder setAddress(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayExtra.Transport.Builder clearAddress() {
      address = null;
    ...
    /** Sets the value of the 'port' field */
    public org.torproject.metrics.converTor.relayExtra.Transport.Builder setPort(java.lang.Integer value) {
    ...
    public org.torproject.metrics.converTor.relayExtra.Transport.Builder clearPort() {
      port = null;
    ...
    /** Sets the value of the 'args' field */
    public org.torproject.metrics.converTor.relayExtra.Transport.Builder setArgs(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayExtra.Transport.Builder clearArgs() {
      args = null;
