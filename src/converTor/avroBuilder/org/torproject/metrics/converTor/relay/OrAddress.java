...
public class OrAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrAddress\",\"namespace\":\"org.torproject.metrics.converTor.relay\",\"fields\":[{\"name\":\"adress\",\"type\":\"string\"},{\"name\":\"port\",\"type\":\"int\"}]}");
  ...
  public static org.torproject.metrics.converTor.relay.OrAddress.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relay.OrAddress.Builder();
  }
  
  /** Creates a new OrAddress RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relay.OrAddress.Builder newBuilder(org.torproject.metrics.converTor.relay.OrAddress.Builder other) {
    return new org.torproject.metrics.converTor.relay.OrAddress.Builder(other);
  }
  
  /** Creates a new OrAddress RecordBuilder by copying an existing OrAddress instance */
  public static org.torproject.metrics.converTor.relay.OrAddress.Builder newBuilder(org.torproject.metrics.converTor.relay.OrAddress other) {
    return new org.torproject.metrics.converTor.relay.OrAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrAddress>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relay.OrAddress.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relay.OrAddress.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relay.OrAddress other) {
            super(org.torproject.metrics.converTor.relay.OrAddress.SCHEMA$);
      if (isValidValue(fields()[0], other.adress)) {
        this.adress = data().deepCopy(fields()[0].schema(), other.adress);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'adress' field */
    public org.torproject.metrics.converTor.relay.OrAddress.Builder setAdress(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relay.OrAddress.Builder clearAdress() {
      adress = null;
    ...
    /** Sets the value of the 'port' field */
    public org.torproject.metrics.converTor.relay.OrAddress.Builder setPort(int value) {
    ...
    public org.torproject.metrics.converTor.relay.OrAddress.Builder clearPort() {
