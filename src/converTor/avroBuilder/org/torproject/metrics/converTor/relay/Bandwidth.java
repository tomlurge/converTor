...
public class Bandwidth extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Bandwidth\",\"namespace\":\"org.torproject.metrics.converTor.relay\",\"fields\":[{\"name\":\"avg\",\"type\":[\"null\",\"int\"]},{\"name\":\"burst\",\"type\":[\"null\",\"int\"]},{\"name\":\"observed\",\"type\":[\"null\",\"int\"]}]}");
  ...
  public static org.torproject.metrics.converTor.relay.Bandwidth.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relay.Bandwidth.Builder();
  }
  
  /** Creates a new Bandwidth RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relay.Bandwidth.Builder newBuilder(org.torproject.metrics.converTor.relay.Bandwidth.Builder other) {
    return new org.torproject.metrics.converTor.relay.Bandwidth.Builder(other);
  }
  
  /** Creates a new Bandwidth RecordBuilder by copying an existing Bandwidth instance */
  public static org.torproject.metrics.converTor.relay.Bandwidth.Builder newBuilder(org.torproject.metrics.converTor.relay.Bandwidth other) {
    return new org.torproject.metrics.converTor.relay.Bandwidth.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Bandwidth>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relay.Bandwidth.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relay.Bandwidth.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relay.Bandwidth other) {
            super(org.torproject.metrics.converTor.relay.Bandwidth.SCHEMA$);
      if (isValidValue(fields()[0], other.avg)) {
        this.avg = data().deepCopy(fields()[0].schema(), other.avg);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'avg' field */
    public org.torproject.metrics.converTor.relay.Bandwidth.Builder setAvg(java.lang.Integer value) {
    ...
    public org.torproject.metrics.converTor.relay.Bandwidth.Builder clearAvg() {
      avg = null;
    ...
    /** Sets the value of the 'burst' field */
    public org.torproject.metrics.converTor.relay.Bandwidth.Builder setBurst(java.lang.Integer value) {
    ...
    public org.torproject.metrics.converTor.relay.Bandwidth.Builder clearBurst() {
      burst = null;
    ...
    /** Sets the value of the 'observed' field */
    public org.torproject.metrics.converTor.relay.Bandwidth.Builder setObserved(java.lang.Integer value) {
    ...
    public org.torproject.metrics.converTor.relay.Bandwidth.Builder clearObserved() {
      observed = null;
