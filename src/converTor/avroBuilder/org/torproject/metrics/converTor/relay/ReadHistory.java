...
public class ReadHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ReadHistory\",\"namespace\":\"org.torproject.metrics.converTor.relay\",\"fields\":[{\"name\":\"date\",\"type\":\"string\"},{\"name\":\"interval\",\"type\":\"long\"},{\"name\":\"bytes\",\"type\":{\"type\":\"array\",\"items\":\"long\"}}]}");
  ...
  public static org.torproject.metrics.converTor.relay.ReadHistory.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relay.ReadHistory.Builder();
  }
  
  /** Creates a new ReadHistory RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relay.ReadHistory.Builder newBuilder(org.torproject.metrics.converTor.relay.ReadHistory.Builder other) {
    return new org.torproject.metrics.converTor.relay.ReadHistory.Builder(other);
  }
  
  /** Creates a new ReadHistory RecordBuilder by copying an existing ReadHistory instance */
  public static org.torproject.metrics.converTor.relay.ReadHistory.Builder newBuilder(org.torproject.metrics.converTor.relay.ReadHistory other) {
    return new org.torproject.metrics.converTor.relay.ReadHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ReadHistory>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relay.ReadHistory.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relay.ReadHistory.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relay.ReadHistory other) {
            super(org.torproject.metrics.converTor.relay.ReadHistory.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'date' field */
    public org.torproject.metrics.converTor.relay.ReadHistory.Builder setDate(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relay.ReadHistory.Builder clearDate() {
      date = null;
    ...
    /** Sets the value of the 'interval' field */
    public org.torproject.metrics.converTor.relay.ReadHistory.Builder setInterval(long value) {
    ...
    public org.torproject.metrics.converTor.relay.ReadHistory.Builder clearInterval() {
    ...
    /** Sets the value of the 'bytes' field */
    public org.torproject.metrics.converTor.relay.ReadHistory.Builder setBytes(java.util.List<java.lang.Long> value) {
    ...
    public org.torproject.metrics.converTor.relay.ReadHistory.Builder clearBytes() {
      bytes = null;
