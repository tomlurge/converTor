...
public class CrossCert extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CrossCert\",\"namespace\":\"org.torproject.metrics.converTor.relay\",\"fields\":[{\"name\":\"cert\",\"type\":\"string\"},{\"name\":\"bit\",\"type\":\"int\"}]}");
  ...
  public static org.torproject.metrics.converTor.relay.CrossCert.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relay.CrossCert.Builder();
  }
  
  /** Creates a new CrossCert RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relay.CrossCert.Builder newBuilder(org.torproject.metrics.converTor.relay.CrossCert.Builder other) {
    return new org.torproject.metrics.converTor.relay.CrossCert.Builder(other);
  }
  
  /** Creates a new CrossCert RecordBuilder by copying an existing CrossCert instance */
  public static org.torproject.metrics.converTor.relay.CrossCert.Builder newBuilder(org.torproject.metrics.converTor.relay.CrossCert other) {
    return new org.torproject.metrics.converTor.relay.CrossCert.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CrossCert>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relay.CrossCert.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relay.CrossCert.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relay.CrossCert other) {
            super(org.torproject.metrics.converTor.relay.CrossCert.SCHEMA$);
      if (isValidValue(fields()[0], other.cert)) {
        this.cert = data().deepCopy(fields()[0].schema(), other.cert);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'cert' field */
    public org.torproject.metrics.converTor.relay.CrossCert.Builder setCert(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relay.CrossCert.Builder clearCert() {
      cert = null;
    ...
    /** Sets the value of the 'bit' field */
    public org.torproject.metrics.converTor.relay.CrossCert.Builder setBit(int value) {
    ...
    public org.torproject.metrics.converTor.relay.CrossCert.Builder clearBit() {
