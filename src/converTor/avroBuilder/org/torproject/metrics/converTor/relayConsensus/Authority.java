...
public class Authority extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Authority(org.torproject.metrics.converTor.relayConsensus.DirSource dir_source, java.lang.CharSequence contact, java.lang.CharSequence vote_digest) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: dir_source = (org.torproject.metrics.converTor.relayConsensus.DirSource)value$; break;
   ...
   */
  public org.torproject.metrics.converTor.relayConsensus.DirSource getDirSource() {
    return dir_source;
  }
   ...
   */
  public void setDirSource(org.torproject.metrics.converTor.relayConsensus.DirSource value) {
  ...
  public static org.torproject.metrics.converTor.relayConsensus.Authority.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relayConsensus.Authority.Builder();
  }
  
  /** Creates a new Authority RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relayConsensus.Authority.Builder newBuilder(org.torproject.metrics.converTor.relayConsensus.Authority.Builder other) {
    return new org.torproject.metrics.converTor.relayConsensus.Authority.Builder(other);
  }
  
  /** Creates a new Authority RecordBuilder by copying an existing Authority instance */
  public static org.torproject.metrics.converTor.relayConsensus.Authority.Builder newBuilder(org.torproject.metrics.converTor.relayConsensus.Authority other) {
    return new org.torproject.metrics.converTor.relayConsensus.Authority.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Authority>
    ...
    private org.torproject.metrics.converTor.relayConsensus.DirSource dir_source;
    private java.lang.CharSequence contact;
    private java.lang.CharSequence vote_digest;

    /** Creates a new Builder */
    private Builder() {
      super(org.torproject.metrics.converTor.relayConsensus.Authority.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relayConsensus.Authority.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relayConsensus.Authority other) {
            super(org.torproject.metrics.converTor.relayConsensus.Authority.SCHEMA$);
      if (isValidValue(fields()[0], other.dir_source)) {
        this.dir_source = data().deepCopy(fields()[0].schema(), other.dir_source);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'dir_source' field */
    public org.torproject.metrics.converTor.relayConsensus.Authority.Builder setDirSource(org.torproject.metrics.converTor.relayConsensus.DirSource value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.Authority.Builder clearDirSource() {
      dir_source = null;
    ...
    /** Sets the value of the 'contact' field */
    public org.torproject.metrics.converTor.relayConsensus.Authority.Builder setContact(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.Authority.Builder clearContact() {
      contact = null;
    ...
    /** Sets the value of the 'vote_digest' field */
    public org.torproject.metrics.converTor.relayConsensus.Authority.Builder setVoteDigest(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.Authority.Builder clearVoteDigest() {
      vote_digest = null;
    ...
    public Authority build() {
      try {
        ...
        record.dir_source = fieldSetFlags()[0] ? this.dir_source : (org.torproject.metrics.converTor.relayConsensus.DirSource) defaultValue(fields()[0]);
