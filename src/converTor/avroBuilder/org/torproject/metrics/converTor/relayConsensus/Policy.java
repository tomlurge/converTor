...
public class Policy extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Policy\",\"namespace\":\"org.torproject.metrics.converTor.relayConsensus\",\"fields\":[{\"name\":\"default_policy\",\"type\":[\"null\",\"string\"]},{\"name\":\"port_summary\",\"type\":[\"null\",\"string\"]}]}");
  ...
  public static org.torproject.metrics.converTor.relayConsensus.Policy.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relayConsensus.Policy.Builder();
  }
  
  /** Creates a new Policy RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relayConsensus.Policy.Builder newBuilder(org.torproject.metrics.converTor.relayConsensus.Policy.Builder other) {
    return new org.torproject.metrics.converTor.relayConsensus.Policy.Builder(other);
  }
  
  /** Creates a new Policy RecordBuilder by copying an existing Policy instance */
  public static org.torproject.metrics.converTor.relayConsensus.Policy.Builder newBuilder(org.torproject.metrics.converTor.relayConsensus.Policy other) {
    return new org.torproject.metrics.converTor.relayConsensus.Policy.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Policy>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relayConsensus.Policy.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relayConsensus.Policy.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relayConsensus.Policy other) {
            super(org.torproject.metrics.converTor.relayConsensus.Policy.SCHEMA$);
      if (isValidValue(fields()[0], other.default_policy)) {
        this.default_policy = data().deepCopy(fields()[0].schema(), other.default_policy);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'default_policy' field */
    public org.torproject.metrics.converTor.relayConsensus.Policy.Builder setDefaultPolicy(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.Policy.Builder clearDefaultPolicy() {
      default_policy = null;
    ...
    /** Sets the value of the 'port_summary' field */
    public org.torproject.metrics.converTor.relayConsensus.Policy.Builder setPortSummary(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.Policy.Builder clearPortSummary() {
      port_summary = null;
