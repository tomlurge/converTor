...
public class R extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static org.torproject.metrics.converTor.relayConsensus.R.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relayConsensus.R.Builder();
  }
  
  /** Creates a new R RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relayConsensus.R.Builder newBuilder(org.torproject.metrics.converTor.relayConsensus.R.Builder other) {
    return new org.torproject.metrics.converTor.relayConsensus.R.Builder(other);
  }
  
  /** Creates a new R RecordBuilder by copying an existing R instance */
  public static org.torproject.metrics.converTor.relayConsensus.R.Builder newBuilder(org.torproject.metrics.converTor.relayConsensus.R other) {
    return new org.torproject.metrics.converTor.relayConsensus.R.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<R>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relayConsensus.R.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relayConsensus.R.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relayConsensus.R other) {
            super(org.torproject.metrics.converTor.relayConsensus.R.SCHEMA$);
      if (isValidValue(fields()[0], other.nickname)) {
        this.nickname = data().deepCopy(fields()[0].schema(), other.nickname);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'nickname' field */
    public org.torproject.metrics.converTor.relayConsensus.R.Builder setNickname(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.R.Builder clearNickname() {
      nickname = null;
    ...
    /** Sets the value of the 'identity' field */
    public org.torproject.metrics.converTor.relayConsensus.R.Builder setIdentity(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.R.Builder clearIdentity() {
      identity = null;
    ...
    /** Sets the value of the 'digest' field */
    public org.torproject.metrics.converTor.relayConsensus.R.Builder setDigest(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.R.Builder clearDigest() {
      digest = null;
    ...
    /** Sets the value of the 'publication' field */
    public org.torproject.metrics.converTor.relayConsensus.R.Builder setPublication(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.R.Builder clearPublication() {
      publication = null;
    ...
    /** Sets the value of the 'ip' field */
    public org.torproject.metrics.converTor.relayConsensus.R.Builder setIp(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.R.Builder clearIp() {
      ip = null;
    ...
    /** Sets the value of the 'or_port' field */
    public org.torproject.metrics.converTor.relayConsensus.R.Builder setOrPort(java.lang.Integer value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.R.Builder clearOrPort() {
      or_port = null;
    ...
    /** Sets the value of the 'dir_port' field */
    public org.torproject.metrics.converTor.relayConsensus.R.Builder setDirPort(java.lang.Integer value) {
    ...
    public org.torproject.metrics.converTor.relayConsensus.R.Builder clearDirPort() {
      dir_port = null;
