...
public class ExitNode extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ExitNode\",\"namespace\":\"org.torproject.metrics.converTor.tordnsel\",\"fields\":[{\"name\":\"fingerprint\",\"type\":[\"null\",\"string\"]},{\"name\":\"published\",\"type\":[\"null\",\"string\"]},{\"name\":\"last_status\",\"type\":[\"null\",\"string\"]},{\"name\":\"exit_list\",\"type\":[\"null\",{\"type\":\"map\",\"values\":\"string\"}]}]}");
  ...
  public static org.torproject.metrics.converTor.tordnsel.ExitNode.Builder newBuilder() {
    return new org.torproject.metrics.converTor.tordnsel.ExitNode.Builder();
  }
  
  /** Creates a new ExitNode RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.tordnsel.ExitNode.Builder newBuilder(org.torproject.metrics.converTor.tordnsel.ExitNode.Builder other) {
    return new org.torproject.metrics.converTor.tordnsel.ExitNode.Builder(other);
  }
  
  /** Creates a new ExitNode RecordBuilder by copying an existing ExitNode instance */
  public static org.torproject.metrics.converTor.tordnsel.ExitNode.Builder newBuilder(org.torproject.metrics.converTor.tordnsel.ExitNode other) {
    return new org.torproject.metrics.converTor.tordnsel.ExitNode.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExitNode>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.tordnsel.ExitNode.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.tordnsel.ExitNode.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.tordnsel.ExitNode other) {
            super(org.torproject.metrics.converTor.tordnsel.ExitNode.SCHEMA$);
      if (isValidValue(fields()[0], other.fingerprint)) {
        this.fingerprint = data().deepCopy(fields()[0].schema(), other.fingerprint);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'fingerprint' field */
    public org.torproject.metrics.converTor.tordnsel.ExitNode.Builder setFingerprint(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.tordnsel.ExitNode.Builder clearFingerprint() {
      fingerprint = null;
    ...
    /** Sets the value of the 'published' field */
    public org.torproject.metrics.converTor.tordnsel.ExitNode.Builder setPublished(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.tordnsel.ExitNode.Builder clearPublished() {
      published = null;
    ...
    /** Sets the value of the 'last_status' field */
    public org.torproject.metrics.converTor.tordnsel.ExitNode.Builder setLastStatus(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.tordnsel.ExitNode.Builder clearLastStatus() {
      last_status = null;
    ...
    /** Sets the value of the 'exit_list' field */
    public org.torproject.metrics.converTor.tordnsel.ExitNode.Builder setExitList(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    public org.torproject.metrics.converTor.tordnsel.ExitNode.Builder clearExitList() {
      exit_list = null;
