...
public class CellStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CellStats\",\"namespace\":\"org.torproject.metrics.converTor.bridgeExtra\",\"fields\":[{\"name\":\"date\",\"type\":\"string\"},{\"name\":\"interval\",\"type\":\"long\",\"default\":86400}]}");
  ...
  public static org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder newBuilder() {
    return new org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder();
  }
  
  /** Creates a new CellStats RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder newBuilder(org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder other) {
    return new org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder(other);
  }
  
  /** Creates a new CellStats RecordBuilder by copying an existing CellStats instance */
  public static org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder newBuilder(org.torproject.metrics.converTor.bridgeExtra.CellStats other) {
    return new org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CellStats>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.bridgeExtra.CellStats.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.bridgeExtra.CellStats other) {
            super(org.torproject.metrics.converTor.bridgeExtra.CellStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'date' field */
    public org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder setDate(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder clearDate() {
      date = null;
    ...
    /** Sets the value of the 'interval' field */
    public org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder setInterval(long value) {
    ...
    public org.torproject.metrics.converTor.bridgeExtra.CellStats.Builder clearInterval() {
