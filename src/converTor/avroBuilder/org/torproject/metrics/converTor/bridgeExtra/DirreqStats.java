...
public class DirreqStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DirreqStats\",\"namespace\":\"org.torproject.metrics.converTor.bridgeExtra\",\"fields\":[{\"name\":\"date\",\"type\":\"string\"},{\"name\":\"interval\",\"type\":\"long\",\"default\":86400}]}");
  ...
  public static org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder newBuilder() {
    return new org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder();
  }
  
  /** Creates a new DirreqStats RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder newBuilder(org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder other) {
    return new org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder(other);
  }
  
  /** Creates a new DirreqStats RecordBuilder by copying an existing DirreqStats instance */
  public static org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder newBuilder(org.torproject.metrics.converTor.bridgeExtra.DirreqStats other) {
    return new org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirreqStats>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.bridgeExtra.DirreqStats.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.bridgeExtra.DirreqStats other) {
            super(org.torproject.metrics.converTor.bridgeExtra.DirreqStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'date' field */
    public org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder setDate(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder clearDate() {
      date = null;
    ...
    /** Sets the value of the 'interval' field */
    public org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder setInterval(long value) {
    ...
    public org.torproject.metrics.converTor.bridgeExtra.DirreqStats.Builder clearInterval() {
