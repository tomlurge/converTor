...
public class Router extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public org.torproject.metrics.converTor.relayVote.W w;
  @Deprecated public org.torproject.metrics.converTor.relayVote.Policy p;
   ...
   */
  public Router(org.torproject.metrics.converTor.relayVote.R r, java.util.List<java.lang.CharSequence> a, java.util.List<java.lang.CharSequence> s, java.lang.CharSequence v, org.torproject.metrics.converTor.relayVote.W w, org.torproject.metrics.converTor.relayVote.Policy p, java.lang.CharSequence id) {
    this.r = r;
    this.a = a;
    this.s = s;
    this.v = v;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: r = (org.torproject.metrics.converTor.relayVote.R)value$; break;
    ...
    case 4: w = (org.torproject.metrics.converTor.relayVote.W)value$; break;
    case 5: p = (org.torproject.metrics.converTor.relayVote.Policy)value$; break;
   ...
   */
  public org.torproject.metrics.converTor.relayVote.R getR() {
    return r;
  }
   ...
   */
  public void setR(org.torproject.metrics.converTor.relayVote.R value) {
    this.r = value;
  }
   ...
   */
  public org.torproject.metrics.converTor.relayVote.W getW() {
    return w;
  }
   ...
   * @param value the value to set.
   */
  public void setW(org.torproject.metrics.converTor.relayVote.W value) {
    this.w = value;
  }
   ...
   */
  public org.torproject.metrics.converTor.relayVote.Policy getP() {
    return p;
  }
   ...
   * @param value the value to set.
   */
  public void setP(org.torproject.metrics.converTor.relayVote.Policy value) {
    this.p = value;
  }
  ...
  public static org.torproject.metrics.converTor.relayVote.Router.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relayVote.Router.Builder();
  }
  
  /** Creates a new Router RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relayVote.Router.Builder newBuilder(org.torproject.metrics.converTor.relayVote.Router.Builder other) {
    return new org.torproject.metrics.converTor.relayVote.Router.Builder(other);
  }
  
  /** Creates a new Router RecordBuilder by copying an existing Router instance */
  public static org.torproject.metrics.converTor.relayVote.Router.Builder newBuilder(org.torproject.metrics.converTor.relayVote.Router other) {
    return new org.torproject.metrics.converTor.relayVote.Router.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Router>
    ...
    private org.torproject.metrics.converTor.relayVote.R r;
    ...
    private org.torproject.metrics.converTor.relayVote.W w;
    private org.torproject.metrics.converTor.relayVote.Policy p;
    private java.lang.CharSequence id;

    /** Creates a new Builder */
    private Builder() {
      super(org.torproject.metrics.converTor.relayVote.Router.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relayVote.Router.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relayVote.Router other) {
            super(org.torproject.metrics.converTor.relayVote.Router.SCHEMA$);
      if (isValidValue(fields()[0], other.r)) {
        this.r = data().deepCopy(fields()[0].schema(), other.r);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'r' field */
    public org.torproject.metrics.converTor.relayVote.Router.Builder setR(org.torproject.metrics.converTor.relayVote.R value) {
    ...
    public org.torproject.metrics.converTor.relayVote.Router.Builder clearR() {
      r = null;
    ...
    /** Sets the value of the 'a' field */
    public org.torproject.metrics.converTor.relayVote.Router.Builder setA(java.util.List<java.lang.CharSequence> value) {
    ...
    public org.torproject.metrics.converTor.relayVote.Router.Builder clearA() {
      a = null;
    ...
    /** Sets the value of the 's' field */
    public org.torproject.metrics.converTor.relayVote.Router.Builder setS(java.util.List<java.lang.CharSequence> value) {
    ...
    public org.torproject.metrics.converTor.relayVote.Router.Builder clearS() {
      s = null;
    ...
    /** Sets the value of the 'v' field */
    public org.torproject.metrics.converTor.relayVote.Router.Builder setV(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayVote.Router.Builder clearV() {
      v = null;
    ...
    /** Sets the value of the 'w' field */
    public org.torproject.metrics.converTor.relayVote.Router.Builder setW(org.torproject.metrics.converTor.relayVote.W value) {
    ...
    public org.torproject.metrics.converTor.relayVote.Router.Builder clearW() {
      w = null;
    ...
    /** Sets the value of the 'p' field */
    public org.torproject.metrics.converTor.relayVote.Router.Builder setP(org.torproject.metrics.converTor.relayVote.Policy value) {
    ...
    public org.torproject.metrics.converTor.relayVote.Router.Builder clearP() {
      p = null;
    ...
    /** Sets the value of the 'id' field */
    public org.torproject.metrics.converTor.relayVote.Router.Builder setId(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayVote.Router.Builder clearId() {
      id = null;
    ...
    public Router build() {
      try {
        ...
        record.r = fieldSetFlags()[0] ? this.r : (org.torproject.metrics.converTor.relayVote.R) defaultValue(fields()[0]);
        ...
        record.w = fieldSetFlags()[4] ? this.w : (org.torproject.metrics.converTor.relayVote.W) defaultValue(fields()[4]);
        record.p = fieldSetFlags()[5] ? this.p : (org.torproject.metrics.converTor.relayVote.Policy) defaultValue(fields()[5]);
