...
public class DirSig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static org.torproject.metrics.converTor.relayVote.DirSig.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relayVote.DirSig.Builder();
  }
  
  /** Creates a new DirSig RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relayVote.DirSig.Builder newBuilder(org.torproject.metrics.converTor.relayVote.DirSig.Builder other) {
    return new org.torproject.metrics.converTor.relayVote.DirSig.Builder(other);
  }
  
  /** Creates a new DirSig RecordBuilder by copying an existing DirSig instance */
  public static org.torproject.metrics.converTor.relayVote.DirSig.Builder newBuilder(org.torproject.metrics.converTor.relayVote.DirSig other) {
    return new org.torproject.metrics.converTor.relayVote.DirSig.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirSig>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relayVote.DirSig.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relayVote.DirSig.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relayVote.DirSig other) {
            super(org.torproject.metrics.converTor.relayVote.DirSig.SCHEMA$);
      if (isValidValue(fields()[0], other.algorithm)) {
        this.algorithm = data().deepCopy(fields()[0].schema(), other.algorithm);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'algorithm' field */
    public org.torproject.metrics.converTor.relayVote.DirSig.Builder setAlgorithm(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayVote.DirSig.Builder clearAlgorithm() {
      algorithm = null;
    ...
    /** Sets the value of the 'identity' field */
    public org.torproject.metrics.converTor.relayVote.DirSig.Builder setIdentity(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayVote.DirSig.Builder clearIdentity() {
      identity = null;
    ...
    /** Sets the value of the 'signing_key_digest' field */
    public org.torproject.metrics.converTor.relayVote.DirSig.Builder setSigningKeyDigest(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayVote.DirSig.Builder clearSigningKeyDigest() {
    ...
    /** Sets the value of the 'signature' field */
    public org.torproject.metrics.converTor.relayVote.DirSig.Builder setSignature(java.lang.Boolean value) {
    ...
    public org.torproject.metrics.converTor.relayVote.DirSig.Builder clearSignature() {
      signature = null;
