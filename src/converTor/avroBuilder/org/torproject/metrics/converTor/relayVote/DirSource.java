...
public class DirSource extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static org.torproject.metrics.converTor.relayVote.DirSource.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relayVote.DirSource.Builder();
  }
  
  /** Creates a new DirSource RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relayVote.DirSource.Builder newBuilder(org.torproject.metrics.converTor.relayVote.DirSource.Builder other) {
    return new org.torproject.metrics.converTor.relayVote.DirSource.Builder(other);
  }
  
  /** Creates a new DirSource RecordBuilder by copying an existing DirSource instance */
  public static org.torproject.metrics.converTor.relayVote.DirSource.Builder newBuilder(org.torproject.metrics.converTor.relayVote.DirSource other) {
    return new org.torproject.metrics.converTor.relayVote.DirSource.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirSource>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relayVote.DirSource.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relayVote.DirSource.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relayVote.DirSource other) {
            super(org.torproject.metrics.converTor.relayVote.DirSource.SCHEMA$);
      if (isValidValue(fields()[0], other.nickname)) {
        this.nickname = data().deepCopy(fields()[0].schema(), other.nickname);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'nickname' field */
    public org.torproject.metrics.converTor.relayVote.DirSource.Builder setNickname(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayVote.DirSource.Builder clearNickname() {
      nickname = null;
    ...
    /** Sets the value of the 'identity' field */
    public org.torproject.metrics.converTor.relayVote.DirSource.Builder setIdentity(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayVote.DirSource.Builder clearIdentity() {
      identity = null;
    ...
    /** Sets the value of the 'address' field */
    public org.torproject.metrics.converTor.relayVote.DirSource.Builder setAddress(java.lang.CharSequence value) {
    ...
    public org.torproject.metrics.converTor.relayVote.DirSource.Builder clearAddress() {
      address = null;
    ...
    /** Sets the value of the 'dir_port' field */
    public org.torproject.metrics.converTor.relayVote.DirSource.Builder setDirPort(java.lang.Integer value) {
    ...
    public org.torproject.metrics.converTor.relayVote.DirSource.Builder clearDirPort() {
      dir_port = null;
    ...
    /** Sets the value of the 'or_port' field */
    public org.torproject.metrics.converTor.relayVote.DirSource.Builder setOrPort(java.lang.Integer value) {
    ...
    public org.torproject.metrics.converTor.relayVote.DirSource.Builder clearOrPort() {
      or_port = null;
