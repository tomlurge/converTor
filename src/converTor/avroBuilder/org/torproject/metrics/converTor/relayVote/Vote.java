...
public class Vote extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Vote\",\"namespace\":\"org.torproject.metrics.converTor.relayVote\",\"fields\":[{\"name\":\"vote_seconds\",\"type\":[\"null\",\"long\"]},{\"name\":\"dist_seconds\",\"type\":[\"null\",\"long\"]}]}");
  ...
  public static org.torproject.metrics.converTor.relayVote.Vote.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relayVote.Vote.Builder();
  }
  
  /** Creates a new Vote RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relayVote.Vote.Builder newBuilder(org.torproject.metrics.converTor.relayVote.Vote.Builder other) {
    return new org.torproject.metrics.converTor.relayVote.Vote.Builder(other);
  }
  
  /** Creates a new Vote RecordBuilder by copying an existing Vote instance */
  public static org.torproject.metrics.converTor.relayVote.Vote.Builder newBuilder(org.torproject.metrics.converTor.relayVote.Vote other) {
    return new org.torproject.metrics.converTor.relayVote.Vote.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Vote>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relayVote.Vote.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relayVote.Vote.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relayVote.Vote other) {
            super(org.torproject.metrics.converTor.relayVote.Vote.SCHEMA$);
      if (isValidValue(fields()[0], other.vote_seconds)) {
        this.vote_seconds = data().deepCopy(fields()[0].schema(), other.vote_seconds);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'vote_seconds' field */
    public org.torproject.metrics.converTor.relayVote.Vote.Builder setVoteSeconds(java.lang.Long value) {
    ...
    public org.torproject.metrics.converTor.relayVote.Vote.Builder clearVoteSeconds() {
      vote_seconds = null;
    ...
    /** Sets the value of the 'dist_seconds' field */
    public org.torproject.metrics.converTor.relayVote.Vote.Builder setDistSeconds(java.lang.Long value) {
    ...
    public org.torproject.metrics.converTor.relayVote.Vote.Builder clearDistSeconds() {
      dist_seconds = null;
