...
public class W extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"W\",\"namespace\":\"org.torproject.metrics.converTor.relayVote\",\"fields\":[{\"name\":\"bandwidth\",\"type\":[\"null\",\"long\"]},{\"name\":\"measured\",\"type\":[\"null\",\"long\"]},{\"name\":\"unmeasured\",\"type\":[\"null\",\"boolean\"]}]}");
  ...
  public static org.torproject.metrics.converTor.relayVote.W.Builder newBuilder() {
    return new org.torproject.metrics.converTor.relayVote.W.Builder();
  }
  
  /** Creates a new W RecordBuilder by copying an existing Builder */
  public static org.torproject.metrics.converTor.relayVote.W.Builder newBuilder(org.torproject.metrics.converTor.relayVote.W.Builder other) {
    return new org.torproject.metrics.converTor.relayVote.W.Builder(other);
  }
  
  /** Creates a new W RecordBuilder by copying an existing W instance */
  public static org.torproject.metrics.converTor.relayVote.W.Builder newBuilder(org.torproject.metrics.converTor.relayVote.W other) {
    return new org.torproject.metrics.converTor.relayVote.W.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<W>
    ...
    private Builder() {
      super(org.torproject.metrics.converTor.relayVote.W.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.torproject.metrics.converTor.relayVote.W.Builder other) {
      super(other);
    ...
    private Builder(org.torproject.metrics.converTor.relayVote.W other) {
            super(org.torproject.metrics.converTor.relayVote.W.SCHEMA$);
      if (isValidValue(fields()[0], other.bandwidth)) {
        this.bandwidth = data().deepCopy(fields()[0].schema(), other.bandwidth);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'bandwidth' field */
    public org.torproject.metrics.converTor.relayVote.W.Builder setBandwidth(java.lang.Long value) {
    ...
    public org.torproject.metrics.converTor.relayVote.W.Builder clearBandwidth() {
      bandwidth = null;
    ...
    /** Sets the value of the 'measured' field */
    public org.torproject.metrics.converTor.relayVote.W.Builder setMeasured(java.lang.Long value) {
    ...
    public org.torproject.metrics.converTor.relayVote.W.Builder clearMeasured() {
      measured = null;
    ...
    /** Sets the value of the 'unmeasured' field */
    public org.torproject.metrics.converTor.relayVote.W.Builder setUnmeasured(java.lang.Boolean value) {
    ...
    public org.torproject.metrics.converTor.relayVote.W.Builder clearUnmeasured() {
      unmeasured = null;
