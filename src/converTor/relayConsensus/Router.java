...
public class Router extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Router(converTor.relayConsensus.R r, java.util.List<java.lang.CharSequence> a, java.util.List<java.lang.CharSequence> s, java.lang.CharSequence v, converTor.relayConsensus.W w, converTor.relayConsensus.Policy p) {
    this.r = r;
    this.a = a;
    this.s = s;
    this.v = v;
  ...
  public static converTor.relayConsensus.Router.Builder newBuilder() {
    return new converTor.relayConsensus.Router.Builder();
  }
  
  /** Creates a new Router RecordBuilder by copying an existing Builder */
  public static converTor.relayConsensus.Router.Builder newBuilder(converTor.relayConsensus.Router.Builder other) {
    return new converTor.relayConsensus.Router.Builder(other);
  }
  
  /** Creates a new Router RecordBuilder by copying an existing Router instance */
  public static converTor.relayConsensus.Router.Builder newBuilder(converTor.relayConsensus.Router other) {
    return new converTor.relayConsensus.Router.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Router>
    ...
    private Builder() {
      super(converTor.relayConsensus.Router.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(converTor.relayConsensus.Router.Builder other) {
      super(other);
    ...
    private Builder(converTor.relayConsensus.Router other) {
            super(converTor.relayConsensus.Router.SCHEMA$);
      if (isValidValue(fields()[0], other.r)) {
        this.r = data().deepCopy(fields()[0].schema(), other.r);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'r' field */
    public converTor.relayConsensus.Router.Builder setR(converTor.relayConsensus.R value) {
    ...
    public converTor.relayConsensus.Router.Builder clearR() {
      r = null;
    ...
    /** Sets the value of the 'a' field */
    public converTor.relayConsensus.Router.Builder setA(java.util.List<java.lang.CharSequence> value) {
    ...
    public converTor.relayConsensus.Router.Builder clearA() {
      a = null;
    ...
    /** Sets the value of the 's' field */
    public converTor.relayConsensus.Router.Builder setS(java.util.List<java.lang.CharSequence> value) {
    ...
    public converTor.relayConsensus.Router.Builder clearS() {
      s = null;
    ...
    /** Sets the value of the 'v' field */
    public converTor.relayConsensus.Router.Builder setV(java.lang.CharSequence value) {
    ...
    public converTor.relayConsensus.Router.Builder clearV() {
      v = null;
    ...
    /** Sets the value of the 'w' field */
    public converTor.relayConsensus.Router.Builder setW(converTor.relayConsensus.W value) {
    ...
    public converTor.relayConsensus.Router.Builder clearW() {
      w = null;
    ...
    /** Sets the value of the 'p' field */
    public converTor.relayConsensus.Router.Builder setP(converTor.relayConsensus.Policy value) {
    ...
    public converTor.relayConsensus.Router.Builder clearP() {
      p = null;
