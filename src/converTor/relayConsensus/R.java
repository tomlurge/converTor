...
public class R extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1210970686061016495L;
   ...
   */
  public static converTor.relayConsensus.R.Builder newBuilder() {
    return new converTor.relayConsensus.R.Builder();
  }
   ...
   * @return A new R RecordBuilder
   */
  public static converTor.relayConsensus.R.Builder newBuilder(converTor.relayConsensus.R.Builder other) {
    return new converTor.relayConsensus.R.Builder(other);
  }
   ...
   * @return A new R RecordBuilder
   */
  public static converTor.relayConsensus.R.Builder newBuilder(converTor.relayConsensus.R other) {
    return new converTor.relayConsensus.R.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<R>
    ...
    private Builder() {
      super(converTor.relayConsensus.R.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.relayConsensus.R.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.relayConsensus.R other) {
            super(converTor.relayConsensus.R.SCHEMA$);
      if (isValidValue(fields()[0], other.nickname)) {
        this.nickname = data().deepCopy(fields()[0].schema(), other.nickname);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder setNickname(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder clearNickname() {
      nickname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder setIdentity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder clearIdentity() {
      identity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder setDigest(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder clearDigest() {
      digest = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder setPublication(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder clearPublication() {
      publication = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder setIp(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder clearIp() {
      ip = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder setOrPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder clearOrPort() {
      or_port = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder setDirPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder clearDirPort() {
      dir_port = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder setFingerprint(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.R.Builder clearFingerprint() {
      fingerprint = null;
