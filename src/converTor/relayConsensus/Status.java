...
public class Status extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public converTor.relayConsensus.W w;
  @Deprecated public converTor.relayConsensus.Policy p;
   ...
   */
  public Status(converTor.relayConsensus.R r, java.util.List<java.lang.CharSequence> a, java.util.List<java.lang.CharSequence> s, java.lang.CharSequence v, converTor.relayConsensus.W w, converTor.relayConsensus.Policy p) {
    this.r = r;
    this.a = a;
    this.s = s;
    this.v = v;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: r = (converTor.relayConsensus.R)value$; break;
    ...
    case 4: w = (converTor.relayConsensus.W)value$; break;
    case 5: p = (converTor.relayConsensus.Policy)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public converTor.relayConsensus.R getR() {
    return r;
  }
   ...
   */
  public void setR(converTor.relayConsensus.R value) {
    this.r = value;
  }
   ...
   */
  public converTor.relayConsensus.W getW() {
    return w;
  }
   ...
   * @param value the value to set.
   */
  public void setW(converTor.relayConsensus.W value) {
    this.w = value;
  }
   ...
   */
  public converTor.relayConsensus.Policy getP() {
    return p;
  }
   ...
   * @param value the value to set.
   */
  public void setP(converTor.relayConsensus.Policy value) {
    this.p = value;
  }
   ...
   */
  public static converTor.relayConsensus.Status.Builder newBuilder() {
    return new converTor.relayConsensus.Status.Builder();
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static converTor.relayConsensus.Status.Builder newBuilder(converTor.relayConsensus.Status.Builder other) {
    return new converTor.relayConsensus.Status.Builder(other);
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static converTor.relayConsensus.Status.Builder newBuilder(converTor.relayConsensus.Status other) {
    return new converTor.relayConsensus.Status.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Status>
    ...
    private converTor.relayConsensus.R r;
    private converTor.relayConsensus.R.Builder rBuilder;
    /** metrics-lib/NetworkStatusEntry: getOrAddresses() */
    ...
    private converTor.relayConsensus.W w;
    private converTor.relayConsensus.W.Builder wBuilder;
    private converTor.relayConsensus.Policy p;
    private converTor.relayConsensus.Policy.Builder pBuilder;

    /** Creates a new Builder */
    private Builder() {
      super(converTor.relayConsensus.Status.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.relayConsensus.Status.Builder other) {
      super(other);
      ...
      if (other.hasRBuilder()) {
        this.rBuilder = converTor.relayConsensus.R.newBuilder(other.getRBuilder());
      }
      ...
      if (other.hasWBuilder()) {
        this.wBuilder = converTor.relayConsensus.W.newBuilder(other.getWBuilder());
      }
      ...
      if (other.hasPBuilder()) {
        this.pBuilder = converTor.relayConsensus.Policy.newBuilder(other.getPBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.relayConsensus.Status other) {
            super(converTor.relayConsensus.Status.SCHEMA$);
      if (isValidValue(fields()[0], other.r)) {
        this.r = data().deepCopy(fields()[0].schema(), other.r);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder setR(converTor.relayConsensus.R value) {
     ...
     * @return This builder.
     */
    public converTor.relayConsensus.R.Builder getRBuilder() {
      if (rBuilder == null) {
        if (hasR()) {
          setRBuilder(converTor.relayConsensus.R.newBuilder(r));
        } else {
          setRBuilder(converTor.relayConsensus.R.newBuilder());
        }
      }
      return rBuilder;
    }
     ...
     * @return This builder.
     */
    public converTor.relayConsensus.Status.Builder setRBuilder(converTor.relayConsensus.R.Builder value) {
      clearR();
      rBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder clearR() {
      r = null;
      rBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder setA(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder clearA() {
      a = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder setS(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder clearS() {
      s = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder setV(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder clearV() {
      v = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder setW(converTor.relayConsensus.W value) {
     ...
     * @return This builder.
     */
    public converTor.relayConsensus.W.Builder getWBuilder() {
      if (wBuilder == null) {
        if (hasW()) {
          setWBuilder(converTor.relayConsensus.W.newBuilder(w));
        } else {
          setWBuilder(converTor.relayConsensus.W.newBuilder());
        }
      }
      return wBuilder;
    }
     ...
     * @return This builder.
     */
    public converTor.relayConsensus.Status.Builder setWBuilder(converTor.relayConsensus.W.Builder value) {
      clearW();
      wBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder clearW() {
      w = null;
      wBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder setP(converTor.relayConsensus.Policy value) {
     ...
     * @return This builder.
     */
    public converTor.relayConsensus.Policy.Builder getPBuilder() {
      if (pBuilder == null) {
        if (hasP()) {
          setPBuilder(converTor.relayConsensus.Policy.newBuilder(p));
        } else {
          setPBuilder(converTor.relayConsensus.Policy.newBuilder());
        }
      }
      return pBuilder;
    }
     ...
     * @return This builder.
     */
    public converTor.relayConsensus.Status.Builder setPBuilder(converTor.relayConsensus.Policy.Builder value) {
      clearP();
      pBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayConsensus.Status.Builder clearP() {
      p = null;
      pBuilder = null;
    ...
    public Status build() {
      try {
        ...
        if (rBuilder != null) {
          ...
          record.r = fieldSetFlags()[0] ? this.r : (converTor.relayConsensus.R) defaultValue(fields()[0]);
        }
        ...
        if (wBuilder != null) {
          ...
          record.w = fieldSetFlags()[4] ? this.w : (converTor.relayConsensus.W) defaultValue(fields()[4]);
        }
        if (pBuilder != null) {
          record.p = this.pBuilder.build();
        } else {
          record.p = fieldSetFlags()[5] ? this.p : (converTor.relayConsensus.Policy) defaultValue(fields()[5]);
        }
        return record;
      } catch (Exception e) {
