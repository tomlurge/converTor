...
class DescriptorType {
  ...
  Class<?> convertClas;// reference to the Convert Class object
  ...
  DescriptorType(String name) {
    ...
    try {
      ...
      //  this.clas = ClassLoader.getSystemClassLoader().loadClass("converTor." + name + "." + clasName);
    ...
    try {
      this.convertClas = Class.forName("converTor.Convert" + clasName);
    } catch (ClassNotFoundException c) {
      System.err.println("ClassNotFoundException: "+ c.getMessage());
      c.printStackTrace();
    }
