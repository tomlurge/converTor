...
public class DirreqWriteHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public DirreqWriteHistory(java.lang.String date, java.lang.Long interval, java.util.List<java.lang.Long> bytes) {
    this.date = date;
   ...
   */
  public static converTor.bridgeExtra.DirreqWriteHistory.Builder newBuilder() {
    return new converTor.bridgeExtra.DirreqWriteHistory.Builder();
  }
   ...
   * @return A new DirreqWriteHistory RecordBuilder
   */
  public static converTor.bridgeExtra.DirreqWriteHistory.Builder newBuilder(converTor.bridgeExtra.DirreqWriteHistory.Builder other) {
    return new converTor.bridgeExtra.DirreqWriteHistory.Builder(other);
  }
   ...
   * @return A new DirreqWriteHistory RecordBuilder
   */
  public static converTor.bridgeExtra.DirreqWriteHistory.Builder newBuilder(converTor.bridgeExtra.DirreqWriteHistory other) {
    return new converTor.bridgeExtra.DirreqWriteHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirreqWriteHistory>
    ...
    private Builder() {
      super(converTor.bridgeExtra.DirreqWriteHistory.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.bridgeExtra.DirreqWriteHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.bridgeExtra.DirreqWriteHistory other) {
            super(converTor.bridgeExtra.DirreqWriteHistory.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.DirreqWriteHistory.Builder setDate(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.DirreqWriteHistory.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.DirreqWriteHistory.Builder setInterval(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.DirreqWriteHistory.Builder clearInterval() {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.DirreqWriteHistory.Builder setBytes(java.util.List<java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.DirreqWriteHistory.Builder clearBytes() {
      bytes = null;
