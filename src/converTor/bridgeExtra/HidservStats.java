...
public class HidservStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public HidservStats(java.lang.String date, java.lang.Long interval) {
    this.date = date;
   ...
   */
  public static converTor.bridgeExtra.HidservStats.Builder newBuilder() {
    return new converTor.bridgeExtra.HidservStats.Builder();
  }
   ...
   * @return A new HidservStats RecordBuilder
   */
  public static converTor.bridgeExtra.HidservStats.Builder newBuilder(converTor.bridgeExtra.HidservStats.Builder other) {
    return new converTor.bridgeExtra.HidservStats.Builder(other);
  }
   ...
   * @return A new HidservStats RecordBuilder
   */
  public static converTor.bridgeExtra.HidservStats.Builder newBuilder(converTor.bridgeExtra.HidservStats other) {
    return new converTor.bridgeExtra.HidservStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservStats>
    ...
    private Builder() {
      super(converTor.bridgeExtra.HidservStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.bridgeExtra.HidservStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.bridgeExtra.HidservStats other) {
            super(converTor.bridgeExtra.HidservStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.HidservStats.Builder setDate(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.HidservStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.HidservStats.Builder setInterval(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.HidservStats.Builder clearInterval() {
