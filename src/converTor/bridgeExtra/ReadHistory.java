...
public class ReadHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ReadHistory\",\"namespace\":\"converTor.bridgeExtra\",\"fields\":[{\"name\":\"date\",\"type\":\"string\"},{\"name\":\"interval\",\"type\":\"long\"},{\"name\":\"bytes\",\"type\":{\"type\":\"array\",\"items\":\"long\"}}]}");
  ...
  public static converTor.bridgeExtra.ReadHistory.Builder newBuilder() {
    return new converTor.bridgeExtra.ReadHistory.Builder();
  }
  
  /** Creates a new ReadHistory RecordBuilder by copying an existing Builder */
  public static converTor.bridgeExtra.ReadHistory.Builder newBuilder(converTor.bridgeExtra.ReadHistory.Builder other) {
    return new converTor.bridgeExtra.ReadHistory.Builder(other);
  }
  
  /** Creates a new ReadHistory RecordBuilder by copying an existing ReadHistory instance */
  public static converTor.bridgeExtra.ReadHistory.Builder newBuilder(converTor.bridgeExtra.ReadHistory other) {
    return new converTor.bridgeExtra.ReadHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ReadHistory>
    ...
    private Builder() {
      super(converTor.bridgeExtra.ReadHistory.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(converTor.bridgeExtra.ReadHistory.Builder other) {
      super(other);
    ...
    private Builder(converTor.bridgeExtra.ReadHistory other) {
            super(converTor.bridgeExtra.ReadHistory.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'date' field */
    public converTor.bridgeExtra.ReadHistory.Builder setDate(java.lang.CharSequence value) {
    ...
    public converTor.bridgeExtra.ReadHistory.Builder clearDate() {
      date = null;
    ...
    /** Sets the value of the 'interval' field */
    public converTor.bridgeExtra.ReadHistory.Builder setInterval(long value) {
    ...
    public converTor.bridgeExtra.ReadHistory.Builder clearInterval() {
    ...
    /** Sets the value of the 'bytes' field */
    public converTor.bridgeExtra.ReadHistory.Builder setBytes(java.util.List<java.lang.Long> value) {
    ...
    public converTor.bridgeExtra.ReadHistory.Builder clearBytes() {
      bytes = null;
