...
public class HidservRendRelayedCells extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"HidservRendRelayedCells\",\"namespace\":\"converTor.bridgeExtra\",\"fields\":[{\"name\":\"cells\",\"type\":\"int\"},{\"name\":\"obfuscation\",\"type\":{\"type\":\"map\",\"values\":\"int\"}}]}");
  ...
  public static converTor.bridgeExtra.HidservRendRelayedCells.Builder newBuilder() {
    return new converTor.bridgeExtra.HidservRendRelayedCells.Builder();
  }
  
  /** Creates a new HidservRendRelayedCells RecordBuilder by copying an existing Builder */
  public static converTor.bridgeExtra.HidservRendRelayedCells.Builder newBuilder(converTor.bridgeExtra.HidservRendRelayedCells.Builder other) {
    return new converTor.bridgeExtra.HidservRendRelayedCells.Builder(other);
  }
  
  /** Creates a new HidservRendRelayedCells RecordBuilder by copying an existing HidservRendRelayedCells instance */
  public static converTor.bridgeExtra.HidservRendRelayedCells.Builder newBuilder(converTor.bridgeExtra.HidservRendRelayedCells other) {
    return new converTor.bridgeExtra.HidservRendRelayedCells.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservRendRelayedCells>
    ...
    private Builder() {
      super(converTor.bridgeExtra.HidservRendRelayedCells.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(converTor.bridgeExtra.HidservRendRelayedCells.Builder other) {
      super(other);
    ...
    private Builder(converTor.bridgeExtra.HidservRendRelayedCells other) {
            super(converTor.bridgeExtra.HidservRendRelayedCells.SCHEMA$);
      if (isValidValue(fields()[0], other.cells)) {
        this.cells = data().deepCopy(fields()[0].schema(), other.cells);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'cells' field */
    public converTor.bridgeExtra.HidservRendRelayedCells.Builder setCells(int value) {
    ...
    public converTor.bridgeExtra.HidservRendRelayedCells.Builder clearCells() {
    ...
    /** Sets the value of the 'obfuscation' field */
    public converTor.bridgeExtra.HidservRendRelayedCells.Builder setObfuscation(java.util.Map<java.lang.CharSequence,java.lang.Integer> value) {
    ...
    public converTor.bridgeExtra.HidservRendRelayedCells.Builder clearObfuscation() {
      obfuscation = null;
