...
public class ConnBiDirect extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static converTor.bridgeExtra.ConnBiDirect.Builder newBuilder() {
    return new converTor.bridgeExtra.ConnBiDirect.Builder();
  }
   ...
   * @return A new ConnBiDirect RecordBuilder
   */
  public static converTor.bridgeExtra.ConnBiDirect.Builder newBuilder(converTor.bridgeExtra.ConnBiDirect.Builder other) {
    return new converTor.bridgeExtra.ConnBiDirect.Builder(other);
  }
   ...
   * @return A new ConnBiDirect RecordBuilder
   */
  public static converTor.bridgeExtra.ConnBiDirect.Builder newBuilder(converTor.bridgeExtra.ConnBiDirect other) {
    return new converTor.bridgeExtra.ConnBiDirect.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ConnBiDirect>
    ...
    private Builder() {
      super(converTor.bridgeExtra.ConnBiDirect.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.bridgeExtra.ConnBiDirect.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.bridgeExtra.ConnBiDirect other) {
            super(converTor.bridgeExtra.ConnBiDirect.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder setDate(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder setInterval(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder clearInterval() {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder setBelow(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder clearBelow() {
      below = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder setRead(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder clearRead() {
      read = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder setWrite(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder clearWrite() {
      write = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder setBoth(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridgeExtra.ConnBiDirect.Builder clearBoth() {
      both = null;
