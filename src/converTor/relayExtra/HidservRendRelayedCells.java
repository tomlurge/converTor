...
public class HidservRendRelayedCells extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"HidservRendRelayedCells\",\"namespace\":\"converTor.relayExtra\",\"fields\":[{\"name\":\"cells\",\"type\":\"int\"},{\"name\":\"obfuscation\",\"type\":{\"type\":\"map\",\"values\":\"int\"}}]}");
  ...
  public static converTor.relayExtra.HidservRendRelayedCells.Builder newBuilder() {
    return new converTor.relayExtra.HidservRendRelayedCells.Builder();
  }
  
  /** Creates a new HidservRendRelayedCells RecordBuilder by copying an existing Builder */
  public static converTor.relayExtra.HidservRendRelayedCells.Builder newBuilder(converTor.relayExtra.HidservRendRelayedCells.Builder other) {
    return new converTor.relayExtra.HidservRendRelayedCells.Builder(other);
  }
  
  /** Creates a new HidservRendRelayedCells RecordBuilder by copying an existing HidservRendRelayedCells instance */
  public static converTor.relayExtra.HidservRendRelayedCells.Builder newBuilder(converTor.relayExtra.HidservRendRelayedCells other) {
    return new converTor.relayExtra.HidservRendRelayedCells.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservRendRelayedCells>
    ...
    private Builder() {
      super(converTor.relayExtra.HidservRendRelayedCells.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(converTor.relayExtra.HidservRendRelayedCells.Builder other) {
      super(other);
    ...
    private Builder(converTor.relayExtra.HidservRendRelayedCells other) {
            super(converTor.relayExtra.HidservRendRelayedCells.SCHEMA$);
      if (isValidValue(fields()[0], other.cells)) {
        this.cells = data().deepCopy(fields()[0].schema(), other.cells);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'cells' field */
    public converTor.relayExtra.HidservRendRelayedCells.Builder setCells(int value) {
    ...
    public converTor.relayExtra.HidservRendRelayedCells.Builder clearCells() {
    ...
    public converTor.relayExtra.HidservRendRelayedCells.Builder clearObfuscation() {
      obfuscation = null;
