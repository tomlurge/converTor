...
public class EntryStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -906386735724138543L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EntryStats\",\"namespace\":\"converTor.relayExtra\",\"fields\":[{\"name\":\"date\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getEntryStatsEndMillis()\"},{\"name\":\"interval\",\"type\":\"long\",\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getEntryStatsIntervalLength()\",\"default\":86400}]}");
   ...
   */
  public EntryStats(java.lang.String date, java.lang.Long interval) {
    this.date = date;
   ...
   */
  public static converTor.relayExtra.EntryStats.Builder newBuilder() {
    return new converTor.relayExtra.EntryStats.Builder();
  }
   ...
   * @return A new EntryStats RecordBuilder
   */
  public static converTor.relayExtra.EntryStats.Builder newBuilder(converTor.relayExtra.EntryStats.Builder other) {
    return new converTor.relayExtra.EntryStats.Builder(other);
  }
   ...
   * @return A new EntryStats RecordBuilder
   */
  public static converTor.relayExtra.EntryStats.Builder newBuilder(converTor.relayExtra.EntryStats other) {
    return new converTor.relayExtra.EntryStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EntryStats>
    ...
    private Builder() {
      super(converTor.relayExtra.EntryStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.relayExtra.EntryStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.relayExtra.EntryStats other) {
            super(converTor.relayExtra.EntryStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.EntryStats.Builder setDate(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.EntryStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.EntryStats.Builder setInterval(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.EntryStats.Builder clearInterval() {
