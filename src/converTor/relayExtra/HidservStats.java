...
public class HidservStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2198912526417453694L;
   ...
   */
  public static converTor.relayExtra.HidservStats.Builder newBuilder() {
    return new converTor.relayExtra.HidservStats.Builder();
  }
   ...
   * @return A new HidservStats RecordBuilder
   */
  public static converTor.relayExtra.HidservStats.Builder newBuilder(converTor.relayExtra.HidservStats.Builder other) {
    return new converTor.relayExtra.HidservStats.Builder(other);
  }
   ...
   * @return A new HidservStats RecordBuilder
   */
  public static converTor.relayExtra.HidservStats.Builder newBuilder(converTor.relayExtra.HidservStats other) {
    return new converTor.relayExtra.HidservStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservStats>
    ...
    private Builder() {
      super(converTor.relayExtra.HidservStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.relayExtra.HidservStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.relayExtra.HidservStats other) {
            super(converTor.relayExtra.HidservStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.HidservStats.Builder setDate(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.HidservStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.HidservStats.Builder setInterval(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.HidservStats.Builder clearInterval() {
