...
public class CellStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7281271238409784436L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CellStats\",\"namespace\":\"converTor.relayExtra\",\"fields\":[{\"name\":\"date\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getCellStatsEndMillis()\"},{\"name\":\"interval\",\"type\":\"long\",\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getCellStatsIntervalLength()\",\"default\":86400}]}");
   ...
   */
  public CellStats(java.lang.String date, java.lang.Long interval) {
    this.date = date;
   ...
   */
  public static converTor.relayExtra.CellStats.Builder newBuilder() {
    return new converTor.relayExtra.CellStats.Builder();
  }
   ...
   * @return A new CellStats RecordBuilder
   */
  public static converTor.relayExtra.CellStats.Builder newBuilder(converTor.relayExtra.CellStats.Builder other) {
    return new converTor.relayExtra.CellStats.Builder(other);
  }
   ...
   * @return A new CellStats RecordBuilder
   */
  public static converTor.relayExtra.CellStats.Builder newBuilder(converTor.relayExtra.CellStats other) {
    return new converTor.relayExtra.CellStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CellStats>
    ...
    private Builder() {
      super(converTor.relayExtra.CellStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.relayExtra.CellStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.relayExtra.CellStats other) {
            super(converTor.relayExtra.CellStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.CellStats.Builder setDate(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.CellStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.CellStats.Builder setInterval(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.CellStats.Builder clearInterval() {
