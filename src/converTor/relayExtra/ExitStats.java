...
public class ExitStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -464232461248687422L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ExitStats\",\"namespace\":\"converTor.relayExtra\",\"fields\":[{\"name\":\"date\",\"type\":\"string\",\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getExitStatsEndMillis()\"},{\"name\":\"interval\",\"type\":\"long\",\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getExitStatsIntervalLength()\",\"default\":86400}]}");
   ...
   */
  public static converTor.relayExtra.ExitStats.Builder newBuilder() {
    return new converTor.relayExtra.ExitStats.Builder();
  }
   ...
   * @return A new ExitStats RecordBuilder
   */
  public static converTor.relayExtra.ExitStats.Builder newBuilder(converTor.relayExtra.ExitStats.Builder other) {
    return new converTor.relayExtra.ExitStats.Builder(other);
  }
   ...
   * @return A new ExitStats RecordBuilder
   */
  public static converTor.relayExtra.ExitStats.Builder newBuilder(converTor.relayExtra.ExitStats other) {
    return new converTor.relayExtra.ExitStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExitStats>
    ...
    private Builder() {
      super(converTor.relayExtra.ExitStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(converTor.relayExtra.ExitStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(converTor.relayExtra.ExitStats other) {
            super(converTor.relayExtra.ExitStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.ExitStats.Builder setDate(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.ExitStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.ExitStats.Builder setInterval(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.relayExtra.ExitStats.Builder clearInterval() {
