...
public class Bandwidth extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Bandwidth\",\"namespace\":\"converTor.bridge\",\"fields\":[{\"name\":\"avg\",\"type\":[\"null\",\"int\"]},{\"name\":\"burst\",\"type\":[\"null\",\"int\"]},{\"name\":\"observed\",\"type\":[\"null\",\"int\"]}]}");
  ...
  public static converTor.bridge.Bandwidth.Builder newBuilder() {
    return new converTor.bridge.Bandwidth.Builder();
  }
  
  /** Creates a new Bandwidth RecordBuilder by copying an existing Builder */
  public static converTor.bridge.Bandwidth.Builder newBuilder(converTor.bridge.Bandwidth.Builder other) {
    return new converTor.bridge.Bandwidth.Builder(other);
  }
  
  /** Creates a new Bandwidth RecordBuilder by copying an existing Bandwidth instance */
  public static converTor.bridge.Bandwidth.Builder newBuilder(converTor.bridge.Bandwidth other) {
    return new converTor.bridge.Bandwidth.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Bandwidth>
    ...
    private Builder() {
      super(converTor.bridge.Bandwidth.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(converTor.bridge.Bandwidth.Builder other) {
      super(other);
    ...
    private Builder(converTor.bridge.Bandwidth other) {
            super(converTor.bridge.Bandwidth.SCHEMA$);
      if (isValidValue(fields()[0], other.avg)) {
        this.avg = data().deepCopy(fields()[0].schema(), other.avg);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'avg' field */
    public converTor.bridge.Bandwidth.Builder setAvg(java.lang.Integer value) {
    ...
    public converTor.bridge.Bandwidth.Builder clearAvg() {
      avg = null;
    ...
    /** Sets the value of the 'burst' field */
    public converTor.bridge.Bandwidth.Builder setBurst(java.lang.Integer value) {
    ...
    public converTor.bridge.Bandwidth.Builder clearBurst() {
      burst = null;
    ...
    /** Sets the value of the 'observed' field */
    public converTor.bridge.Bandwidth.Builder setObserved(java.lang.Integer value) {
    ...
    public converTor.bridge.Bandwidth.Builder clearObserved() {
      observed = null;
