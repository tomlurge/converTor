...
public class OrAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrAddress\",\"namespace\":\"converTor.bridge\",\"fields\":[{\"name\":\"address\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"implementation specific\"},{\"name\":\"port\",\"type\":\"int\",\"doc\":\"implementation specific\"}]}");
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrAddress>
    ...
    /**
      ...
      * @return This builder.
      */
    public converTor.bridge.OrAddress.Builder setAddress(java.lang.String value) {
