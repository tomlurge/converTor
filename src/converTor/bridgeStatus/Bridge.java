...
public class Bridge extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Bridge(converTor.bridgeStatus.R r, java.util.List<java.lang.CharSequence> s, converTor.bridgeStatus.W w, java.lang.CharSequence p, java.lang.CharSequence a, java.lang.CharSequence v) {
    this.r = r;
    this.s = s;
    this.w = w;
    this.p = p;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: w = (converTor.bridgeStatus.W)value$; break;
  ...
  public static converTor.bridgeStatus.Bridge.Builder newBuilder() {
    return new converTor.bridgeStatus.Bridge.Builder();
  }
  
  /** Creates a new Bridge RecordBuilder by copying an existing Builder */
  public static converTor.bridgeStatus.Bridge.Builder newBuilder(converTor.bridgeStatus.Bridge.Builder other) {
    return new converTor.bridgeStatus.Bridge.Builder(other);
  }
  
  /** Creates a new Bridge RecordBuilder by copying an existing Bridge instance */
  public static converTor.bridgeStatus.Bridge.Builder newBuilder(converTor.bridgeStatus.Bridge other) {
    return new converTor.bridgeStatus.Bridge.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Bridge>
    ...
    private Builder() {
      super(converTor.bridgeStatus.Bridge.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(converTor.bridgeStatus.Bridge.Builder other) {
      super(other);
    ...
    private Builder(converTor.bridgeStatus.Bridge other) {
            super(converTor.bridgeStatus.Bridge.SCHEMA$);
      if (isValidValue(fields()[0], other.r)) {
        this.r = data().deepCopy(fields()[0].schema(), other.r);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'r' field */
    public converTor.bridgeStatus.Bridge.Builder setR(converTor.bridgeStatus.R value) {
    ...
    public converTor.bridgeStatus.Bridge.Builder clearR() {
      r = null;
    ...
    /** Sets the value of the 's' field */
    public converTor.bridgeStatus.Bridge.Builder setS(java.util.List<java.lang.CharSequence> value) {
    ...
    public converTor.bridgeStatus.Bridge.Builder clearS() {
      s = null;
    ...
    /** Sets the value of the 'w' field */
    public converTor.bridgeStatus.Bridge.Builder setW(converTor.bridgeStatus.W value) {
    ...
    public converTor.bridgeStatus.Bridge.Builder clearW() {
      w = null;
    ...
    /** Sets the value of the 'p' field */
    public converTor.bridgeStatus.Bridge.Builder setP(java.lang.CharSequence value) {
    ...
    public converTor.bridgeStatus.Bridge.Builder clearP() {
      p = null;
    ...
    /** Sets the value of the 'a' field */
    public converTor.bridgeStatus.Bridge.Builder setA(java.lang.CharSequence value) {
    ...
    public converTor.bridgeStatus.Bridge.Builder clearA() {
      a = null;
    ...
    /** Sets the value of the 'v' field */
    public converTor.bridgeStatus.Bridge.Builder setV(java.lang.CharSequence value) {
    ...
    public converTor.bridgeStatus.Bridge.Builder clearV() {
      v = null;
    ...
    public Bridge build() {
      try {
        ...
        record.w = fieldSetFlags()[2] ? this.w : (converTor.bridgeStatus.W) defaultValue(fields()[2]);
