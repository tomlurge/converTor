...
public class HidservDirOnionsSeen extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5984571852009431232L;
   ...
   */
  public static convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder newBuilder() {
    return new convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder();
  }
   ...
   * @return A new HidservDirOnionsSeen RecordBuilder
   */
  public static convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder newBuilder(convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder other) {
    return new convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder(other);
  }
   ...
   * @return A new HidservDirOnionsSeen RecordBuilder
   */
  public static convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder newBuilder(convertor.encoders.bridgeExtra.HidservDirOnionsSeen other) {
    return new convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservDirOnionsSeen>
    ...
    private Builder() {
      super(convertor.encoders.bridgeExtra.HidservDirOnionsSeen.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(convertor.encoders.bridgeExtra.HidservDirOnionsSeen other) {
            super(convertor.encoders.bridgeExtra.HidservDirOnionsSeen.SCHEMA$);
      if (isValidValue(fields()[0], other.onions)) {
        this.onions = data().deepCopy(fields()[0].schema(), other.onions);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder setOnions(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder clearOnions() {
      onions = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder setObfuscation(java.util.Map<java.lang.String,java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.bridgeExtra.HidservDirOnionsSeen.Builder clearObfuscation() {
      obfuscation = null;
