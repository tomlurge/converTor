...
public class DirSig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static convertor.encoders.relayVote.DirSig.Builder newBuilder() {
    return new convertor.encoders.relayVote.DirSig.Builder();
  }
   ...
   * @return A new DirSig RecordBuilder
   */
  public static convertor.encoders.relayVote.DirSig.Builder newBuilder(convertor.encoders.relayVote.DirSig.Builder other) {
    return new convertor.encoders.relayVote.DirSig.Builder(other);
  }
   ...
   * @return A new DirSig RecordBuilder
   */
  public static convertor.encoders.relayVote.DirSig.Builder newBuilder(convertor.encoders.relayVote.DirSig other) {
    return new convertor.encoders.relayVote.DirSig.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirSig>
    ...
    private Builder() {
      super(convertor.encoders.relayVote.DirSig.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(convertor.encoders.relayVote.DirSig.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(convertor.encoders.relayVote.DirSig other) {
            super(convertor.encoders.relayVote.DirSig.SCHEMA$);
      if (isValidValue(fields()[0], other.algorithm)) {
        this.algorithm = data().deepCopy(fields()[0].schema(), other.algorithm);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relayVote.DirSig.Builder setAlgorithm(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relayVote.DirSig.Builder clearAlgorithm() {
      algorithm = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relayVote.DirSig.Builder setIdentity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relayVote.DirSig.Builder clearIdentity() {
      identity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relayVote.DirSig.Builder setSigningKeyDigest(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relayVote.DirSig.Builder clearSigningKeyDigest() {
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relayVote.DirSig.Builder setSignature(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public convertor.encoders.relayVote.DirSig.Builder clearSignature() {
      signature = null;
