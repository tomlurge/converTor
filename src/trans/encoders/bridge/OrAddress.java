...
public class OrAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1009050871405458050L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrAddress\",\"namespace\":\"trans.encoders.bridge\",\"fields\":[{\"name\":\"address\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"implementation specific, see actual converter\"},{\"name\":\"port\",\"type\":[\"null\",\"int\"],\"doc\":\"implementation specific, see actual converter\"}]}");
   ...
   */
  public static trans.encoders.bridge.OrAddress.Builder newBuilder() {
    return new trans.encoders.bridge.OrAddress.Builder();
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static trans.encoders.bridge.OrAddress.Builder newBuilder(trans.encoders.bridge.OrAddress.Builder other) {
    return new trans.encoders.bridge.OrAddress.Builder(other);
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static trans.encoders.bridge.OrAddress.Builder newBuilder(trans.encoders.bridge.OrAddress other) {
    return new trans.encoders.bridge.OrAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrAddress>
    ...
    private Builder() {
      super(trans.encoders.bridge.OrAddress.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.bridge.OrAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.bridge.OrAddress other) {
            super(trans.encoders.bridge.OrAddress.SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridge.OrAddress.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridge.OrAddress.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridge.OrAddress.Builder setPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridge.OrAddress.Builder clearPort() {
      port = null;
