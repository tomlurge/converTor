...
public class Vote extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2676529507392547440L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Vote\",\"namespace\":\"trans.encoders.relayConsensus\",\"fields\":[{\"name\":\"vote_seconds\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/RelayNetworkStatusConsensus: long getVoteSeconds()\"},{\"name\":\"dist_seconds\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/RelayNetworkStatusConsensus: long getDistSeconds()\"}]}");
   ...
   */
  public static trans.encoders.relayConsensus.Vote.Builder newBuilder() {
    return new trans.encoders.relayConsensus.Vote.Builder();
  }
   ...
   * @return A new Vote RecordBuilder
   */
  public static trans.encoders.relayConsensus.Vote.Builder newBuilder(trans.encoders.relayConsensus.Vote.Builder other) {
    return new trans.encoders.relayConsensus.Vote.Builder(other);
  }
   ...
   * @return A new Vote RecordBuilder
   */
  public static trans.encoders.relayConsensus.Vote.Builder newBuilder(trans.encoders.relayConsensus.Vote other) {
    return new trans.encoders.relayConsensus.Vote.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Vote>
    ...
    private Builder() {
      super(trans.encoders.relayConsensus.Vote.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayConsensus.Vote.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayConsensus.Vote other) {
            super(trans.encoders.relayConsensus.Vote.SCHEMA$);
      if (isValidValue(fields()[0], other.vote_seconds)) {
        this.vote_seconds = data().deepCopy(fields()[0].schema(), other.vote_seconds);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.Vote.Builder setVoteSeconds(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.Vote.Builder clearVoteSeconds() {
      vote_seconds = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.Vote.Builder setDistSeconds(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.Vote.Builder clearDistSeconds() {
      dist_seconds = null;
