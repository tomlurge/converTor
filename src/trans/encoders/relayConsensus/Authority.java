...
public class Authority extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Authority(trans.encoders.relayConsensus.DirSource dir_source, java.lang.String contact, java.lang.String vote_digest) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: dir_source = (trans.encoders.relayConsensus.DirSource)value$; break;
   ...
   */
  public trans.encoders.relayConsensus.DirSource getDirSource() {
    return dir_source;
  }
   ...
   */
  public void setDirSource(trans.encoders.relayConsensus.DirSource value) {
   ...
   */
  public static trans.encoders.relayConsensus.Authority.Builder newBuilder() {
    return new trans.encoders.relayConsensus.Authority.Builder();
  }
   ...
   * @return A new Authority RecordBuilder
   */
  public static trans.encoders.relayConsensus.Authority.Builder newBuilder(trans.encoders.relayConsensus.Authority.Builder other) {
    return new trans.encoders.relayConsensus.Authority.Builder(other);
  }
   ...
   * @return A new Authority RecordBuilder
   */
  public static trans.encoders.relayConsensus.Authority.Builder newBuilder(trans.encoders.relayConsensus.Authority other) {
    return new trans.encoders.relayConsensus.Authority.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Authority>
    ...
    private trans.encoders.relayConsensus.DirSource dir_source;
    private trans.encoders.relayConsensus.DirSource.Builder dir_sourceBuilder;
    /** metrics-lib/DirSourceEntry: String getContactLine() */
    ...
    private Builder() {
      super(trans.encoders.relayConsensus.Authority.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayConsensus.Authority.Builder other) {
      super(other);
      ...
      if (other.hasDirSourceBuilder()) {
        this.dir_sourceBuilder = trans.encoders.relayConsensus.DirSource.newBuilder(other.getDirSourceBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayConsensus.Authority other) {
            super(trans.encoders.relayConsensus.Authority.SCHEMA$);
      if (isValidValue(fields()[0], other.dir_source)) {
        this.dir_source = data().deepCopy(fields()[0].schema(), other.dir_source);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.Authority.Builder setDirSource(trans.encoders.relayConsensus.DirSource value) {
     ...
     * @return This builder.
     */
    public trans.encoders.relayConsensus.DirSource.Builder getDirSourceBuilder() {
      if (dir_sourceBuilder == null) {
        if (hasDirSource()) {
          setDirSourceBuilder(trans.encoders.relayConsensus.DirSource.newBuilder(dir_source));
        } else {
          setDirSourceBuilder(trans.encoders.relayConsensus.DirSource.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public trans.encoders.relayConsensus.Authority.Builder setDirSourceBuilder(trans.encoders.relayConsensus.DirSource.Builder value) {
      clearDirSource();
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.Authority.Builder clearDirSource() {
      dir_source = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.Authority.Builder setContact(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.Authority.Builder clearContact() {
      contact = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.Authority.Builder setVoteDigest(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.Authority.Builder clearVoteDigest() {
      vote_digest = null;
    ...
    public Authority build() {
      try {
        ...
        if (dir_sourceBuilder != null) {
          ...
          record.dir_source = fieldSetFlags()[0] ? this.dir_source : (trans.encoders.relayConsensus.DirSource) defaultValue(fields()[0]);
        }
