...
public class DirSig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static trans.encoders.relayConsensus.DirSig.Builder newBuilder() {
    return new trans.encoders.relayConsensus.DirSig.Builder();
  }
   ...
   * @return A new DirSig RecordBuilder
   */
  public static trans.encoders.relayConsensus.DirSig.Builder newBuilder(trans.encoders.relayConsensus.DirSig.Builder other) {
    return new trans.encoders.relayConsensus.DirSig.Builder(other);
  }
   ...
   * @return A new DirSig RecordBuilder
   */
  public static trans.encoders.relayConsensus.DirSig.Builder newBuilder(trans.encoders.relayConsensus.DirSig other) {
    return new trans.encoders.relayConsensus.DirSig.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirSig>
    ...
    private Builder() {
      super(trans.encoders.relayConsensus.DirSig.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayConsensus.DirSig.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayConsensus.DirSig other) {
            super(trans.encoders.relayConsensus.DirSig.SCHEMA$);
      if (isValidValue(fields()[0], other.algorithm)) {
        this.algorithm = data().deepCopy(fields()[0].schema(), other.algorithm);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirSig.Builder setAlgorithm(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirSig.Builder clearAlgorithm() {
      algorithm = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirSig.Builder setIdentity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirSig.Builder clearIdentity() {
      identity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirSig.Builder setSigningKeyDigest(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirSig.Builder clearSigningKeyDigest() {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirSig.Builder setSignature(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirSig.Builder clearSignature() {
      signature = null;
