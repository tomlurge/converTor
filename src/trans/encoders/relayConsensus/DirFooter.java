...
public class DirFooter extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<trans.encoders.relayConsensus.DirSig> directory_signature;
   ...
   */
  public DirFooter(java.util.Map<java.lang.String,java.lang.Integer> bandwidth_weights, java.lang.String consensus_digest, java.util.List<trans.encoders.relayConsensus.DirSig> directory_signature) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: directory_signature = (java.util.List<trans.encoders.relayConsensus.DirSig>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<trans.encoders.relayConsensus.DirSig> getDirectorySignature() {
   ...
   * @param value the value to set.
   */
  public void setDirectorySignature(java.util.List<trans.encoders.relayConsensus.DirSig> value) {
   ...
   */
  public static trans.encoders.relayConsensus.DirFooter.Builder newBuilder() {
    return new trans.encoders.relayConsensus.DirFooter.Builder();
  }
   ...
   * @return A new DirFooter RecordBuilder
   */
  public static trans.encoders.relayConsensus.DirFooter.Builder newBuilder(trans.encoders.relayConsensus.DirFooter.Builder other) {
    return new trans.encoders.relayConsensus.DirFooter.Builder(other);
  }
   ...
   * @return A new DirFooter RecordBuilder
   */
  public static trans.encoders.relayConsensus.DirFooter.Builder newBuilder(trans.encoders.relayConsensus.DirFooter other) {
    return new trans.encoders.relayConsensus.DirFooter.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirFooter>
    ...
    /** metrics-lib/RelayNetworkStatusConsensus: List<DirectorySignature> getSignatures() */
    private java.util.List<trans.encoders.relayConsensus.DirSig> directory_signature;

    /** Creates a new Builder */
    private Builder() {
      super(trans.encoders.relayConsensus.DirFooter.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayConsensus.DirFooter.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayConsensus.DirFooter other) {
            super(trans.encoders.relayConsensus.DirFooter.SCHEMA$);
      if (isValidValue(fields()[0], other.bandwidth_weights)) {
        this.bandwidth_weights = data().deepCopy(fields()[0].schema(), other.bandwidth_weights);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirFooter.Builder setBandwidthWeights(java.util.Map<java.lang.String,java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirFooter.Builder clearBandwidthWeights() {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirFooter.Builder setConsensusDigest(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirFooter.Builder clearConsensusDigest() {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirFooter.Builder setDirectorySignature(java.util.List<trans.encoders.relayConsensus.DirSig> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayConsensus.DirFooter.Builder clearDirectorySignature() {
    ...
    public DirFooter build() {
      try {
        ...
        record.directory_signature = fieldSetFlags()[2] ? this.directory_signature : (java.util.List<trans.encoders.relayConsensus.DirSig>) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
