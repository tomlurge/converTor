 ...
 */
package trans.encoders.tordnsel;  
...
public class Tordnsel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<trans.encoders.tordnsel.ExitNode> exit_nodes;
   ...
   */
  public Tordnsel(java.lang.String descriptor_type, java.lang.Long src_date, java.lang.Long downloaded, java.util.List<trans.encoders.tordnsel.ExitNode> exit_nodes) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: exit_nodes = (java.util.List<trans.encoders.tordnsel.ExitNode>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<trans.encoders.tordnsel.ExitNode> getExitNodes() {
    return exit_nodes;
  }
   ...
   * @param value the value to set.
   */
  public void setExitNodes(java.util.List<trans.encoders.tordnsel.ExitNode> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Tordnsel>
    ...
    /** metrics-lib/ExitList: Set<ExitList.Entry> getEntries() */
    private java.util.List<trans.encoders.tordnsel.ExitNode> exit_nodes;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.tordnsel.Tordnsel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.tordnsel.Tordnsel other) {
            super(trans.encoders.tordnsel.Tordnsel.SCHEMA$);
      if (isValidValue(fields()[0], other.descriptor_type)) {
        this.descriptor_type = data().deepCopy(fields()[0].schema(), other.descriptor_type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.Tordnsel.Builder setDescriptorType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.Tordnsel.Builder clearDescriptorType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.Tordnsel.Builder setSrcDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.Tordnsel.Builder clearSrcDate() {
      src_date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.Tordnsel.Builder clearDownloaded() {
      downloaded = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.Tordnsel.Builder setExitNodes(java.util.List<trans.encoders.tordnsel.ExitNode> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.Tordnsel.Builder clearExitNodes() {
      exit_nodes = null;
    ...
    public Tordnsel build() {
      try {
        ...
        record.exit_nodes = fieldSetFlags()[3] ? this.exit_nodes : (java.util.List<trans.encoders.tordnsel.ExitNode>) defaultValue(fields()[3]);
        return record;
      } catch (Exception e) {
