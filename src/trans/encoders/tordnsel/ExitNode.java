...
public class ExitNode extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static trans.encoders.tordnsel.ExitNode.Builder newBuilder() {
    return new trans.encoders.tordnsel.ExitNode.Builder();
  }
   ...
   * @return A new ExitNode RecordBuilder
   */
  public static trans.encoders.tordnsel.ExitNode.Builder newBuilder(trans.encoders.tordnsel.ExitNode.Builder other) {
    return new trans.encoders.tordnsel.ExitNode.Builder(other);
  }
   ...
   * @return A new ExitNode RecordBuilder
   */
  public static trans.encoders.tordnsel.ExitNode.Builder newBuilder(trans.encoders.tordnsel.ExitNode other) {
    return new trans.encoders.tordnsel.ExitNode.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExitNode>
    ...
    private Builder() {
      super(trans.encoders.tordnsel.ExitNode.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.tordnsel.ExitNode.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.tordnsel.ExitNode other) {
            super(trans.encoders.tordnsel.ExitNode.SCHEMA$);
      if (isValidValue(fields()[0], other.fingerprint)) {
        this.fingerprint = data().deepCopy(fields()[0].schema(), other.fingerprint);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.ExitNode.Builder setFingerprint(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.ExitNode.Builder clearFingerprint() {
      fingerprint = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.ExitNode.Builder setPublished(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.ExitNode.Builder clearPublished() {
      published = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.ExitNode.Builder setLastStatus(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.ExitNode.Builder clearLastStatus() {
      last_status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.ExitNode.Builder setExitAdresses(java.util.Map<java.lang.String,java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.tordnsel.ExitNode.Builder clearExitAdresses() {
      exit_adresses = null;
