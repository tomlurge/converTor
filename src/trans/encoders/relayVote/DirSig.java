...
public class DirSig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static trans.encoders.relayVote.DirSig.Builder newBuilder() {
    return new trans.encoders.relayVote.DirSig.Builder();
  }
   ...
   * @return A new DirSig RecordBuilder
   */
  public static trans.encoders.relayVote.DirSig.Builder newBuilder(trans.encoders.relayVote.DirSig.Builder other) {
    return new trans.encoders.relayVote.DirSig.Builder(other);
  }
   ...
   * @return A new DirSig RecordBuilder
   */
  public static trans.encoders.relayVote.DirSig.Builder newBuilder(trans.encoders.relayVote.DirSig other) {
    return new trans.encoders.relayVote.DirSig.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirSig>
    ...
    private Builder() {
      super(trans.encoders.relayVote.DirSig.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayVote.DirSig.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayVote.DirSig other) {
            super(trans.encoders.relayVote.DirSig.SCHEMA$);
      if (isValidValue(fields()[0], other.algorithm)) {
        this.algorithm = data().deepCopy(fields()[0].schema(), other.algorithm);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.DirSig.Builder setAlgorithm(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.DirSig.Builder clearAlgorithm() {
      algorithm = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.DirSig.Builder setIdentity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.DirSig.Builder clearIdentity() {
      identity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.DirSig.Builder setSigningKeyDigest(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.DirSig.Builder clearSigningKeyDigest() {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.DirSig.Builder setSignature(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.DirSig.Builder clearSignature() {
      signature = null;
