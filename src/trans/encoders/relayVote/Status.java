...
public class Status extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** see above */
  @Deprecated public trans.encoders.relayVote.W w;
  /** see above */
  @Deprecated public trans.encoders.relayVote.Policy p;
  /** see above */
  @Deprecated public trans.encoders.relayVote.ID id;
   ...
   * @param id see above
   */
  public Status(trans.encoders.relayVote.R r, java.util.List<trans.encoders.relayVote.OrAddress> a, java.util.List<java.lang.String> s, java.lang.String v, trans.encoders.relayVote.W w, trans.encoders.relayVote.Policy p, trans.encoders.relayVote.ID id) {
    this.r = r;
    this.a = a;
    this.s = s;
    this.v = v;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: r = (trans.encoders.relayVote.R)value$; break;
    case 1: a = (java.util.List<trans.encoders.relayVote.OrAddress>)value$; break;
    case 2: s = (java.util.List<java.lang.String>)value$; break;
    case 3: v = (java.lang.String)value$; break;
    case 4: w = (trans.encoders.relayVote.W)value$; break;
    case 5: p = (trans.encoders.relayVote.Policy)value$; break;
    case 6: id = (trans.encoders.relayVote.ID)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public trans.encoders.relayVote.R getR() {
    return r;
  }
   ...
   */
  public void setR(trans.encoders.relayVote.R value) {
    this.r = value;
  }
   ...
   */
  public java.util.List<trans.encoders.relayVote.OrAddress> getA() {
    return a;
  }
   ...
   * @param value the value to set.
   */
  public void setA(java.util.List<trans.encoders.relayVote.OrAddress> value) {
    this.a = value;
  }
   ...
   * @return see above
   */
  public trans.encoders.relayVote.W getW() {
    return w;
  }
   ...
   * @param value the value to set.
   */
  public void setW(trans.encoders.relayVote.W value) {
    this.w = value;
  }
   ...
   * @return see above
   */
  public trans.encoders.relayVote.Policy getP() {
    return p;
  }
   ...
   * @param value the value to set.
   */
  public void setP(trans.encoders.relayVote.Policy value) {
    this.p = value;
  }
   ...
   * @return see above
   */
  public trans.encoders.relayVote.ID getId() {
    return id;
  }
   ...
   * @param value the value to set.
   */
  public void setId(trans.encoders.relayVote.ID value) {
    this.id = value;
  }
   ...
   */
  public static trans.encoders.relayVote.Status.Builder newBuilder() {
    return new trans.encoders.relayVote.Status.Builder();
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static trans.encoders.relayVote.Status.Builder newBuilder(trans.encoders.relayVote.Status.Builder other) {
    return new trans.encoders.relayVote.Status.Builder(other);
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static trans.encoders.relayVote.Status.Builder newBuilder(trans.encoders.relayVote.Status other) {
    return new trans.encoders.relayVote.Status.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Status>
    ...
    private trans.encoders.relayVote.R r;
    private trans.encoders.relayVote.R.Builder rBuilder;
    private java.util.List<trans.encoders.relayVote.OrAddress> a;
    /** metrics-lib/NetworkStatusEntry: SortedSet<String> getFlags() */
    private java.util.List<java.lang.String> s;
    /** metrics-lib/NetworkStatusEntry: String getVersion() */
    private java.lang.String v;
    /** see above */
    private trans.encoders.relayVote.W w;
    private trans.encoders.relayVote.W.Builder wBuilder;
    /** see above */
    private trans.encoders.relayVote.Policy p;
    private trans.encoders.relayVote.Policy.Builder pBuilder;
    /** see above */
    private trans.encoders.relayVote.ID id;
    private trans.encoders.relayVote.ID.Builder idBuilder;

    /** Creates a new Builder */
    private Builder() {
      super(trans.encoders.relayVote.Status.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayVote.Status.Builder other) {
      super(other);
      ...
      if (other.hasRBuilder()) {
        this.rBuilder = trans.encoders.relayVote.R.newBuilder(other.getRBuilder());
      }
      ...
      if (other.hasWBuilder()) {
        this.wBuilder = trans.encoders.relayVote.W.newBuilder(other.getWBuilder());
      }
      ...
      if (other.hasPBuilder()) {
        this.pBuilder = trans.encoders.relayVote.Policy.newBuilder(other.getPBuilder());
      }
      ...
      if (other.hasIdBuilder()) {
        this.idBuilder = trans.encoders.relayVote.ID.newBuilder(other.getIdBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayVote.Status other) {
            super(trans.encoders.relayVote.Status.SCHEMA$);
      if (isValidValue(fields()[0], other.r)) {
        this.r = data().deepCopy(fields()[0].schema(), other.r);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder setR(trans.encoders.relayVote.R value) {
     ...
     * @return This builder.
     */
    public trans.encoders.relayVote.R.Builder getRBuilder() {
      if (rBuilder == null) {
        if (hasR()) {
          setRBuilder(trans.encoders.relayVote.R.newBuilder(r));
        } else {
          setRBuilder(trans.encoders.relayVote.R.newBuilder());
        }
      }
      return rBuilder;
    }
     ...
     * @return This builder.
     */
    public trans.encoders.relayVote.Status.Builder setRBuilder(trans.encoders.relayVote.R.Builder value) {
      clearR();
      rBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder clearR() {
      r = null;
      rBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder setA(java.util.List<trans.encoders.relayVote.OrAddress> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder clearA() {
      a = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder setS(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder clearS() {
      s = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder setV(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder clearV() {
      v = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder setW(trans.encoders.relayVote.W value) {
     ...
     * @return This builder.
     */
    public trans.encoders.relayVote.W.Builder getWBuilder() {
      if (wBuilder == null) {
        if (hasW()) {
          setWBuilder(trans.encoders.relayVote.W.newBuilder(w));
        } else {
          setWBuilder(trans.encoders.relayVote.W.newBuilder());
        }
      }
      return wBuilder;
    }
     ...
     * @return This builder.
     */
    public trans.encoders.relayVote.Status.Builder setWBuilder(trans.encoders.relayVote.W.Builder value) {
      clearW();
      wBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder clearW() {
      w = null;
      wBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder setP(trans.encoders.relayVote.Policy value) {
     ...
     * @return This builder.
     */
    public trans.encoders.relayVote.Policy.Builder getPBuilder() {
      if (pBuilder == null) {
        if (hasP()) {
          setPBuilder(trans.encoders.relayVote.Policy.newBuilder(p));
        } else {
          setPBuilder(trans.encoders.relayVote.Policy.newBuilder());
        }
      }
      return pBuilder;
    }
     ...
     * @return This builder.
     */
    public trans.encoders.relayVote.Status.Builder setPBuilder(trans.encoders.relayVote.Policy.Builder value) {
      clearP();
      pBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder clearP() {
      p = null;
      pBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder setId(trans.encoders.relayVote.ID value) {
     ...
     * @return This builder.
     */
    public trans.encoders.relayVote.ID.Builder getIdBuilder() {
      if (idBuilder == null) {
        if (hasId()) {
          setIdBuilder(trans.encoders.relayVote.ID.newBuilder(id));
        } else {
          setIdBuilder(trans.encoders.relayVote.ID.newBuilder());
        }
      }
      return idBuilder;
    }
     ...
     * @return This builder.
     */
    public trans.encoders.relayVote.Status.Builder setIdBuilder(trans.encoders.relayVote.ID.Builder value) {
      clearId();
      idBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Status.Builder clearId() {
      id = null;
      idBuilder = null;
    ...
    public Status build() {
      try {
        ...
        if (rBuilder != null) {
          ...
          record.r = fieldSetFlags()[0] ? this.r : (trans.encoders.relayVote.R) defaultValue(fields()[0]);
        }
        record.a = fieldSetFlags()[1] ? this.a : (java.util.List<trans.encoders.relayVote.OrAddress>) defaultValue(fields()[1]);
        ...
        if (wBuilder != null) {
          ...
          record.w = fieldSetFlags()[4] ? this.w : (trans.encoders.relayVote.W) defaultValue(fields()[4]);
        }
        if (pBuilder != null) {
          record.p = this.pBuilder.build();
        } else {
          record.p = fieldSetFlags()[5] ? this.p : (trans.encoders.relayVote.Policy) defaultValue(fields()[5]);
        }
        if (idBuilder != null) {
          record.id = this.idBuilder.build();
        } else {
          record.id = fieldSetFlags()[6] ? this.id : (trans.encoders.relayVote.ID) defaultValue(fields()[6]);
        }
        return record;
      } catch (Exception e) {
