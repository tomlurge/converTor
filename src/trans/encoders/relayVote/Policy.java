...
public class Policy extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static trans.encoders.relayVote.Policy.Builder newBuilder() {
    return new trans.encoders.relayVote.Policy.Builder();
  }
   ...
   * @return A new Policy RecordBuilder
   */
  public static trans.encoders.relayVote.Policy.Builder newBuilder(trans.encoders.relayVote.Policy.Builder other) {
    return new trans.encoders.relayVote.Policy.Builder(other);
  }
   ...
   * @return A new Policy RecordBuilder
   */
  public static trans.encoders.relayVote.Policy.Builder newBuilder(trans.encoders.relayVote.Policy other) {
    return new trans.encoders.relayVote.Policy.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Policy>
    ...
    private Builder() {
      super(trans.encoders.relayVote.Policy.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayVote.Policy.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayVote.Policy other) {
            super(trans.encoders.relayVote.Policy.SCHEMA$);
      if (isValidValue(fields()[0], other.default_policy)) {
        this.default_policy = data().deepCopy(fields()[0].schema(), other.default_policy);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Policy.Builder setDefaultPolicy(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Policy.Builder clearDefaultPolicy() {
      default_policy = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Policy.Builder setPortSummary(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayVote.Policy.Builder clearPortSummary() {
      port_summary = null;
