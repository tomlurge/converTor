...
public class OrAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2380985061512559876L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrAddress\",\"namespace\":\"trans.encoders.relay\",\"fields\":[{\"name\":\"address\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"implementation specific\"},{\"name\":\"port\",\"type\":[\"null\",\"int\"],\"doc\":\"implementation specific\"}]}");
   ...
   */
  public static trans.encoders.relay.OrAddress.Builder newBuilder() {
    return new trans.encoders.relay.OrAddress.Builder();
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static trans.encoders.relay.OrAddress.Builder newBuilder(trans.encoders.relay.OrAddress.Builder other) {
    return new trans.encoders.relay.OrAddress.Builder(other);
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static trans.encoders.relay.OrAddress.Builder newBuilder(trans.encoders.relay.OrAddress other) {
    return new trans.encoders.relay.OrAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrAddress>
    ...
    private Builder() {
      super(trans.encoders.relay.OrAddress.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relay.OrAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relay.OrAddress other) {
            super(trans.encoders.relay.OrAddress.SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.OrAddress.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.OrAddress.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.OrAddress.Builder setPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.OrAddress.Builder clearPort() {
      port = null;
