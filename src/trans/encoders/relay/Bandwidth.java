...
public class Bandwidth extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static trans.encoders.relay.Bandwidth.Builder newBuilder() {
    return new trans.encoders.relay.Bandwidth.Builder();
  }
   ...
   * @return A new Bandwidth RecordBuilder
   */
  public static trans.encoders.relay.Bandwidth.Builder newBuilder(trans.encoders.relay.Bandwidth.Builder other) {
    return new trans.encoders.relay.Bandwidth.Builder(other);
  }
   ...
   * @return A new Bandwidth RecordBuilder
   */
  public static trans.encoders.relay.Bandwidth.Builder newBuilder(trans.encoders.relay.Bandwidth other) {
    return new trans.encoders.relay.Bandwidth.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Bandwidth>
    ...
    private Builder() {
      super(trans.encoders.relay.Bandwidth.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relay.Bandwidth.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relay.Bandwidth other) {
            super(trans.encoders.relay.Bandwidth.SCHEMA$);
      if (isValidValue(fields()[0], other.avg)) {
        this.avg = data().deepCopy(fields()[0].schema(), other.avg);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.Bandwidth.Builder setAvg(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.Bandwidth.Builder clearAvg() {
      avg = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.Bandwidth.Builder setBurst(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.Bandwidth.Builder clearBurst() {
      burst = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.Bandwidth.Builder setObserved(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.Bandwidth.Builder clearObserved() {
      observed = null;
