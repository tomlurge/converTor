...
public class WriteHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5123840604322411094L;
   ...
   */
  public static trans.encoders.relay.WriteHistory.Builder newBuilder() {
    return new trans.encoders.relay.WriteHistory.Builder();
  }
   ...
   * @return A new WriteHistory RecordBuilder
   */
  public static trans.encoders.relay.WriteHistory.Builder newBuilder(trans.encoders.relay.WriteHistory.Builder other) {
    return new trans.encoders.relay.WriteHistory.Builder(other);
  }
   ...
   * @return A new WriteHistory RecordBuilder
   */
  public static trans.encoders.relay.WriteHistory.Builder newBuilder(trans.encoders.relay.WriteHistory other) {
    return new trans.encoders.relay.WriteHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WriteHistory>
    ...
    private Builder() {
      super(trans.encoders.relay.WriteHistory.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relay.WriteHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relay.WriteHistory other) {
            super(trans.encoders.relay.WriteHistory.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.WriteHistory.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.WriteHistory.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.WriteHistory.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.WriteHistory.Builder clearInterval() {
      interval = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.WriteHistory.Builder setBytes(java.util.List<java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relay.WriteHistory.Builder clearBytes() {
      bytes = null;
