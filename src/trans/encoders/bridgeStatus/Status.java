...
public class Status extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public trans.encoders.bridgeStatus.W w;
  @Deprecated public trans.encoders.bridgeStatus.Policy p;
   ...
   */
  public Status(trans.encoders.bridgeStatus.R r, java.util.List<trans.encoders.bridgeStatus.OrAddress> a, java.util.List<java.lang.String> s, java.lang.String v, trans.encoders.bridgeStatus.W w, trans.encoders.bridgeStatus.Policy p) {
    this.r = r;
    this.a = a;
    this.s = s;
    this.v = v;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: r = (trans.encoders.bridgeStatus.R)value$; break;
    case 1: a = (java.util.List<trans.encoders.bridgeStatus.OrAddress>)value$; break;
    case 2: s = (java.util.List<java.lang.String>)value$; break;
    case 3: v = (java.lang.String)value$; break;
    case 4: w = (trans.encoders.bridgeStatus.W)value$; break;
    case 5: p = (trans.encoders.bridgeStatus.Policy)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public trans.encoders.bridgeStatus.R getR() {
    return r;
  }
   ...
   */
  public void setR(trans.encoders.bridgeStatus.R value) {
    this.r = value;
  }
   ...
   */
  public java.util.List<trans.encoders.bridgeStatus.OrAddress> getA() {
    return a;
  }
   ...
   * @param value the value to set.
   */
  public void setA(java.util.List<trans.encoders.bridgeStatus.OrAddress> value) {
    this.a = value;
  }
   ...
   */
  public trans.encoders.bridgeStatus.W getW() {
    return w;
  }
   ...
   * @param value the value to set.
   */
  public void setW(trans.encoders.bridgeStatus.W value) {
    this.w = value;
  }
   ...
   */
  public trans.encoders.bridgeStatus.Policy getP() {
    return p;
  }
   ...
   * @param value the value to set.
   */
  public void setP(trans.encoders.bridgeStatus.Policy value) {
    this.p = value;
  }
   ...
   */
  public static trans.encoders.bridgeStatus.Status.Builder newBuilder() {
    return new trans.encoders.bridgeStatus.Status.Builder();
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static trans.encoders.bridgeStatus.Status.Builder newBuilder(trans.encoders.bridgeStatus.Status.Builder other) {
    return new trans.encoders.bridgeStatus.Status.Builder(other);
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static trans.encoders.bridgeStatus.Status.Builder newBuilder(trans.encoders.bridgeStatus.Status other) {
    return new trans.encoders.bridgeStatus.Status.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Status>
    ...
    private trans.encoders.bridgeStatus.R r;
    private trans.encoders.bridgeStatus.R.Builder rBuilder;
    /** metrics-lib/NetworkStatusEntry: getOrAddresses() */
    private java.util.List<trans.encoders.bridgeStatus.OrAddress> a;
    /** metrics-lib/NetworkStatusEntry: SortedSet<String> getFlags() */
    private java.util.List<java.lang.String> s;
    /** metrics-lib/NetworkStatusEntry: String getVersion() */
    private java.lang.String v;
    private trans.encoders.bridgeStatus.W w;
    private trans.encoders.bridgeStatus.W.Builder wBuilder;
    private trans.encoders.bridgeStatus.Policy p;
    private trans.encoders.bridgeStatus.Policy.Builder pBuilder;

    /** Creates a new Builder */
    private Builder() {
      super(trans.encoders.bridgeStatus.Status.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.bridgeStatus.Status.Builder other) {
      super(other);
      ...
      if (other.hasRBuilder()) {
        this.rBuilder = trans.encoders.bridgeStatus.R.newBuilder(other.getRBuilder());
      }
      ...
      if (other.hasWBuilder()) {
        this.wBuilder = trans.encoders.bridgeStatus.W.newBuilder(other.getWBuilder());
      }
      ...
      if (other.hasPBuilder()) {
        this.pBuilder = trans.encoders.bridgeStatus.Policy.newBuilder(other.getPBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.bridgeStatus.Status other) {
            super(trans.encoders.bridgeStatus.Status.SCHEMA$);
      if (isValidValue(fields()[0], other.r)) {
        this.r = data().deepCopy(fields()[0].schema(), other.r);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder setR(trans.encoders.bridgeStatus.R value) {
     ...
     * @return This builder.
     */
    public trans.encoders.bridgeStatus.R.Builder getRBuilder() {
      if (rBuilder == null) {
        if (hasR()) {
          setRBuilder(trans.encoders.bridgeStatus.R.newBuilder(r));
        } else {
          setRBuilder(trans.encoders.bridgeStatus.R.newBuilder());
        }
      }
      return rBuilder;
    }
     ...
     * @return This builder.
     */
    public trans.encoders.bridgeStatus.Status.Builder setRBuilder(trans.encoders.bridgeStatus.R.Builder value) {
      clearR();
      rBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder clearR() {
      r = null;
      rBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder setA(java.util.List<trans.encoders.bridgeStatus.OrAddress> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder clearA() {
      a = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder setS(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder clearS() {
      s = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder setV(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder clearV() {
      v = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder setW(trans.encoders.bridgeStatus.W value) {
     ...
     * @return This builder.
     */
    public trans.encoders.bridgeStatus.W.Builder getWBuilder() {
      if (wBuilder == null) {
        if (hasW()) {
          setWBuilder(trans.encoders.bridgeStatus.W.newBuilder(w));
        } else {
          setWBuilder(trans.encoders.bridgeStatus.W.newBuilder());
        }
      }
      return wBuilder;
    }
     ...
     * @return This builder.
     */
    public trans.encoders.bridgeStatus.Status.Builder setWBuilder(trans.encoders.bridgeStatus.W.Builder value) {
      clearW();
      wBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder clearW() {
      w = null;
      wBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder setP(trans.encoders.bridgeStatus.Policy value) {
     ...
     * @return This builder.
     */
    public trans.encoders.bridgeStatus.Policy.Builder getPBuilder() {
      if (pBuilder == null) {
        if (hasP()) {
          setPBuilder(trans.encoders.bridgeStatus.Policy.newBuilder(p));
        } else {
          setPBuilder(trans.encoders.bridgeStatus.Policy.newBuilder());
        }
      }
      return pBuilder;
    }
     ...
     * @return This builder.
     */
    public trans.encoders.bridgeStatus.Status.Builder setPBuilder(trans.encoders.bridgeStatus.Policy.Builder value) {
      clearP();
      pBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.Status.Builder clearP() {
      p = null;
      pBuilder = null;
    ...
    public Status build() {
      try {
        ...
        if (rBuilder != null) {
          ...
          record.r = fieldSetFlags()[0] ? this.r : (trans.encoders.bridgeStatus.R) defaultValue(fields()[0]);
        }
        record.a = fieldSetFlags()[1] ? this.a : (java.util.List<trans.encoders.bridgeStatus.OrAddress>) defaultValue(fields()[1]);
        ...
        if (wBuilder != null) {
          ...
          record.w = fieldSetFlags()[4] ? this.w : (trans.encoders.bridgeStatus.W) defaultValue(fields()[4]);
        }
        if (pBuilder != null) {
          record.p = this.pBuilder.build();
        } else {
          record.p = fieldSetFlags()[5] ? this.p : (trans.encoders.bridgeStatus.Policy) defaultValue(fields()[5]);
        }
        return record;
      } catch (Exception e) {
