...
public class W extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static trans.encoders.bridgeStatus.W.Builder newBuilder() {
    return new trans.encoders.bridgeStatus.W.Builder();
  }
   ...
   * @return A new W RecordBuilder
   */
  public static trans.encoders.bridgeStatus.W.Builder newBuilder(trans.encoders.bridgeStatus.W.Builder other) {
    return new trans.encoders.bridgeStatus.W.Builder(other);
  }
   ...
   * @return A new W RecordBuilder
   */
  public static trans.encoders.bridgeStatus.W.Builder newBuilder(trans.encoders.bridgeStatus.W other) {
    return new trans.encoders.bridgeStatus.W.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<W>
    ...
    private Builder() {
      super(trans.encoders.bridgeStatus.W.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.bridgeStatus.W.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.bridgeStatus.W other) {
            super(trans.encoders.bridgeStatus.W.SCHEMA$);
      if (isValidValue(fields()[0], other.bandwidth)) {
        this.bandwidth = data().deepCopy(fields()[0].schema(), other.bandwidth);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.W.Builder setBandwidth(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.W.Builder clearBandwidth() {
      bandwidth = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.W.Builder setMeasured(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.W.Builder clearMeasured() {
      measured = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.W.Builder setUnmeasured(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeStatus.W.Builder clearUnmeasured() {
      unmeasured = null;
