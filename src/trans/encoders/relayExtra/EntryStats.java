...
public class EntryStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8827963262831386560L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EntryStats\",\"namespace\":\"trans.encoders.relayExtra\",\"fields\":[{\"name\":\"date\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getEntryStatsEndMillis()\"},{\"name\":\"interval\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getEntryStatsIntervalLength()\"}]}");
   ...
   */
  public static trans.encoders.relayExtra.EntryStats.Builder newBuilder() {
    return new trans.encoders.relayExtra.EntryStats.Builder();
  }
   ...
   * @return A new EntryStats RecordBuilder
   */
  public static trans.encoders.relayExtra.EntryStats.Builder newBuilder(trans.encoders.relayExtra.EntryStats.Builder other) {
    return new trans.encoders.relayExtra.EntryStats.Builder(other);
  }
   ...
   * @return A new EntryStats RecordBuilder
   */
  public static trans.encoders.relayExtra.EntryStats.Builder newBuilder(trans.encoders.relayExtra.EntryStats other) {
    return new trans.encoders.relayExtra.EntryStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EntryStats>
    ...
    private Builder() {
      super(trans.encoders.relayExtra.EntryStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayExtra.EntryStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayExtra.EntryStats other) {
            super(trans.encoders.relayExtra.EntryStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.EntryStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.EntryStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.EntryStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.EntryStats.Builder clearInterval() {
      interval = null;
