...
public class HidservDirOnionsSeen extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3352701079935072500L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"HidservDirOnionsSeen\",\"namespace\":\"trans.encoders.relayExtra\",\"fields\":[{\"name\":\"onions\",\"type\":[\"null\",\"double\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: Double getHidservDirOnionsSeen()\"},{\"name\":\"obfuscation\",\"type\":[\"null\",{\"type\":\"map\",\"values\":\"double\",\"avro.java.string\":\"String\"}],\"doc\":\"metrics-lib/ExtraInfoDescriptor: Map<String, Double> getHidservDirOnionsSeenParameters()\"}]}");
   ...
   */
  public static trans.encoders.relayExtra.HidservDirOnionsSeen.Builder newBuilder() {
    return new trans.encoders.relayExtra.HidservDirOnionsSeen.Builder();
  }
   ...
   * @return A new HidservDirOnionsSeen RecordBuilder
   */
  public static trans.encoders.relayExtra.HidservDirOnionsSeen.Builder newBuilder(trans.encoders.relayExtra.HidservDirOnionsSeen.Builder other) {
    return new trans.encoders.relayExtra.HidservDirOnionsSeen.Builder(other);
  }
   ...
   * @return A new HidservDirOnionsSeen RecordBuilder
   */
  public static trans.encoders.relayExtra.HidservDirOnionsSeen.Builder newBuilder(trans.encoders.relayExtra.HidservDirOnionsSeen other) {
    return new trans.encoders.relayExtra.HidservDirOnionsSeen.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservDirOnionsSeen>
    ...
    private Builder() {
      super(trans.encoders.relayExtra.HidservDirOnionsSeen.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayExtra.HidservDirOnionsSeen.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayExtra.HidservDirOnionsSeen other) {
            super(trans.encoders.relayExtra.HidservDirOnionsSeen.SCHEMA$);
      if (isValidValue(fields()[0], other.onions)) {
        this.onions = data().deepCopy(fields()[0].schema(), other.onions);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.HidservDirOnionsSeen.Builder setOnions(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.HidservDirOnionsSeen.Builder clearOnions() {
      onions = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.HidservDirOnionsSeen.Builder setObfuscation(java.util.Map<java.lang.String,java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.HidservDirOnionsSeen.Builder clearObfuscation() {
      obfuscation = null;
