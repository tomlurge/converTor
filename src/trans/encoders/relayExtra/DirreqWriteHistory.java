...
public class DirreqWriteHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static trans.encoders.relayExtra.DirreqWriteHistory.Builder newBuilder() {
    return new trans.encoders.relayExtra.DirreqWriteHistory.Builder();
  }
   ...
   * @return A new DirreqWriteHistory RecordBuilder
   */
  public static trans.encoders.relayExtra.DirreqWriteHistory.Builder newBuilder(trans.encoders.relayExtra.DirreqWriteHistory.Builder other) {
    return new trans.encoders.relayExtra.DirreqWriteHistory.Builder(other);
  }
   ...
   * @return A new DirreqWriteHistory RecordBuilder
   */
  public static trans.encoders.relayExtra.DirreqWriteHistory.Builder newBuilder(trans.encoders.relayExtra.DirreqWriteHistory other) {
    return new trans.encoders.relayExtra.DirreqWriteHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirreqWriteHistory>
    ...
    private Builder() {
      super(trans.encoders.relayExtra.DirreqWriteHistory.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayExtra.DirreqWriteHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayExtra.DirreqWriteHistory other) {
            super(trans.encoders.relayExtra.DirreqWriteHistory.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.DirreqWriteHistory.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.DirreqWriteHistory.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.DirreqWriteHistory.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.DirreqWriteHistory.Builder clearInterval() {
      interval = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.DirreqWriteHistory.Builder setBytes(java.util.List<java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.DirreqWriteHistory.Builder clearBytes() {
      bytes = null;
