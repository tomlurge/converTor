...
public class ExtraInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1438184166998546026L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ExtraInfo\",\"namespace\":\"trans.encoders.relayExtra\",\"fields\":[{\"name\":\"nickname\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"metrics-lib/ExtraInfoDescriptor: String getNickname()\"},{\"name\":\"fingerprint\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"metrics-lib/ExtraInfoDescriptor: String getFingerprint()\"}]}");
   ...
   */
  public static trans.encoders.relayExtra.ExtraInfo.Builder newBuilder() {
    return new trans.encoders.relayExtra.ExtraInfo.Builder();
  }
   ...
   * @return A new ExtraInfo RecordBuilder
   */
  public static trans.encoders.relayExtra.ExtraInfo.Builder newBuilder(trans.encoders.relayExtra.ExtraInfo.Builder other) {
    return new trans.encoders.relayExtra.ExtraInfo.Builder(other);
  }
   ...
   * @return A new ExtraInfo RecordBuilder
   */
  public static trans.encoders.relayExtra.ExtraInfo.Builder newBuilder(trans.encoders.relayExtra.ExtraInfo other) {
    return new trans.encoders.relayExtra.ExtraInfo.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExtraInfo>
    ...
    private Builder() {
      super(trans.encoders.relayExtra.ExtraInfo.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayExtra.ExtraInfo.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayExtra.ExtraInfo other) {
            super(trans.encoders.relayExtra.ExtraInfo.SCHEMA$);
      if (isValidValue(fields()[0], other.nickname)) {
        this.nickname = data().deepCopy(fields()[0].schema(), other.nickname);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.ExtraInfo.Builder setNickname(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.ExtraInfo.Builder clearNickname() {
      nickname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.ExtraInfo.Builder setFingerprint(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.ExtraInfo.Builder clearFingerprint() {
      fingerprint = null;
