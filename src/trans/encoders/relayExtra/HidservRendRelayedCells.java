...
public class HidservRendRelayedCells extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static trans.encoders.relayExtra.HidservRendRelayedCells.Builder newBuilder() {
    return new trans.encoders.relayExtra.HidservRendRelayedCells.Builder();
  }
   ...
   * @return A new HidservRendRelayedCells RecordBuilder
   */
  public static trans.encoders.relayExtra.HidservRendRelayedCells.Builder newBuilder(trans.encoders.relayExtra.HidservRendRelayedCells.Builder other) {
    return new trans.encoders.relayExtra.HidservRendRelayedCells.Builder(other);
  }
   ...
   * @return A new HidservRendRelayedCells RecordBuilder
   */
  public static trans.encoders.relayExtra.HidservRendRelayedCells.Builder newBuilder(trans.encoders.relayExtra.HidservRendRelayedCells other) {
    return new trans.encoders.relayExtra.HidservRendRelayedCells.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservRendRelayedCells>
    ...
    private Builder() {
      super(trans.encoders.relayExtra.HidservRendRelayedCells.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.relayExtra.HidservRendRelayedCells.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.relayExtra.HidservRendRelayedCells other) {
            super(trans.encoders.relayExtra.HidservRendRelayedCells.SCHEMA$);
      if (isValidValue(fields()[0], other.cells)) {
        this.cells = data().deepCopy(fields()[0].schema(), other.cells);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.HidservRendRelayedCells.Builder setCells(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.HidservRendRelayedCells.Builder clearCells() {
      cells = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.HidservRendRelayedCells.Builder setObfuscation(java.util.Map<java.lang.String,java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.relayExtra.HidservRendRelayedCells.Builder clearObfuscation() {
      obfuscation = null;
