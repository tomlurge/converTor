...
public class HidservDirOnionsSeen extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8984834188285149804L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"HidservDirOnionsSeen\",\"namespace\":\"trans.encoders.bridgeExtra\",\"fields\":[{\"name\":\"onions\",\"type\":[\"null\",\"double\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: Double getHidservDirOnionsSeen()\"},{\"name\":\"obfuscation\",\"type\":[\"null\",{\"type\":\"map\",\"values\":\"double\",\"avro.java.string\":\"String\"}],\"doc\":\"metrics-lib/ExtraInfoDescriptor: Map<String, Double> getHidservDirOnionsSeenParameters()\"}]}");
   ...
   */
  public static trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder newBuilder() {
    return new trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder();
  }
   ...
   * @return A new HidservDirOnionsSeen RecordBuilder
   */
  public static trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder newBuilder(trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder other) {
    return new trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder(other);
  }
   ...
   * @return A new HidservDirOnionsSeen RecordBuilder
   */
  public static trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder newBuilder(trans.encoders.bridgeExtra.HidservDirOnionsSeen other) {
    return new trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservDirOnionsSeen>
    ...
    private Builder() {
      super(trans.encoders.bridgeExtra.HidservDirOnionsSeen.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.bridgeExtra.HidservDirOnionsSeen other) {
            super(trans.encoders.bridgeExtra.HidservDirOnionsSeen.SCHEMA$);
      if (isValidValue(fields()[0], other.onions)) {
        this.onions = data().deepCopy(fields()[0].schema(), other.onions);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder setOnions(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder clearOnions() {
      onions = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder setObfuscation(java.util.Map<java.lang.String,java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.HidservDirOnionsSeen.Builder clearObfuscation() {
      obfuscation = null;
