...
public class WriteHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static trans.encoders.bridgeExtra.WriteHistory.Builder newBuilder() {
    return new trans.encoders.bridgeExtra.WriteHistory.Builder();
  }
   ...
   * @return A new WriteHistory RecordBuilder
   */
  public static trans.encoders.bridgeExtra.WriteHistory.Builder newBuilder(trans.encoders.bridgeExtra.WriteHistory.Builder other) {
    return new trans.encoders.bridgeExtra.WriteHistory.Builder(other);
  }
   ...
   * @return A new WriteHistory RecordBuilder
   */
  public static trans.encoders.bridgeExtra.WriteHistory.Builder newBuilder(trans.encoders.bridgeExtra.WriteHistory other) {
    return new trans.encoders.bridgeExtra.WriteHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WriteHistory>
    ...
    private Builder() {
      super(trans.encoders.bridgeExtra.WriteHistory.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.bridgeExtra.WriteHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.bridgeExtra.WriteHistory other) {
            super(trans.encoders.bridgeExtra.WriteHistory.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.WriteHistory.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.WriteHistory.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.WriteHistory.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.WriteHistory.Builder clearInterval() {
      interval = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.WriteHistory.Builder setBytes(java.util.List<java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.WriteHistory.Builder clearBytes() {
      bytes = null;
