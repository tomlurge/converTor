...
public class CellStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3896443571037921831L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CellStats\",\"namespace\":\"trans.encoders.bridgeExtra\",\"fields\":[{\"name\":\"date\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getCellStatsEndMillis()\"},{\"name\":\"interval\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getCellStatsIntervalLength()\"}]}");
   ...
   */
  public static trans.encoders.bridgeExtra.CellStats.Builder newBuilder() {
    return new trans.encoders.bridgeExtra.CellStats.Builder();
  }
   ...
   * @return A new CellStats RecordBuilder
   */
  public static trans.encoders.bridgeExtra.CellStats.Builder newBuilder(trans.encoders.bridgeExtra.CellStats.Builder other) {
    return new trans.encoders.bridgeExtra.CellStats.Builder(other);
  }
   ...
   * @return A new CellStats RecordBuilder
   */
  public static trans.encoders.bridgeExtra.CellStats.Builder newBuilder(trans.encoders.bridgeExtra.CellStats other) {
    return new trans.encoders.bridgeExtra.CellStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CellStats>
    ...
    private Builder() {
      super(trans.encoders.bridgeExtra.CellStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.bridgeExtra.CellStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.bridgeExtra.CellStats other) {
            super(trans.encoders.bridgeExtra.CellStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.CellStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.CellStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.CellStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.CellStats.Builder clearInterval() {
      interval = null;
