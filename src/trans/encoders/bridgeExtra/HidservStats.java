...
public class HidservStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6579845381824063262L;
   ...
   */
  public static trans.encoders.bridgeExtra.HidservStats.Builder newBuilder() {
    return new trans.encoders.bridgeExtra.HidservStats.Builder();
  }
   ...
   * @return A new HidservStats RecordBuilder
   */
  public static trans.encoders.bridgeExtra.HidservStats.Builder newBuilder(trans.encoders.bridgeExtra.HidservStats.Builder other) {
    return new trans.encoders.bridgeExtra.HidservStats.Builder(other);
  }
   ...
   * @return A new HidservStats RecordBuilder
   */
  public static trans.encoders.bridgeExtra.HidservStats.Builder newBuilder(trans.encoders.bridgeExtra.HidservStats other) {
    return new trans.encoders.bridgeExtra.HidservStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservStats>
    ...
    private Builder() {
      super(trans.encoders.bridgeExtra.HidservStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.bridgeExtra.HidservStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.bridgeExtra.HidservStats other) {
            super(trans.encoders.bridgeExtra.HidservStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.HidservStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.HidservStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.HidservStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.HidservStats.Builder clearInterval() {
      interval = null;
