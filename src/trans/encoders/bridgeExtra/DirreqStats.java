...
public class DirreqStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6146054572753236510L;
   ...
   */
  public static trans.encoders.bridgeExtra.DirreqStats.Builder newBuilder() {
    return new trans.encoders.bridgeExtra.DirreqStats.Builder();
  }
   ...
   * @return A new DirreqStats RecordBuilder
   */
  public static trans.encoders.bridgeExtra.DirreqStats.Builder newBuilder(trans.encoders.bridgeExtra.DirreqStats.Builder other) {
    return new trans.encoders.bridgeExtra.DirreqStats.Builder(other);
  }
   ...
   * @return A new DirreqStats RecordBuilder
   */
  public static trans.encoders.bridgeExtra.DirreqStats.Builder newBuilder(trans.encoders.bridgeExtra.DirreqStats other) {
    return new trans.encoders.bridgeExtra.DirreqStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirreqStats>
    ...
    private Builder() {
      super(trans.encoders.bridgeExtra.DirreqStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.bridgeExtra.DirreqStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.bridgeExtra.DirreqStats other) {
            super(trans.encoders.bridgeExtra.DirreqStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.DirreqStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.DirreqStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.DirreqStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.DirreqStats.Builder clearInterval() {
      interval = null;
