...
public class ExitStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1313453269954175929L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ExitStats\",\"namespace\":\"trans.encoders.bridgeExtra\",\"fields\":[{\"name\":\"date\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getExitStatsEndMillis()\"},{\"name\":\"interval\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getExitStatsIntervalLength()\"}]}");
   ...
   */
  public static trans.encoders.bridgeExtra.ExitStats.Builder newBuilder() {
    return new trans.encoders.bridgeExtra.ExitStats.Builder();
  }
   ...
   * @return A new ExitStats RecordBuilder
   */
  public static trans.encoders.bridgeExtra.ExitStats.Builder newBuilder(trans.encoders.bridgeExtra.ExitStats.Builder other) {
    return new trans.encoders.bridgeExtra.ExitStats.Builder(other);
  }
   ...
   * @return A new ExitStats RecordBuilder
   */
  public static trans.encoders.bridgeExtra.ExitStats.Builder newBuilder(trans.encoders.bridgeExtra.ExitStats other) {
    return new trans.encoders.bridgeExtra.ExitStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExitStats>
    ...
    private Builder() {
      super(trans.encoders.bridgeExtra.ExitStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(trans.encoders.bridgeExtra.ExitStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(trans.encoders.bridgeExtra.ExitStats other) {
            super(trans.encoders.bridgeExtra.ExitStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.ExitStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.ExitStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.ExitStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public trans.encoders.bridgeExtra.ExitStats.Builder clearInterval() {
      interval = null;
