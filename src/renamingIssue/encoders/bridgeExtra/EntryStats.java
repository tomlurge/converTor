...
public class EntryStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2735071773796111401L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EntryStats\",\"namespace\":\"convertor.encoders.bridgeExtra\",\"fields\":[{\"name\":\"date\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getEntryStatsEndMillis()\"},{\"name\":\"interval\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getEntryStatsIntervalLength()\"}]}");
   ...
   */
  public static renamingIssue.encoders.bridgeExtra.EntryStats.Builder newBuilder() {
    return new renamingIssue.encoders.bridgeExtra.EntryStats.Builder();
  }
   ...
   * @return A new EntryStats RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.EntryStats.Builder newBuilder(renamingIssue.encoders.bridgeExtra.EntryStats.Builder other) {
    return new renamingIssue.encoders.bridgeExtra.EntryStats.Builder(other);
  }
   ...
   * @return A new EntryStats RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.EntryStats.Builder newBuilder(renamingIssue.encoders.bridgeExtra.EntryStats other) {
    return new renamingIssue.encoders.bridgeExtra.EntryStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EntryStats>
    ...
    private Builder() {
      super(renamingIssue.encoders.bridgeExtra.EntryStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.EntryStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.EntryStats other) {
            super(renamingIssue.encoders.bridgeExtra.EntryStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.EntryStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.EntryStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.EntryStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.EntryStats.Builder clearInterval() {
      interval = null;
