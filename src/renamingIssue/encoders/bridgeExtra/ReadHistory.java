...
public class ReadHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.bridgeExtra.ReadHistory.Builder newBuilder() {
    return new renamingIssue.encoders.bridgeExtra.ReadHistory.Builder();
  }
   ...
   * @return A new ReadHistory RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.ReadHistory.Builder newBuilder(renamingIssue.encoders.bridgeExtra.ReadHistory.Builder other) {
    return new renamingIssue.encoders.bridgeExtra.ReadHistory.Builder(other);
  }
   ...
   * @return A new ReadHistory RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.ReadHistory.Builder newBuilder(renamingIssue.encoders.bridgeExtra.ReadHistory other) {
    return new renamingIssue.encoders.bridgeExtra.ReadHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ReadHistory>
    ...
    private Builder() {
      super(renamingIssue.encoders.bridgeExtra.ReadHistory.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.ReadHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.ReadHistory other) {
            super(renamingIssue.encoders.bridgeExtra.ReadHistory.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.ReadHistory.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.ReadHistory.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.ReadHistory.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.ReadHistory.Builder clearInterval() {
      interval = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.ReadHistory.Builder setBytes(java.util.List<java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.ReadHistory.Builder clearBytes() {
      bytes = null;
