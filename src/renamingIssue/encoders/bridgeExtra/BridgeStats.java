...
public class BridgeStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3937255658356848820L;
   ...
   */
  public static renamingIssue.encoders.bridgeExtra.BridgeStats.Builder newBuilder() {
    return new renamingIssue.encoders.bridgeExtra.BridgeStats.Builder();
  }
   ...
   * @return A new BridgeStats RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.BridgeStats.Builder newBuilder(renamingIssue.encoders.bridgeExtra.BridgeStats.Builder other) {
    return new renamingIssue.encoders.bridgeExtra.BridgeStats.Builder(other);
  }
   ...
   * @return A new BridgeStats RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.BridgeStats.Builder newBuilder(renamingIssue.encoders.bridgeExtra.BridgeStats other) {
    return new renamingIssue.encoders.bridgeExtra.BridgeStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BridgeStats>
    ...
    private Builder() {
      super(renamingIssue.encoders.bridgeExtra.BridgeStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.BridgeStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.BridgeStats other) {
            super(renamingIssue.encoders.bridgeExtra.BridgeStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.BridgeStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.BridgeStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.BridgeStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.BridgeStats.Builder clearInterval() {
      interval = null;
