...
public class ExtraInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8986140238220991377L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ExtraInfo\",\"namespace\":\"convertor.encoders.bridgeExtra\",\"fields\":[{\"name\":\"nickname\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"metrics-lib/ExtraInfoDescriptor: String getNickname()\"},{\"name\":\"fingerprint\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"metrics-lib/ExtraInfoDescriptor: String getFingerprint()\"}]}");
   ...
   */
  public static renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder newBuilder() {
    return new renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder();
  }
   ...
   * @return A new ExtraInfo RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder newBuilder(renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder other) {
    return new renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder(other);
  }
   ...
   * @return A new ExtraInfo RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder newBuilder(renamingIssue.encoders.bridgeExtra.ExtraInfo other) {
    return new renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExtraInfo>
    ...
    private Builder() {
      super(renamingIssue.encoders.bridgeExtra.ExtraInfo.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.ExtraInfo other) {
            super(renamingIssue.encoders.bridgeExtra.ExtraInfo.SCHEMA$);
      if (isValidValue(fields()[0], other.nickname)) {
        this.nickname = data().deepCopy(fields()[0].schema(), other.nickname);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder setNickname(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder clearNickname() {
      nickname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder setFingerprint(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.ExtraInfo.Builder clearFingerprint() {
      fingerprint = null;
