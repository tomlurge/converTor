...
public class DirreqStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3956994441638737221L;
   ...
   */
  public static renamingIssue.encoders.bridgeExtra.DirreqStats.Builder newBuilder() {
    return new renamingIssue.encoders.bridgeExtra.DirreqStats.Builder();
  }
   ...
   * @return A new DirreqStats RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.DirreqStats.Builder newBuilder(renamingIssue.encoders.bridgeExtra.DirreqStats.Builder other) {
    return new renamingIssue.encoders.bridgeExtra.DirreqStats.Builder(other);
  }
   ...
   * @return A new DirreqStats RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.DirreqStats.Builder newBuilder(renamingIssue.encoders.bridgeExtra.DirreqStats other) {
    return new renamingIssue.encoders.bridgeExtra.DirreqStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirreqStats>
    ...
    private Builder() {
      super(renamingIssue.encoders.bridgeExtra.DirreqStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.DirreqStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.DirreqStats other) {
            super(renamingIssue.encoders.bridgeExtra.DirreqStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.DirreqStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.DirreqStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.DirreqStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.DirreqStats.Builder clearInterval() {
      interval = null;
