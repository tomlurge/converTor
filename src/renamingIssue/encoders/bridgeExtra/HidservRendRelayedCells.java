...
public class HidservRendRelayedCells extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder newBuilder() {
    return new renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder();
  }
   ...
   * @return A new HidservRendRelayedCells RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder newBuilder(renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder other) {
    return new renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder(other);
  }
   ...
   * @return A new HidservRendRelayedCells RecordBuilder
   */
  public static renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder newBuilder(renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells other) {
    return new renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservRendRelayedCells>
    ...
    private Builder() {
      super(renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells other) {
            super(renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.SCHEMA$);
      if (isValidValue(fields()[0], other.cells)) {
        this.cells = data().deepCopy(fields()[0].schema(), other.cells);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder setCells(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder clearCells() {
      cells = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder setObfuscation(java.util.Map<java.lang.String,java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeExtra.HidservRendRelayedCells.Builder clearObfuscation() {
      obfuscation = null;
