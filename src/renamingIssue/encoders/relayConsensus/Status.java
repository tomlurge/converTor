...
public class Status extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1596188783715038301L;
  ...
  @Deprecated public renamingIssue.encoders.relayConsensus.R r;
  @Deprecated public java.util.List<renamingIssue.encoders.relayConsensus.OrAddress> a;
  ...
  @Deprecated public renamingIssue.encoders.relayConsensus.W w;
  @Deprecated public renamingIssue.encoders.relayConsensus.Policy p;
   ...
   */
  public Status(renamingIssue.encoders.relayConsensus.R r, java.util.List<renamingIssue.encoders.relayConsensus.OrAddress> a, java.util.List<java.lang.String> s, java.lang.String v, renamingIssue.encoders.relayConsensus.W w, renamingIssue.encoders.relayConsensus.Policy p) {
    this.r = r;
    this.a = a;
    this.s = s;
    this.v = v;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: r = (renamingIssue.encoders.relayConsensus.R)value$; break;
    case 1: a = (java.util.List<renamingIssue.encoders.relayConsensus.OrAddress>)value$; break;
    case 2: s = (java.util.List<java.lang.String>)value$; break;
    case 3: v = (java.lang.String)value$; break;
    case 4: w = (renamingIssue.encoders.relayConsensus.W)value$; break;
    case 5: p = (renamingIssue.encoders.relayConsensus.Policy)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public renamingIssue.encoders.relayConsensus.R getR() {
    return r;
  }
   ...
   */
  public void setR(renamingIssue.encoders.relayConsensus.R value) {
    this.r = value;
  }
   ...
   */
  public java.util.List<renamingIssue.encoders.relayConsensus.OrAddress> getA() {
    return a;
  }
   ...
   * @param value the value to set.
   */
  public void setA(java.util.List<renamingIssue.encoders.relayConsensus.OrAddress> value) {
    this.a = value;
  }
   ...
   */
  public renamingIssue.encoders.relayConsensus.W getW() {
    return w;
  }
   ...
   * @param value the value to set.
   */
  public void setW(renamingIssue.encoders.relayConsensus.W value) {
    this.w = value;
  }
   ...
   */
  public renamingIssue.encoders.relayConsensus.Policy getP() {
    return p;
  }
   ...
   * @param value the value to set.
   */
  public void setP(renamingIssue.encoders.relayConsensus.Policy value) {
    this.p = value;
  }
   ...
   */
  public static renamingIssue.encoders.relayConsensus.Status.Builder newBuilder() {
    return new renamingIssue.encoders.relayConsensus.Status.Builder();
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.Status.Builder newBuilder(renamingIssue.encoders.relayConsensus.Status.Builder other) {
    return new renamingIssue.encoders.relayConsensus.Status.Builder(other);
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.Status.Builder newBuilder(renamingIssue.encoders.relayConsensus.Status other) {
    return new renamingIssue.encoders.relayConsensus.Status.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Status>
    ...
    private renamingIssue.encoders.relayConsensus.R r;
    private renamingIssue.encoders.relayConsensus.R.Builder rBuilder;
    private java.util.List<renamingIssue.encoders.relayConsensus.OrAddress> a;
    /** metrics-lib/NetworkStatusEntry: SortedSet<String> getFlags() */
    private java.util.List<java.lang.String> s;
    /** metrics-lib/NetworkStatusEntry: String getVersion() */
    private java.lang.String v;
    private renamingIssue.encoders.relayConsensus.W w;
    private renamingIssue.encoders.relayConsensus.W.Builder wBuilder;
    private renamingIssue.encoders.relayConsensus.Policy p;
    private renamingIssue.encoders.relayConsensus.Policy.Builder pBuilder;

    /** Creates a new Builder */
    private Builder() {
      super(renamingIssue.encoders.relayConsensus.Status.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.Status.Builder other) {
      super(other);
      ...
      if (other.hasRBuilder()) {
        this.rBuilder = renamingIssue.encoders.relayConsensus.R.newBuilder(other.getRBuilder());
      }
      ...
      if (other.hasWBuilder()) {
        this.wBuilder = renamingIssue.encoders.relayConsensus.W.newBuilder(other.getWBuilder());
      }
      ...
      if (other.hasPBuilder()) {
        this.pBuilder = renamingIssue.encoders.relayConsensus.Policy.newBuilder(other.getPBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.Status other) {
            super(renamingIssue.encoders.relayConsensus.Status.SCHEMA$);
      if (isValidValue(fields()[0], other.r)) {
        this.r = data().deepCopy(fields()[0].schema(), other.r);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder setR(renamingIssue.encoders.relayConsensus.R value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.R.Builder getRBuilder() {
      if (rBuilder == null) {
        if (hasR()) {
          setRBuilder(renamingIssue.encoders.relayConsensus.R.newBuilder(r));
        } else {
          setRBuilder(renamingIssue.encoders.relayConsensus.R.newBuilder());
        }
      }
      return rBuilder;
    }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.Status.Builder setRBuilder(renamingIssue.encoders.relayConsensus.R.Builder value) {
      clearR();
      rBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder clearR() {
      r = null;
      rBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder setA(java.util.List<renamingIssue.encoders.relayConsensus.OrAddress> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder clearA() {
      a = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder setS(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder clearS() {
      s = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder setV(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder clearV() {
      v = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder setW(renamingIssue.encoders.relayConsensus.W value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.W.Builder getWBuilder() {
      if (wBuilder == null) {
        if (hasW()) {
          setWBuilder(renamingIssue.encoders.relayConsensus.W.newBuilder(w));
        } else {
          setWBuilder(renamingIssue.encoders.relayConsensus.W.newBuilder());
        }
      }
      return wBuilder;
    }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.Status.Builder setWBuilder(renamingIssue.encoders.relayConsensus.W.Builder value) {
      clearW();
      wBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder clearW() {
      w = null;
      wBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder setP(renamingIssue.encoders.relayConsensus.Policy value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.Policy.Builder getPBuilder() {
      if (pBuilder == null) {
        if (hasP()) {
          setPBuilder(renamingIssue.encoders.relayConsensus.Policy.newBuilder(p));
        } else {
          setPBuilder(renamingIssue.encoders.relayConsensus.Policy.newBuilder());
        }
      }
      return pBuilder;
    }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.Status.Builder setPBuilder(renamingIssue.encoders.relayConsensus.Policy.Builder value) {
      clearP();
      pBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Status.Builder clearP() {
      p = null;
      pBuilder = null;
    ...
    public Status build() {
      try {
        ...
        if (rBuilder != null) {
          ...
          record.r = fieldSetFlags()[0] ? this.r : (renamingIssue.encoders.relayConsensus.R) defaultValue(fields()[0]);
        }
        record.a = fieldSetFlags()[1] ? this.a : (java.util.List<renamingIssue.encoders.relayConsensus.OrAddress>) defaultValue(fields()[1]);
        ...
        if (wBuilder != null) {
          ...
          record.w = fieldSetFlags()[4] ? this.w : (renamingIssue.encoders.relayConsensus.W) defaultValue(fields()[4]);
        }
        if (pBuilder != null) {
          record.p = this.pBuilder.build();
        } else {
          record.p = fieldSetFlags()[5] ? this.p : (renamingIssue.encoders.relayConsensus.Policy) defaultValue(fields()[5]);
        }
        return record;
      } catch (Exception e) {
