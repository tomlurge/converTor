...
public class DirFooter extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** metrics-lib/RelayNetworkStatusConsensus:
        SortedMap<String, DirectorySignature> getDirectorySignatures() */
  @Deprecated public java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.DirSig> directory_signature;
   ...
   * @param directory_signature metrics-lib/RelayNetworkStatusConsensus:
        SortedMap<String, DirectorySignature> getDirectorySignatures()
   */
  public DirFooter(java.util.Map<java.lang.String,java.lang.Integer> bandwidth_weights, java.lang.String consensus_digest, java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.DirSig> directory_signature) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: directory_signature = (java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.DirSig>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return metrics-lib/RelayNetworkStatusConsensus:
        SortedMap<String, DirectorySignature> getDirectorySignatures()
   */
  public java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.DirSig> getDirectorySignature() {
   ...
   * @param value the value to set.
   */
  public void setDirectorySignature(java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.DirSig> value) {
   ...
   */
  public static renamingIssue.encoders.relayConsensus.DirFooter.Builder newBuilder() {
    return new renamingIssue.encoders.relayConsensus.DirFooter.Builder();
  }
   ...
   * @return A new DirFooter RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.DirFooter.Builder newBuilder(renamingIssue.encoders.relayConsensus.DirFooter.Builder other) {
    return new renamingIssue.encoders.relayConsensus.DirFooter.Builder(other);
  }
   ...
   * @return A new DirFooter RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.DirFooter.Builder newBuilder(renamingIssue.encoders.relayConsensus.DirFooter other) {
    return new renamingIssue.encoders.relayConsensus.DirFooter.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirFooter>
    ...
    /** metrics-lib/RelayNetworkStatusConsensus:
        SortedMap<String, DirectorySignature> getDirectorySignatures() */
    private java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.DirSig> directory_signature;

    /** Creates a new Builder */
    private Builder() {
      super(renamingIssue.encoders.relayConsensus.DirFooter.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.DirFooter.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.DirFooter other) {
            super(renamingIssue.encoders.relayConsensus.DirFooter.SCHEMA$);
      if (isValidValue(fields()[0], other.bandwidth_weights)) {
        this.bandwidth_weights = data().deepCopy(fields()[0].schema(), other.bandwidth_weights);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirFooter.Builder setBandwidthWeights(java.util.Map<java.lang.String,java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirFooter.Builder clearBandwidthWeights() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirFooter.Builder setConsensusDigest(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirFooter.Builder clearConsensusDigest() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirFooter.Builder setDirectorySignature(java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.DirSig> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirFooter.Builder clearDirectorySignature() {
    ...
    public DirFooter build() {
      try {
        ...
        record.directory_signature = fieldSetFlags()[2] ? this.directory_signature : (java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.DirSig>) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
