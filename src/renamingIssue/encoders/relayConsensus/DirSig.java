...
public class DirSig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.relayConsensus.DirSig.Builder newBuilder() {
    return new renamingIssue.encoders.relayConsensus.DirSig.Builder();
  }
   ...
   * @return A new DirSig RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.DirSig.Builder newBuilder(renamingIssue.encoders.relayConsensus.DirSig.Builder other) {
    return new renamingIssue.encoders.relayConsensus.DirSig.Builder(other);
  }
   ...
   * @return A new DirSig RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.DirSig.Builder newBuilder(renamingIssue.encoders.relayConsensus.DirSig other) {
    return new renamingIssue.encoders.relayConsensus.DirSig.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirSig>
    ...
    private Builder() {
      super(renamingIssue.encoders.relayConsensus.DirSig.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.DirSig.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.DirSig other) {
            super(renamingIssue.encoders.relayConsensus.DirSig.SCHEMA$);
      if (isValidValue(fields()[0], other.algorithm)) {
        this.algorithm = data().deepCopy(fields()[0].schema(), other.algorithm);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirSig.Builder setAlgorithm(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirSig.Builder clearAlgorithm() {
      algorithm = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirSig.Builder setIdentity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirSig.Builder clearIdentity() {
      identity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirSig.Builder setSigningKeyDigest(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirSig.Builder clearSigningKeyDigest() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirSig.Builder setSignature(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.DirSig.Builder clearSignature() {
      signature = null;
