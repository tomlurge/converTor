...
public class OrAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5298825499435799776L;
   ...
   */
  public static renamingIssue.encoders.relayConsensus.OrAddress.Builder newBuilder() {
    return new renamingIssue.encoders.relayConsensus.OrAddress.Builder();
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.OrAddress.Builder newBuilder(renamingIssue.encoders.relayConsensus.OrAddress.Builder other) {
    return new renamingIssue.encoders.relayConsensus.OrAddress.Builder(other);
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.OrAddress.Builder newBuilder(renamingIssue.encoders.relayConsensus.OrAddress other) {
    return new renamingIssue.encoders.relayConsensus.OrAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrAddress>
    ...
    private Builder() {
      super(renamingIssue.encoders.relayConsensus.OrAddress.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.OrAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.OrAddress other) {
            super(renamingIssue.encoders.relayConsensus.OrAddress.SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.OrAddress.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.OrAddress.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.OrAddress.Builder setPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.OrAddress.Builder clearPort() {
      port = null;
