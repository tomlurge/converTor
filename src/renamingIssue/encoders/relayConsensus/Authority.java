...
public class Authority extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public renamingIssue.encoders.relayConsensus.DirSource dir_source;
   ...
   */
  public Authority(renamingIssue.encoders.relayConsensus.DirSource dir_source, java.lang.String contact, java.lang.String vote_digest) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: dir_source = (renamingIssue.encoders.relayConsensus.DirSource)value$; break;
   ...
   */
  public renamingIssue.encoders.relayConsensus.DirSource getDirSource() {
    return dir_source;
  }
   ...
   */
  public void setDirSource(renamingIssue.encoders.relayConsensus.DirSource value) {
   ...
   */
  public static renamingIssue.encoders.relayConsensus.Authority.Builder newBuilder() {
    return new renamingIssue.encoders.relayConsensus.Authority.Builder();
  }
   ...
   * @return A new Authority RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.Authority.Builder newBuilder(renamingIssue.encoders.relayConsensus.Authority.Builder other) {
    return new renamingIssue.encoders.relayConsensus.Authority.Builder(other);
  }
   ...
   * @return A new Authority RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.Authority.Builder newBuilder(renamingIssue.encoders.relayConsensus.Authority other) {
    return new renamingIssue.encoders.relayConsensus.Authority.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Authority>
    ...
    private renamingIssue.encoders.relayConsensus.DirSource dir_source;
    private renamingIssue.encoders.relayConsensus.DirSource.Builder dir_sourceBuilder;
    /** metrics-lib/DirSourceEntry: String getContactLine() */
    ...
    private Builder() {
      super(renamingIssue.encoders.relayConsensus.Authority.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.Authority.Builder other) {
      super(other);
      ...
      if (other.hasDirSourceBuilder()) {
        this.dir_sourceBuilder = renamingIssue.encoders.relayConsensus.DirSource.newBuilder(other.getDirSourceBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.Authority other) {
            super(renamingIssue.encoders.relayConsensus.Authority.SCHEMA$);
      if (isValidValue(fields()[0], other.dir_source)) {
        this.dir_source = data().deepCopy(fields()[0].schema(), other.dir_source);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Authority.Builder setDirSource(renamingIssue.encoders.relayConsensus.DirSource value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.DirSource.Builder getDirSourceBuilder() {
      if (dir_sourceBuilder == null) {
        if (hasDirSource()) {
          setDirSourceBuilder(renamingIssue.encoders.relayConsensus.DirSource.newBuilder(dir_source));
        } else {
          setDirSourceBuilder(renamingIssue.encoders.relayConsensus.DirSource.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.Authority.Builder setDirSourceBuilder(renamingIssue.encoders.relayConsensus.DirSource.Builder value) {
      clearDirSource();
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Authority.Builder clearDirSource() {
      dir_source = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Authority.Builder setContact(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Authority.Builder clearContact() {
      contact = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Authority.Builder setVoteDigest(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.Authority.Builder clearVoteDigest() {
      vote_digest = null;
    ...
    public Authority build() {
      try {
        ...
        if (dir_sourceBuilder != null) {
          ...
          record.dir_source = fieldSetFlags()[0] ? this.dir_source : (renamingIssue.encoders.relayConsensus.DirSource) defaultValue(fields()[0]);
        }
