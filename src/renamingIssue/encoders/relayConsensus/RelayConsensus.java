 ...
 */
package renamingIssue.encoders.relayConsensus;
...
public class RelayConsensus extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 788202194555393748L;
  ...
  @Deprecated public renamingIssue.encoders.relayConsensus.Vote voting_delay;
  ...
  @Deprecated public java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Authority> authorities;
  /** metrics-lib/RelayNetworkStatusConsensus:
        SortedMap<String, NetworkStatusEntry> getStatusEntries()
        status entries, one for each contained relay */
  @Deprecated public java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Status> status;
  @Deprecated public renamingIssue.encoders.relayConsensus.DirFooter directory_footer;
   ...
   * @param status metrics-lib/RelayNetworkStatusConsensus:
        ...
        status entries, one for each contained relay
   */
  public RelayConsensus(java.lang.String descriptor_type, java.lang.Integer network_status_version, java.lang.String vote_status, java.lang.Integer consensus_method, java.lang.String consensus_flavor, java.lang.Long valid_after, java.lang.Long fresh_until, java.lang.Long valid_until, renamingIssue.encoders.relayConsensus.Vote voting_delay, java.util.List<java.lang.String> client_versions, java.util.List<java.lang.String> server_versions, java.util.List<java.lang.String> known_flags, java.util.Map<java.lang.String,java.lang.Integer> params, java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Authority> authorities, java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Status> status, renamingIssue.encoders.relayConsensus.DirFooter directory_footer) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 8: voting_delay = (renamingIssue.encoders.relayConsensus.Vote)value$; break;
    ...
    case 13: authorities = (java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Authority>)value$; break;
    case 14: status = (java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Status>)value$; break;
    case 15: directory_footer = (renamingIssue.encoders.relayConsensus.DirFooter)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public renamingIssue.encoders.relayConsensus.Vote getVotingDelay() {
    return voting_delay;
  }
   ...
   * @param value the value to set.
   */
  public void setVotingDelay(renamingIssue.encoders.relayConsensus.Vote value) {
   ...
   * @return metrics-lib/RelayNetworkStatusConsensus:
        ...
        contained in this consensus
   */
  public java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Authority> getAuthorities() {
    return authorities;
  }
   ...
   * @param value the value to set.
   */
  public void setAuthorities(java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Authority> value) {
   ...
   * @return metrics-lib/RelayNetworkStatusConsensus:
        ...
        status entries, one for each contained relay
   */
  public java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Status> getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Status> value) {
    this.status = value;
  }
   ...
   */
  public renamingIssue.encoders.relayConsensus.DirFooter getDirectoryFooter() {
   ...
   * @param value the value to set.
   */
  public void setDirectoryFooter(renamingIssue.encoders.relayConsensus.DirFooter value) {
   ...
   */
  public static renamingIssue.encoders.relayConsensus.RelayConsensus.Builder newBuilder() {
    return new renamingIssue.encoders.relayConsensus.RelayConsensus.Builder();
  }
   ...
   * @return A new RelayConsensus RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.RelayConsensus.Builder newBuilder(renamingIssue.encoders.relayConsensus.RelayConsensus.Builder other) {
    return new renamingIssue.encoders.relayConsensus.RelayConsensus.Builder(other);
  }
   ...
   * @return A new RelayConsensus RecordBuilder
   */
  public static renamingIssue.encoders.relayConsensus.RelayConsensus.Builder newBuilder(renamingIssue.encoders.relayConsensus.RelayConsensus other) {
    return new renamingIssue.encoders.relayConsensus.RelayConsensus.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RelayConsensus>
    ...
    private renamingIssue.encoders.relayConsensus.Vote voting_delay;
    private renamingIssue.encoders.relayConsensus.Vote.Builder voting_delayBuilder;
    /** metrics-lib/RelayNetworkStatusConsensus:
        List<String> getRecommendedClientVersions() */
    ...
    /** metrics-lib/RelayNetworkStatusConsensus:
        ...
        dir-source entries representing the directories of which votes are
        contained in this consensus */
    private java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Authority> authorities;
    /** metrics-lib/RelayNetworkStatusConsensus:
        SortedMap<String, NetworkStatusEntry> getStatusEntries()
        status entries, one for each contained relay */
    private java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Status> status;
    private renamingIssue.encoders.relayConsensus.DirFooter directory_footer;
    private renamingIssue.encoders.relayConsensus.DirFooter.Builder directory_footerBuilder;

    /** Creates a new Builder */
    private Builder() {
      super(renamingIssue.encoders.relayConsensus.RelayConsensus.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.RelayConsensus.Builder other) {
      super(other);
      ...
      if (other.hasVotingDelayBuilder()) {
        this.voting_delayBuilder = renamingIssue.encoders.relayConsensus.Vote.newBuilder(other.getVotingDelayBuilder());
      }
      ...
      if (other.hasDirectoryFooterBuilder()) {
        this.directory_footerBuilder = renamingIssue.encoders.relayConsensus.DirFooter.newBuilder(other.getDirectoryFooterBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayConsensus.RelayConsensus other) {
            super(renamingIssue.encoders.relayConsensus.RelayConsensus.SCHEMA$);
      if (isValidValue(fields()[0], other.descriptor_type)) {
        this.descriptor_type = data().deepCopy(fields()[0].schema(), other.descriptor_type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setDescriptorType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearDescriptorType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setNetworkStatusVersion(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearNetworkStatusVersion() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setVoteStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearVoteStatus() {
      vote_status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setConsensusMethod(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearConsensusMethod() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setConsensusFlavor(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearConsensusFlavor() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setValidAfter(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearValidAfter() {
      valid_after = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setFreshUntil(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearFreshUntil() {
      fresh_until = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setValidUntil(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearValidUntil() {
      valid_until = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setVotingDelay(renamingIssue.encoders.relayConsensus.Vote value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.Vote.Builder getVotingDelayBuilder() {
      if (voting_delayBuilder == null) {
        if (hasVotingDelay()) {
          setVotingDelayBuilder(renamingIssue.encoders.relayConsensus.Vote.newBuilder(voting_delay));
        } else {
          setVotingDelayBuilder(renamingIssue.encoders.relayConsensus.Vote.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setVotingDelayBuilder(renamingIssue.encoders.relayConsensus.Vote.Builder value) {
      clearVotingDelay();
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearVotingDelay() {
      voting_delay = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setClientVersions(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearClientVersions() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setServerVersions(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearServerVersions() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setKnownFlags(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearKnownFlags() {
      known_flags = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setParams(java.util.Map<java.lang.String,java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearParams() {
      params = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setAuthorities(java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Authority> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearAuthorities() {
      authorities = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setStatus(java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Status> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setDirectoryFooter(renamingIssue.encoders.relayConsensus.DirFooter value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.DirFooter.Builder getDirectoryFooterBuilder() {
      if (directory_footerBuilder == null) {
        if (hasDirectoryFooter()) {
          setDirectoryFooterBuilder(renamingIssue.encoders.relayConsensus.DirFooter.newBuilder(directory_footer));
        } else {
          setDirectoryFooterBuilder(renamingIssue.encoders.relayConsensus.DirFooter.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder setDirectoryFooterBuilder(renamingIssue.encoders.relayConsensus.DirFooter.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayConsensus.RelayConsensus.Builder clearDirectoryFooter() {
    ...
    public RelayConsensus build() {
      try {
        ...
        if (voting_delayBuilder != null) {
          ...
          record.voting_delay = fieldSetFlags()[8] ? this.voting_delay : (renamingIssue.encoders.relayConsensus.Vote) defaultValue(fields()[8]);
        }
        ...
        record.authorities = fieldSetFlags()[13] ? this.authorities : (java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Authority>) defaultValue(fields()[13]);
        record.status = fieldSetFlags()[14] ? this.status : (java.util.Map<java.lang.String, renamingIssue.encoders.relayConsensus.Status>) defaultValue(fields()[14]);
        if (directory_footerBuilder != null) {
          record.directory_footer = this.directory_footerBuilder.build();
        } else {
          record.directory_footer = fieldSetFlags()[15] ? this.directory_footer : (renamingIssue.encoders.relayConsensus.DirFooter) defaultValue(fields()[15]);
        }
        return record;
      } catch (Exception e) {
