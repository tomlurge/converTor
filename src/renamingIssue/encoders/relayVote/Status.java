...
public class Status extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public renamingIssue.encoders.relayVote.R r;
  @Deprecated public java.util.List<renamingIssue.encoders.relayVote.OrAddress> a;
  ...
  /** see above */
  @Deprecated public renamingIssue.encoders.relayVote.W w;
  /** see above */
  @Deprecated public renamingIssue.encoders.relayVote.Policy p;
  /** see above */
  @Deprecated public renamingIssue.encoders.relayVote.ID id;
   ...
   * @param id see above
   */
  public Status(renamingIssue.encoders.relayVote.R r, java.util.List<renamingIssue.encoders.relayVote.OrAddress> a, java.util.List<java.lang.String> s, java.lang.String v, renamingIssue.encoders.relayVote.W w, renamingIssue.encoders.relayVote.Policy p, renamingIssue.encoders.relayVote.ID id) {
    this.r = r;
    this.a = a;
    this.s = s;
    this.v = v;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: r = (renamingIssue.encoders.relayVote.R)value$; break;
    case 1: a = (java.util.List<renamingIssue.encoders.relayVote.OrAddress>)value$; break;
    case 2: s = (java.util.List<java.lang.String>)value$; break;
    case 3: v = (java.lang.String)value$; break;
    case 4: w = (renamingIssue.encoders.relayVote.W)value$; break;
    case 5: p = (renamingIssue.encoders.relayVote.Policy)value$; break;
    case 6: id = (renamingIssue.encoders.relayVote.ID)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public renamingIssue.encoders.relayVote.R getR() {
    return r;
  }
   ...
   */
  public void setR(renamingIssue.encoders.relayVote.R value) {
    this.r = value;
  }
   ...
   */
  public java.util.List<renamingIssue.encoders.relayVote.OrAddress> getA() {
    return a;
  }
   ...
   * @param value the value to set.
   */
  public void setA(java.util.List<renamingIssue.encoders.relayVote.OrAddress> value) {
    this.a = value;
  }
   ...
   * @return see above
   */
  public renamingIssue.encoders.relayVote.W getW() {
    return w;
  }
   ...
   * @param value the value to set.
   */
  public void setW(renamingIssue.encoders.relayVote.W value) {
    this.w = value;
  }
   ...
   * @return see above
   */
  public renamingIssue.encoders.relayVote.Policy getP() {
    return p;
  }
   ...
   * @param value the value to set.
   */
  public void setP(renamingIssue.encoders.relayVote.Policy value) {
    this.p = value;
  }
   ...
   * @return see above
   */
  public renamingIssue.encoders.relayVote.ID getId() {
    return id;
  }
   ...
   * @param value the value to set.
   */
  public void setId(renamingIssue.encoders.relayVote.ID value) {
    this.id = value;
  }
   ...
   */
  public static renamingIssue.encoders.relayVote.Status.Builder newBuilder() {
    return new renamingIssue.encoders.relayVote.Status.Builder();
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static renamingIssue.encoders.relayVote.Status.Builder newBuilder(renamingIssue.encoders.relayVote.Status.Builder other) {
    return new renamingIssue.encoders.relayVote.Status.Builder(other);
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static renamingIssue.encoders.relayVote.Status.Builder newBuilder(renamingIssue.encoders.relayVote.Status other) {
    return new renamingIssue.encoders.relayVote.Status.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Status>
    ...
    private renamingIssue.encoders.relayVote.R r;
    private renamingIssue.encoders.relayVote.R.Builder rBuilder;
    private java.util.List<renamingIssue.encoders.relayVote.OrAddress> a;
    /** metrics-lib/NetworkStatusEntry: SortedSet<String> getFlags() */
    private java.util.List<java.lang.String> s;
    /** metrics-lib/NetworkStatusEntry: String getVersion() */
    private java.lang.String v;
    /** see above */
    private renamingIssue.encoders.relayVote.W w;
    private renamingIssue.encoders.relayVote.W.Builder wBuilder;
    /** see above */
    private renamingIssue.encoders.relayVote.Policy p;
    private renamingIssue.encoders.relayVote.Policy.Builder pBuilder;
    /** see above */
    private renamingIssue.encoders.relayVote.ID id;
    private renamingIssue.encoders.relayVote.ID.Builder idBuilder;

    /** Creates a new Builder */
    private Builder() {
      super(renamingIssue.encoders.relayVote.Status.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayVote.Status.Builder other) {
      super(other);
      ...
      if (other.hasRBuilder()) {
        this.rBuilder = renamingIssue.encoders.relayVote.R.newBuilder(other.getRBuilder());
      }
      ...
      if (other.hasWBuilder()) {
        this.wBuilder = renamingIssue.encoders.relayVote.W.newBuilder(other.getWBuilder());
      }
      ...
      if (other.hasPBuilder()) {
        this.pBuilder = renamingIssue.encoders.relayVote.Policy.newBuilder(other.getPBuilder());
      }
      ...
      if (other.hasIdBuilder()) {
        this.idBuilder = renamingIssue.encoders.relayVote.ID.newBuilder(other.getIdBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayVote.Status other) {
            super(renamingIssue.encoders.relayVote.Status.SCHEMA$);
      if (isValidValue(fields()[0], other.r)) {
        this.r = data().deepCopy(fields()[0].schema(), other.r);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder setR(renamingIssue.encoders.relayVote.R value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.R.Builder getRBuilder() {
      if (rBuilder == null) {
        if (hasR()) {
          setRBuilder(renamingIssue.encoders.relayVote.R.newBuilder(r));
        } else {
          setRBuilder(renamingIssue.encoders.relayVote.R.newBuilder());
        }
      }
      return rBuilder;
    }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.Status.Builder setRBuilder(renamingIssue.encoders.relayVote.R.Builder value) {
      clearR();
      rBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder clearR() {
      r = null;
      rBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder setA(java.util.List<renamingIssue.encoders.relayVote.OrAddress> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder clearA() {
      a = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder setS(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder clearS() {
      s = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder setV(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder clearV() {
      v = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder setW(renamingIssue.encoders.relayVote.W value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.W.Builder getWBuilder() {
      if (wBuilder == null) {
        if (hasW()) {
          setWBuilder(renamingIssue.encoders.relayVote.W.newBuilder(w));
        } else {
          setWBuilder(renamingIssue.encoders.relayVote.W.newBuilder());
        }
      }
      return wBuilder;
    }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.Status.Builder setWBuilder(renamingIssue.encoders.relayVote.W.Builder value) {
      clearW();
      wBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder clearW() {
      w = null;
      wBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder setP(renamingIssue.encoders.relayVote.Policy value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.Policy.Builder getPBuilder() {
      if (pBuilder == null) {
        if (hasP()) {
          setPBuilder(renamingIssue.encoders.relayVote.Policy.newBuilder(p));
        } else {
          setPBuilder(renamingIssue.encoders.relayVote.Policy.newBuilder());
        }
      }
      return pBuilder;
    }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.Status.Builder setPBuilder(renamingIssue.encoders.relayVote.Policy.Builder value) {
      clearP();
      pBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder clearP() {
      p = null;
      pBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder setId(renamingIssue.encoders.relayVote.ID value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.ID.Builder getIdBuilder() {
      if (idBuilder == null) {
        if (hasId()) {
          setIdBuilder(renamingIssue.encoders.relayVote.ID.newBuilder(id));
        } else {
          setIdBuilder(renamingIssue.encoders.relayVote.ID.newBuilder());
        }
      }
      return idBuilder;
    }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.Status.Builder setIdBuilder(renamingIssue.encoders.relayVote.ID.Builder value) {
      clearId();
      idBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Status.Builder clearId() {
      id = null;
      idBuilder = null;
    ...
    public Status build() {
      try {
        ...
        if (rBuilder != null) {
          ...
          record.r = fieldSetFlags()[0] ? this.r : (renamingIssue.encoders.relayVote.R) defaultValue(fields()[0]);
        }
        record.a = fieldSetFlags()[1] ? this.a : (java.util.List<renamingIssue.encoders.relayVote.OrAddress>) defaultValue(fields()[1]);
        ...
        if (wBuilder != null) {
          ...
          record.w = fieldSetFlags()[4] ? this.w : (renamingIssue.encoders.relayVote.W) defaultValue(fields()[4]);
        }
        if (pBuilder != null) {
          record.p = this.pBuilder.build();
        } else {
          record.p = fieldSetFlags()[5] ? this.p : (renamingIssue.encoders.relayVote.Policy) defaultValue(fields()[5]);
        }
        if (idBuilder != null) {
          record.id = this.idBuilder.build();
        } else {
          record.id = fieldSetFlags()[6] ? this.id : (renamingIssue.encoders.relayVote.ID) defaultValue(fields()[6]);
        }
        return record;
      } catch (Exception e) {
