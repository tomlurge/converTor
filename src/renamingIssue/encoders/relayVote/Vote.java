...
public class Vote extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.relayVote.Vote.Builder newBuilder() {
    return new renamingIssue.encoders.relayVote.Vote.Builder();
  }
   ...
   * @return A new Vote RecordBuilder
   */
  public static renamingIssue.encoders.relayVote.Vote.Builder newBuilder(renamingIssue.encoders.relayVote.Vote.Builder other) {
    return new renamingIssue.encoders.relayVote.Vote.Builder(other);
  }
   ...
   * @return A new Vote RecordBuilder
   */
  public static renamingIssue.encoders.relayVote.Vote.Builder newBuilder(renamingIssue.encoders.relayVote.Vote other) {
    return new renamingIssue.encoders.relayVote.Vote.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Vote>
    ...
    private Builder() {
      super(renamingIssue.encoders.relayVote.Vote.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayVote.Vote.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayVote.Vote other) {
            super(renamingIssue.encoders.relayVote.Vote.SCHEMA$);
      if (isValidValue(fields()[0], other.vote_seconds)) {
        this.vote_seconds = data().deepCopy(fields()[0].schema(), other.vote_seconds);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Vote.Builder setVoteSeconds(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Vote.Builder clearVoteSeconds() {
      vote_seconds = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Vote.Builder setDistSeconds(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.Vote.Builder clearDistSeconds() {
      dist_seconds = null;
