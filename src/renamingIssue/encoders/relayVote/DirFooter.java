...
public class DirFooter extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** metrics-lib/RelayNetworkStatusVote:
        SortedMap<String, DirectorySignature> getDirectorySignatures() */
  @Deprecated public renamingIssue.encoders.relayVote.DirSig directory_signature;
   ...
   * @param directory_signature metrics-lib/RelayNetworkStatusVote:
        SortedMap<String, DirectorySignature> getDirectorySignatures()
   */
  public DirFooter(renamingIssue.encoders.relayVote.DirSig directory_signature) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: directory_signature = (renamingIssue.encoders.relayVote.DirSig)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return metrics-lib/RelayNetworkStatusVote:
        SortedMap<String, DirectorySignature> getDirectorySignatures()
   */
  public renamingIssue.encoders.relayVote.DirSig getDirectorySignature() {
   ...
   */
  public void setDirectorySignature(renamingIssue.encoders.relayVote.DirSig value) {
   ...
   */
  public static renamingIssue.encoders.relayVote.DirFooter.Builder newBuilder() {
    return new renamingIssue.encoders.relayVote.DirFooter.Builder();
  }
   ...
   * @return A new DirFooter RecordBuilder
   */
  public static renamingIssue.encoders.relayVote.DirFooter.Builder newBuilder(renamingIssue.encoders.relayVote.DirFooter.Builder other) {
    return new renamingIssue.encoders.relayVote.DirFooter.Builder(other);
  }
   ...
   * @return A new DirFooter RecordBuilder
   */
  public static renamingIssue.encoders.relayVote.DirFooter.Builder newBuilder(renamingIssue.encoders.relayVote.DirFooter other) {
    return new renamingIssue.encoders.relayVote.DirFooter.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirFooter>
    ...
    /** metrics-lib/RelayNetworkStatusVote:
        SortedMap<String, DirectorySignature> getDirectorySignatures() */
    private renamingIssue.encoders.relayVote.DirSig directory_signature;
    private renamingIssue.encoders.relayVote.DirSig.Builder directory_signatureBuilder;

    /** Creates a new Builder */
    private Builder() {
      super(renamingIssue.encoders.relayVote.DirFooter.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayVote.DirFooter.Builder other) {
      super(other);
      ...
      if (other.hasDirectorySignatureBuilder()) {
        this.directory_signatureBuilder = renamingIssue.encoders.relayVote.DirSig.newBuilder(other.getDirectorySignatureBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayVote.DirFooter other) {
            super(renamingIssue.encoders.relayVote.DirFooter.SCHEMA$);
      if (isValidValue(fields()[0], other.directory_signature)) {
        this.directory_signature = data().deepCopy(fields()[0].schema(), other.directory_signature);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.DirFooter.Builder setDirectorySignature(renamingIssue.encoders.relayVote.DirSig value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.DirSig.Builder getDirectorySignatureBuilder() {
      if (directory_signatureBuilder == null) {
        if (hasDirectorySignature()) {
          setDirectorySignatureBuilder(renamingIssue.encoders.relayVote.DirSig.newBuilder(directory_signature));
        } else {
          setDirectorySignatureBuilder(renamingIssue.encoders.relayVote.DirSig.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.DirFooter.Builder setDirectorySignatureBuilder(renamingIssue.encoders.relayVote.DirSig.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.DirFooter.Builder clearDirectorySignature() {
    ...
    public DirFooter build() {
      try {
        ...
        if (directory_signatureBuilder != null) {
          ...
          record.directory_signature = fieldSetFlags()[0] ? this.directory_signature : (renamingIssue.encoders.relayVote.DirSig) defaultValue(fields()[0]);
        }
        return record;
      } catch (Exception e) {
