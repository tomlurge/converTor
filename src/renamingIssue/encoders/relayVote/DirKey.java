...
public class DirKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.relayVote.DirKey.Builder newBuilder() {
    return new renamingIssue.encoders.relayVote.DirKey.Builder();
  }
   ...
   * @return A new DirKey RecordBuilder
   */
  public static renamingIssue.encoders.relayVote.DirKey.Builder newBuilder(renamingIssue.encoders.relayVote.DirKey.Builder other) {
    return new renamingIssue.encoders.relayVote.DirKey.Builder(other);
  }
   ...
   * @return A new DirKey RecordBuilder
   */
  public static renamingIssue.encoders.relayVote.DirKey.Builder newBuilder(renamingIssue.encoders.relayVote.DirKey other) {
    return new renamingIssue.encoders.relayVote.DirKey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirKey>
    ...
    private Builder() {
      super(renamingIssue.encoders.relayVote.DirKey.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayVote.DirKey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayVote.DirKey other) {
            super(renamingIssue.encoders.relayVote.DirKey.SCHEMA$);
      if (isValidValue(fields()[0], other.version)) {
        this.version = data().deepCopy(fields()[0].schema(), other.version);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.DirKey.Builder setVersion(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.DirKey.Builder clearVersion() {
      version = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.DirKey.Builder setDirKeyPublished(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.DirKey.Builder clearDirKeyPublished() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.DirKey.Builder setDirKeyExpires(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.DirKey.Builder clearDirKeyExpires() {
