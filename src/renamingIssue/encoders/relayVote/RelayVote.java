...
public class RelayVote extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** see above */
  @Deprecated public renamingIssue.encoders.relayVote.FlagTresholds flag_tresholds;
  ...
  /** see above */
  @Deprecated public renamingIssue.encoders.relayVote.Vote voting_delay;
  /** metrics-lib/RelayNetworkStatusVote:
  ...
  /** see above */
  @Deprecated public renamingIssue.encoders.relayVote.DirSource dir_source;
  ...
  /** see above */
  @Deprecated public renamingIssue.encoders.relayVote.DirKey directory_key;
  /** metrics-lib/RelayNetworkStatusVote:
        SortedMap<String, NetworkStatusEntry> getStatusEntries() */
  @Deprecated public java.util.Map<java.lang.String, renamingIssue.encoders.relayVote.Status> status;
  /** see above */
  @Deprecated public renamingIssue.encoders.relayVote.DirFooter directory_footer;
   ...
   */
  public RelayVote(java.lang.String descriptor_type, java.lang.Integer network_status_version, java.lang.String vote_status, java.util.List<java.lang.Integer> consensus_methods, java.lang.Long published, java.lang.Long valid_after, renamingIssue.encoders.relayVote.FlagTresholds flag_tresholds, java.lang.Long fresh_until, java.lang.Long valid_until, renamingIssue.encoders.relayVote.Vote voting_delay, java.util.List<java.lang.String> client_versions, java.util.List<java.lang.String> server_versions, java.util.List<java.lang.String> known_flags, java.util.Map<java.lang.String,java.lang.Integer> params, renamingIssue.encoders.relayVote.DirSource dir_source, java.lang.String contact, java.lang.String legacy_dir_key, renamingIssue.encoders.relayVote.DirKey directory_key, java.util.Map<java.lang.String, renamingIssue.encoders.relayVote.Status> status, renamingIssue.encoders.relayVote.DirFooter directory_footer, java.lang.String signing_key_digest) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: flag_tresholds = (renamingIssue.encoders.relayVote.FlagTresholds)value$; break;
    case 7: fresh_until = (java.lang.Long)value$; break;
    case 8: valid_until = (java.lang.Long)value$; break;
    case 9: voting_delay = (renamingIssue.encoders.relayVote.Vote)value$; break;
    ...
    case 14: dir_source = (renamingIssue.encoders.relayVote.DirSource)value$; break;
    case 15: contact = (java.lang.String)value$; break;
    case 16: legacy_dir_key = (java.lang.String)value$; break;
    case 17: directory_key = (renamingIssue.encoders.relayVote.DirKey)value$; break;
    case 18: status = (java.util.Map<java.lang.String, renamingIssue.encoders.relayVote.Status>)value$; break;
    case 19: directory_footer = (renamingIssue.encoders.relayVote.DirFooter)value$; break;
   ...
   * @return see above
   */
  public renamingIssue.encoders.relayVote.FlagTresholds getFlagTresholds() {
   ...
   * @param value the value to set.
   */
  public void setFlagTresholds(renamingIssue.encoders.relayVote.FlagTresholds value) {
   ...
   * @return see above
   */
  public renamingIssue.encoders.relayVote.Vote getVotingDelay() {
    return voting_delay;
  }
   ...
   * @param value the value to set.
   */
  public void setVotingDelay(renamingIssue.encoders.relayVote.Vote value) {
   ...
   * @return see above
   */
  public renamingIssue.encoders.relayVote.DirSource getDirSource() {
    return dir_source;
  }
   ...
   * @param value the value to set.
   */
  public void setDirSource(renamingIssue.encoders.relayVote.DirSource value) {
   ...
   * @return see above
   */
  public renamingIssue.encoders.relayVote.DirKey getDirectoryKey() {
   ...
   * @param value the value to set.
   */
  public void setDirectoryKey(renamingIssue.encoders.relayVote.DirKey value) {
   ...
   * @return metrics-lib/RelayNetworkStatusVote:
        SortedMap<String, NetworkStatusEntry> getStatusEntries()
   */
  public java.util.Map<java.lang.String, renamingIssue.encoders.relayVote.Status> getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(java.util.Map<java.lang.String, renamingIssue.encoders.relayVote.Status> value) {
    this.status = value;
  }
   ...
   * @return see above
   */
  public renamingIssue.encoders.relayVote.DirFooter getDirectoryFooter() {
   ...
   * @param value the value to set.
   */
  public void setDirectoryFooter(renamingIssue.encoders.relayVote.DirFooter value) {
   ...
   */
  public static renamingIssue.encoders.relayVote.RelayVote.Builder newBuilder() {
    return new renamingIssue.encoders.relayVote.RelayVote.Builder();
  }
   ...
   * @return A new RelayVote RecordBuilder
   */
  public static renamingIssue.encoders.relayVote.RelayVote.Builder newBuilder(renamingIssue.encoders.relayVote.RelayVote.Builder other) {
    return new renamingIssue.encoders.relayVote.RelayVote.Builder(other);
  }
   ...
   * @return A new RelayVote RecordBuilder
   */
  public static renamingIssue.encoders.relayVote.RelayVote.Builder newBuilder(renamingIssue.encoders.relayVote.RelayVote other) {
    return new renamingIssue.encoders.relayVote.RelayVote.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RelayVote>
    ...
    /** see above */
    private renamingIssue.encoders.relayVote.FlagTresholds flag_tresholds;
    private renamingIssue.encoders.relayVote.FlagTresholds.Builder flag_tresholdsBuilder;
    /** metrics-lib/RelayNetworkStatusVote: long getFreshUntilMillis() */
    private java.lang.Long fresh_until;
    /** metrics-lib/RelayNetworkStatusVote: long getValidUntilMillis() */
    private java.lang.Long valid_until;
    /** see above */
    private renamingIssue.encoders.relayVote.Vote voting_delay;
    private renamingIssue.encoders.relayVote.Vote.Builder voting_delayBuilder;
    /** metrics-lib/RelayNetworkStatusVote:
        List<String> getRecommendedClientVersions() */
    ...
    /** see above */
    private renamingIssue.encoders.relayVote.DirSource dir_source;
    private renamingIssue.encoders.relayVote.DirSource.Builder dir_sourceBuilder;
    /** metrics-lib/RelayNetworkStatusVote: String getContactLine() */
    private java.lang.String contact;
    /** metrics-lib/RelayNetworkStatusVote: String getLegacyDirKey() */
    private java.lang.String legacy_dir_key;
    /** see above */
    private renamingIssue.encoders.relayVote.DirKey directory_key;
    private renamingIssue.encoders.relayVote.DirKey.Builder directory_keyBuilder;
    /** metrics-lib/RelayNetworkStatusVote:
        SortedMap<String, NetworkStatusEntry> getStatusEntries() */
    private java.util.Map<java.lang.String, renamingIssue.encoders.relayVote.Status> status;
    /** see above */
    private renamingIssue.encoders.relayVote.DirFooter directory_footer;
    private renamingIssue.encoders.relayVote.DirFooter.Builder directory_footerBuilder;
    /** metrics-lib/RelayNetworkStatusVote: String getSigningKeyDigest() */
    private java.lang.String signing_key_digest;

    /** Creates a new Builder */
    private Builder() {
      super(renamingIssue.encoders.relayVote.RelayVote.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayVote.RelayVote.Builder other) {
      super(other);
      ...
      if (other.hasFlagTresholdsBuilder()) {
        this.flag_tresholdsBuilder = renamingIssue.encoders.relayVote.FlagTresholds.newBuilder(other.getFlagTresholdsBuilder());
      }
      ...
      if (other.hasVotingDelayBuilder()) {
        this.voting_delayBuilder = renamingIssue.encoders.relayVote.Vote.newBuilder(other.getVotingDelayBuilder());
      }
      ...
      if (other.hasDirSourceBuilder()) {
        this.dir_sourceBuilder = renamingIssue.encoders.relayVote.DirSource.newBuilder(other.getDirSourceBuilder());
      }
      ...
      if (other.hasDirectoryKeyBuilder()) {
        this.directory_keyBuilder = renamingIssue.encoders.relayVote.DirKey.newBuilder(other.getDirectoryKeyBuilder());
      }
      ...
      if (other.hasDirectoryFooterBuilder()) {
        this.directory_footerBuilder = renamingIssue.encoders.relayVote.DirFooter.newBuilder(other.getDirectoryFooterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayVote.RelayVote other) {
            super(renamingIssue.encoders.relayVote.RelayVote.SCHEMA$);
      if (isValidValue(fields()[0], other.descriptor_type)) {
        this.descriptor_type = data().deepCopy(fields()[0].schema(), other.descriptor_type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setDescriptorType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearDescriptorType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setNetworkStatusVersion(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearNetworkStatusVersion() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setVoteStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearVoteStatus() {
      vote_status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setConsensusMethods(java.util.List<java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearConsensusMethods() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setPublished(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearPublished() {
      published = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setValidAfter(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearValidAfter() {
      valid_after = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setFlagTresholds(renamingIssue.encoders.relayVote.FlagTresholds value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.FlagTresholds.Builder getFlagTresholdsBuilder() {
      if (flag_tresholdsBuilder == null) {
        if (hasFlagTresholds()) {
          setFlagTresholdsBuilder(renamingIssue.encoders.relayVote.FlagTresholds.newBuilder(flag_tresholds));
        } else {
          setFlagTresholdsBuilder(renamingIssue.encoders.relayVote.FlagTresholds.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setFlagTresholdsBuilder(renamingIssue.encoders.relayVote.FlagTresholds.Builder value) {
      clearFlagTresholds();
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearFlagTresholds() {
      flag_tresholds = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setFreshUntil(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearFreshUntil() {
      fresh_until = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setValidUntil(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearValidUntil() {
      valid_until = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setVotingDelay(renamingIssue.encoders.relayVote.Vote value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.Vote.Builder getVotingDelayBuilder() {
      if (voting_delayBuilder == null) {
        if (hasVotingDelay()) {
          setVotingDelayBuilder(renamingIssue.encoders.relayVote.Vote.newBuilder(voting_delay));
        } else {
          setVotingDelayBuilder(renamingIssue.encoders.relayVote.Vote.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setVotingDelayBuilder(renamingIssue.encoders.relayVote.Vote.Builder value) {
      clearVotingDelay();
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearVotingDelay() {
      voting_delay = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setClientVersions(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearClientVersions() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setServerVersions(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearServerVersions() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setKnownFlags(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearKnownFlags() {
      known_flags = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setParams(java.util.Map<java.lang.String,java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearParams() {
      params = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setDirSource(renamingIssue.encoders.relayVote.DirSource value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.DirSource.Builder getDirSourceBuilder() {
      if (dir_sourceBuilder == null) {
        if (hasDirSource()) {
          setDirSourceBuilder(renamingIssue.encoders.relayVote.DirSource.newBuilder(dir_source));
        } else {
          setDirSourceBuilder(renamingIssue.encoders.relayVote.DirSource.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setDirSourceBuilder(renamingIssue.encoders.relayVote.DirSource.Builder value) {
      clearDirSource();
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearDirSource() {
      dir_source = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setContact(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearContact() {
      contact = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setLegacyDirKey(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearLegacyDirKey() {
      legacy_dir_key = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setDirectoryKey(renamingIssue.encoders.relayVote.DirKey value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.DirKey.Builder getDirectoryKeyBuilder() {
      if (directory_keyBuilder == null) {
        if (hasDirectoryKey()) {
          setDirectoryKeyBuilder(renamingIssue.encoders.relayVote.DirKey.newBuilder(directory_key));
        } else {
          setDirectoryKeyBuilder(renamingIssue.encoders.relayVote.DirKey.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setDirectoryKeyBuilder(renamingIssue.encoders.relayVote.DirKey.Builder value) {
      clearDirectoryKey();
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearDirectoryKey() {
      directory_key = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setStatus(java.util.Map<java.lang.String, renamingIssue.encoders.relayVote.Status> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setDirectoryFooter(renamingIssue.encoders.relayVote.DirFooter value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.DirFooter.Builder getDirectoryFooterBuilder() {
      if (directory_footerBuilder == null) {
        if (hasDirectoryFooter()) {
          setDirectoryFooterBuilder(renamingIssue.encoders.relayVote.DirFooter.newBuilder(directory_footer));
        } else {
          setDirectoryFooterBuilder(renamingIssue.encoders.relayVote.DirFooter.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setDirectoryFooterBuilder(renamingIssue.encoders.relayVote.DirFooter.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearDirectoryFooter() {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder setSigningKeyDigest(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayVote.RelayVote.Builder clearSigningKeyDigest() {
    ...
    public RelayVote build() {
      try {
        ...
        if (flag_tresholdsBuilder != null) {
          ...
          record.flag_tresholds = fieldSetFlags()[6] ? this.flag_tresholds : (renamingIssue.encoders.relayVote.FlagTresholds) defaultValue(fields()[6]);
        }
        ...
        if (voting_delayBuilder != null) {
          ...
          record.voting_delay = fieldSetFlags()[9] ? this.voting_delay : (renamingIssue.encoders.relayVote.Vote) defaultValue(fields()[9]);
        }
        ...
        if (dir_sourceBuilder != null) {
          ...
          record.dir_source = fieldSetFlags()[14] ? this.dir_source : (renamingIssue.encoders.relayVote.DirSource) defaultValue(fields()[14]);
        }
        ...
        if (directory_keyBuilder != null) {
          ...
          record.directory_key = fieldSetFlags()[17] ? this.directory_key : (renamingIssue.encoders.relayVote.DirKey) defaultValue(fields()[17]);
        }
        record.status = fieldSetFlags()[18] ? this.status : (java.util.Map<java.lang.String, renamingIssue.encoders.relayVote.Status>) defaultValue(fields()[18]);
        if (directory_footerBuilder != null) {
          record.directory_footer = this.directory_footerBuilder.build();
        } else {
          record.directory_footer = fieldSetFlags()[19] ? this.directory_footer : (renamingIssue.encoders.relayVote.DirFooter) defaultValue(fields()[19]);
        }
