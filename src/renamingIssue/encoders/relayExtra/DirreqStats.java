...
public class DirreqStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.relayExtra.DirreqStats.Builder newBuilder() {
    return new renamingIssue.encoders.relayExtra.DirreqStats.Builder();
  }
   ...
   * @return A new DirreqStats RecordBuilder
   */
  public static renamingIssue.encoders.relayExtra.DirreqStats.Builder newBuilder(renamingIssue.encoders.relayExtra.DirreqStats.Builder other) {
    return new renamingIssue.encoders.relayExtra.DirreqStats.Builder(other);
  }
   ...
   * @return A new DirreqStats RecordBuilder
   */
  public static renamingIssue.encoders.relayExtra.DirreqStats.Builder newBuilder(renamingIssue.encoders.relayExtra.DirreqStats other) {
    return new renamingIssue.encoders.relayExtra.DirreqStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirreqStats>
    ...
    private Builder() {
      super(renamingIssue.encoders.relayExtra.DirreqStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayExtra.DirreqStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayExtra.DirreqStats other) {
            super(renamingIssue.encoders.relayExtra.DirreqStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.DirreqStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.DirreqStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.DirreqStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.DirreqStats.Builder clearInterval() {
      interval = null;
