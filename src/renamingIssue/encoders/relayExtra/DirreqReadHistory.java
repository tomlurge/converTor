...
public class DirreqReadHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder newBuilder() {
    return new renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder();
  }
   ...
   * @return A new DirreqReadHistory RecordBuilder
   */
  public static renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder newBuilder(renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder other) {
    return new renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder(other);
  }
   ...
   * @return A new DirreqReadHistory RecordBuilder
   */
  public static renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder newBuilder(renamingIssue.encoders.relayExtra.DirreqReadHistory other) {
    return new renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DirreqReadHistory>
    ...
    private Builder() {
      super(renamingIssue.encoders.relayExtra.DirreqReadHistory.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayExtra.DirreqReadHistory other) {
            super(renamingIssue.encoders.relayExtra.DirreqReadHistory.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder clearInterval() {
      interval = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder setBytes(java.util.List<java.lang.Long> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.DirreqReadHistory.Builder clearBytes() {
      bytes = null;
