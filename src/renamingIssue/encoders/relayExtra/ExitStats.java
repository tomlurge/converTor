...
public class ExitStats extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1799534543698769579L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ExitStats\",\"namespace\":\"convertor.encoders.relayExtra\",\"fields\":[{\"name\":\"date\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getExitStatsEndMillis()\"},{\"name\":\"interval\",\"type\":[\"null\",\"long\"],\"doc\":\"metrics-lib/ExtraInfoDescriptor: long getExitStatsIntervalLength()\"}]}");
   ...
   */
  public static renamingIssue.encoders.relayExtra.ExitStats.Builder newBuilder() {
    return new renamingIssue.encoders.relayExtra.ExitStats.Builder();
  }
   ...
   * @return A new ExitStats RecordBuilder
   */
  public static renamingIssue.encoders.relayExtra.ExitStats.Builder newBuilder(renamingIssue.encoders.relayExtra.ExitStats.Builder other) {
    return new renamingIssue.encoders.relayExtra.ExitStats.Builder(other);
  }
   ...
   * @return A new ExitStats RecordBuilder
   */
  public static renamingIssue.encoders.relayExtra.ExitStats.Builder newBuilder(renamingIssue.encoders.relayExtra.ExitStats other) {
    return new renamingIssue.encoders.relayExtra.ExitStats.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExitStats>
    ...
    private Builder() {
      super(renamingIssue.encoders.relayExtra.ExitStats.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayExtra.ExitStats.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayExtra.ExitStats other) {
            super(renamingIssue.encoders.relayExtra.ExitStats.SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.ExitStats.Builder setDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.ExitStats.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.ExitStats.Builder setInterval(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.ExitStats.Builder clearInterval() {
      interval = null;
