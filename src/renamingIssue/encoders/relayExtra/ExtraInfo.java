...
public class ExtraInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.relayExtra.ExtraInfo.Builder newBuilder() {
    return new renamingIssue.encoders.relayExtra.ExtraInfo.Builder();
  }
   ...
   * @return A new ExtraInfo RecordBuilder
   */
  public static renamingIssue.encoders.relayExtra.ExtraInfo.Builder newBuilder(renamingIssue.encoders.relayExtra.ExtraInfo.Builder other) {
    return new renamingIssue.encoders.relayExtra.ExtraInfo.Builder(other);
  }
   ...
   * @return A new ExtraInfo RecordBuilder
   */
  public static renamingIssue.encoders.relayExtra.ExtraInfo.Builder newBuilder(renamingIssue.encoders.relayExtra.ExtraInfo other) {
    return new renamingIssue.encoders.relayExtra.ExtraInfo.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExtraInfo>
    ...
    private Builder() {
      super(renamingIssue.encoders.relayExtra.ExtraInfo.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayExtra.ExtraInfo.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayExtra.ExtraInfo other) {
            super(renamingIssue.encoders.relayExtra.ExtraInfo.SCHEMA$);
      if (isValidValue(fields()[0], other.nickname)) {
        this.nickname = data().deepCopy(fields()[0].schema(), other.nickname);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.ExtraInfo.Builder setNickname(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.ExtraInfo.Builder clearNickname() {
      nickname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.ExtraInfo.Builder setFingerprint(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.ExtraInfo.Builder clearFingerprint() {
      fingerprint = null;
