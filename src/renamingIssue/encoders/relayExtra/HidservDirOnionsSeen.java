...
public class HidservDirOnionsSeen extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder newBuilder() {
    return new renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder();
  }
   ...
   * @return A new HidservDirOnionsSeen RecordBuilder
   */
  public static renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder newBuilder(renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder other) {
    return new renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder(other);
  }
   ...
   * @return A new HidservDirOnionsSeen RecordBuilder
   */
  public static renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder newBuilder(renamingIssue.encoders.relayExtra.HidservDirOnionsSeen other) {
    return new renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HidservDirOnionsSeen>
    ...
    private Builder() {
      super(renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relayExtra.HidservDirOnionsSeen other) {
            super(renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.SCHEMA$);
      if (isValidValue(fields()[0], other.onions)) {
        this.onions = data().deepCopy(fields()[0].schema(), other.onions);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder setOnions(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder clearOnions() {
      onions = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder setObfuscation(java.util.Map<java.lang.String,java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relayExtra.HidservDirOnionsSeen.Builder clearObfuscation() {
      obfuscation = null;
