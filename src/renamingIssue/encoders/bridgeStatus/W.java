...
public class W extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.bridgeStatus.W.Builder newBuilder() {
    return new renamingIssue.encoders.bridgeStatus.W.Builder();
  }
   ...
   * @return A new W RecordBuilder
   */
  public static renamingIssue.encoders.bridgeStatus.W.Builder newBuilder(renamingIssue.encoders.bridgeStatus.W.Builder other) {
    return new renamingIssue.encoders.bridgeStatus.W.Builder(other);
  }
   ...
   * @return A new W RecordBuilder
   */
  public static renamingIssue.encoders.bridgeStatus.W.Builder newBuilder(renamingIssue.encoders.bridgeStatus.W other) {
    return new renamingIssue.encoders.bridgeStatus.W.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<W>
    ...
    private Builder() {
      super(renamingIssue.encoders.bridgeStatus.W.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.bridgeStatus.W.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.bridgeStatus.W other) {
            super(renamingIssue.encoders.bridgeStatus.W.SCHEMA$);
      if (isValidValue(fields()[0], other.bandwidth)) {
        this.bandwidth = data().deepCopy(fields()[0].schema(), other.bandwidth);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.W.Builder setBandwidth(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.W.Builder clearBandwidth() {
      bandwidth = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.W.Builder setMeasured(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.W.Builder clearMeasured() {
      measured = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.W.Builder setUnmeasured(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.W.Builder clearUnmeasured() {
      unmeasured = null;
