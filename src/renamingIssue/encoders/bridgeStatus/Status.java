...
public class Status extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public renamingIssue.encoders.bridgeStatus.R r;
  /** metrics-lib/NetworkStatusEntry: getOrAddresses() */
  @Deprecated public java.util.List<renamingIssue.encoders.bridgeStatus.OrAddress> a;
  ...
  @Deprecated public renamingIssue.encoders.bridgeStatus.W w;
  @Deprecated public renamingIssue.encoders.bridgeStatus.Policy p;
   ...
   */
  public Status(renamingIssue.encoders.bridgeStatus.R r, java.util.List<renamingIssue.encoders.bridgeStatus.OrAddress> a, java.util.List<java.lang.String> s, java.lang.String v, renamingIssue.encoders.bridgeStatus.W w, renamingIssue.encoders.bridgeStatus.Policy p) {
    this.r = r;
    this.a = a;
    this.s = s;
    this.v = v;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: r = (renamingIssue.encoders.bridgeStatus.R)value$; break;
    case 1: a = (java.util.List<renamingIssue.encoders.bridgeStatus.OrAddress>)value$; break;
    case 2: s = (java.util.List<java.lang.String>)value$; break;
    case 3: v = (java.lang.String)value$; break;
    case 4: w = (renamingIssue.encoders.bridgeStatus.W)value$; break;
    case 5: p = (renamingIssue.encoders.bridgeStatus.Policy)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public renamingIssue.encoders.bridgeStatus.R getR() {
    return r;
  }
   ...
   */
  public void setR(renamingIssue.encoders.bridgeStatus.R value) {
    this.r = value;
  }
   ...
   */
  public java.util.List<renamingIssue.encoders.bridgeStatus.OrAddress> getA() {
    return a;
  }
   ...
   * @param value the value to set.
   */
  public void setA(java.util.List<renamingIssue.encoders.bridgeStatus.OrAddress> value) {
    this.a = value;
  }
   ...
   */
  public renamingIssue.encoders.bridgeStatus.W getW() {
    return w;
  }
   ...
   * @param value the value to set.
   */
  public void setW(renamingIssue.encoders.bridgeStatus.W value) {
    this.w = value;
  }
   ...
   */
  public renamingIssue.encoders.bridgeStatus.Policy getP() {
    return p;
  }
   ...
   * @param value the value to set.
   */
  public void setP(renamingIssue.encoders.bridgeStatus.Policy value) {
    this.p = value;
  }
   ...
   */
  public static renamingIssue.encoders.bridgeStatus.Status.Builder newBuilder() {
    return new renamingIssue.encoders.bridgeStatus.Status.Builder();
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static renamingIssue.encoders.bridgeStatus.Status.Builder newBuilder(renamingIssue.encoders.bridgeStatus.Status.Builder other) {
    return new renamingIssue.encoders.bridgeStatus.Status.Builder(other);
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static renamingIssue.encoders.bridgeStatus.Status.Builder newBuilder(renamingIssue.encoders.bridgeStatus.Status other) {
    return new renamingIssue.encoders.bridgeStatus.Status.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Status>
    ...
    private renamingIssue.encoders.bridgeStatus.R r;
    private renamingIssue.encoders.bridgeStatus.R.Builder rBuilder;
    /** metrics-lib/NetworkStatusEntry: getOrAddresses() */
    private java.util.List<renamingIssue.encoders.bridgeStatus.OrAddress> a;
    /** metrics-lib/NetworkStatusEntry: SortedSet<String> getFlags() */
    private java.util.List<java.lang.String> s;
    /** metrics-lib/NetworkStatusEntry: String getVersion() */
    private java.lang.String v;
    private renamingIssue.encoders.bridgeStatus.W w;
    private renamingIssue.encoders.bridgeStatus.W.Builder wBuilder;
    private renamingIssue.encoders.bridgeStatus.Policy p;
    private renamingIssue.encoders.bridgeStatus.Policy.Builder pBuilder;

    /** Creates a new Builder */
    private Builder() {
      super(renamingIssue.encoders.bridgeStatus.Status.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.bridgeStatus.Status.Builder other) {
      super(other);
      ...
      if (other.hasRBuilder()) {
        this.rBuilder = renamingIssue.encoders.bridgeStatus.R.newBuilder(other.getRBuilder());
      }
      ...
      if (other.hasWBuilder()) {
        this.wBuilder = renamingIssue.encoders.bridgeStatus.W.newBuilder(other.getWBuilder());
      }
      ...
      if (other.hasPBuilder()) {
        this.pBuilder = renamingIssue.encoders.bridgeStatus.Policy.newBuilder(other.getPBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.bridgeStatus.Status other) {
            super(renamingIssue.encoders.bridgeStatus.Status.SCHEMA$);
      if (isValidValue(fields()[0], other.r)) {
        this.r = data().deepCopy(fields()[0].schema(), other.r);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder setR(renamingIssue.encoders.bridgeStatus.R value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.bridgeStatus.R.Builder getRBuilder() {
      if (rBuilder == null) {
        if (hasR()) {
          setRBuilder(renamingIssue.encoders.bridgeStatus.R.newBuilder(r));
        } else {
          setRBuilder(renamingIssue.encoders.bridgeStatus.R.newBuilder());
        }
      }
      return rBuilder;
    }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.bridgeStatus.Status.Builder setRBuilder(renamingIssue.encoders.bridgeStatus.R.Builder value) {
      clearR();
      rBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder clearR() {
      r = null;
      rBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder setA(java.util.List<renamingIssue.encoders.bridgeStatus.OrAddress> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder clearA() {
      a = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder setS(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder clearS() {
      s = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder setV(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder clearV() {
      v = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder setW(renamingIssue.encoders.bridgeStatus.W value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.bridgeStatus.W.Builder getWBuilder() {
      if (wBuilder == null) {
        if (hasW()) {
          setWBuilder(renamingIssue.encoders.bridgeStatus.W.newBuilder(w));
        } else {
          setWBuilder(renamingIssue.encoders.bridgeStatus.W.newBuilder());
        }
      }
      return wBuilder;
    }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.bridgeStatus.Status.Builder setWBuilder(renamingIssue.encoders.bridgeStatus.W.Builder value) {
      clearW();
      wBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder clearW() {
      w = null;
      wBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder setP(renamingIssue.encoders.bridgeStatus.Policy value) {
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.bridgeStatus.Policy.Builder getPBuilder() {
      if (pBuilder == null) {
        if (hasP()) {
          setPBuilder(renamingIssue.encoders.bridgeStatus.Policy.newBuilder(p));
        } else {
          setPBuilder(renamingIssue.encoders.bridgeStatus.Policy.newBuilder());
        }
      }
      return pBuilder;
    }
     ...
     * @return This builder.
     */
    public renamingIssue.encoders.bridgeStatus.Status.Builder setPBuilder(renamingIssue.encoders.bridgeStatus.Policy.Builder value) {
      clearP();
      pBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Status.Builder clearP() {
      p = null;
      pBuilder = null;
    ...
    public Status build() {
      try {
        ...
        if (rBuilder != null) {
          ...
          record.r = fieldSetFlags()[0] ? this.r : (renamingIssue.encoders.bridgeStatus.R) defaultValue(fields()[0]);
        }
        record.a = fieldSetFlags()[1] ? this.a : (java.util.List<renamingIssue.encoders.bridgeStatus.OrAddress>) defaultValue(fields()[1]);
        ...
        if (wBuilder != null) {
          ...
          record.w = fieldSetFlags()[4] ? this.w : (renamingIssue.encoders.bridgeStatus.W) defaultValue(fields()[4]);
        }
        if (pBuilder != null) {
          record.p = this.pBuilder.build();
        } else {
          record.p = fieldSetFlags()[5] ? this.p : (renamingIssue.encoders.bridgeStatus.Policy) defaultValue(fields()[5]);
        }
        return record;
      } catch (Exception e) {
