...
public class OrAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.bridgeStatus.OrAddress.Builder newBuilder() {
    return new renamingIssue.encoders.bridgeStatus.OrAddress.Builder();
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static renamingIssue.encoders.bridgeStatus.OrAddress.Builder newBuilder(renamingIssue.encoders.bridgeStatus.OrAddress.Builder other) {
    return new renamingIssue.encoders.bridgeStatus.OrAddress.Builder(other);
  }
   ...
   * @return A new OrAddress RecordBuilder
   */
  public static renamingIssue.encoders.bridgeStatus.OrAddress.Builder newBuilder(renamingIssue.encoders.bridgeStatus.OrAddress other) {
    return new renamingIssue.encoders.bridgeStatus.OrAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrAddress>
    ...
    private Builder() {
      super(renamingIssue.encoders.bridgeStatus.OrAddress.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.bridgeStatus.OrAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.bridgeStatus.OrAddress other) {
            super(renamingIssue.encoders.bridgeStatus.OrAddress.SCHEMA$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.OrAddress.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.OrAddress.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.OrAddress.Builder setPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.OrAddress.Builder clearPort() {
      port = null;
