...
public class Policy extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.bridgeStatus.Policy.Builder newBuilder() {
    return new renamingIssue.encoders.bridgeStatus.Policy.Builder();
  }
   ...
   * @return A new Policy RecordBuilder
   */
  public static renamingIssue.encoders.bridgeStatus.Policy.Builder newBuilder(renamingIssue.encoders.bridgeStatus.Policy.Builder other) {
    return new renamingIssue.encoders.bridgeStatus.Policy.Builder(other);
  }
   ...
   * @return A new Policy RecordBuilder
   */
  public static renamingIssue.encoders.bridgeStatus.Policy.Builder newBuilder(renamingIssue.encoders.bridgeStatus.Policy other) {
    return new renamingIssue.encoders.bridgeStatus.Policy.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Policy>
    ...
    private Builder() {
      super(renamingIssue.encoders.bridgeStatus.Policy.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.bridgeStatus.Policy.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.bridgeStatus.Policy other) {
            super(renamingIssue.encoders.bridgeStatus.Policy.SCHEMA$);
      if (isValidValue(fields()[0], other.default_policy)) {
        this.default_policy = data().deepCopy(fields()[0].schema(), other.default_policy);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Policy.Builder setDefaultPolicy(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Policy.Builder clearDefaultPolicy() {
      default_policy = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Policy.Builder setPortSummary(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.bridgeStatus.Policy.Builder clearPortSummary() {
      port_summary = null;
