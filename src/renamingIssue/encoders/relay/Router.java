...
public class Router extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static renamingIssue.encoders.relay.Router.Builder newBuilder() {
    return new renamingIssue.encoders.relay.Router.Builder();
  }
   ...
   * @return A new Router RecordBuilder
   */
  public static renamingIssue.encoders.relay.Router.Builder newBuilder(renamingIssue.encoders.relay.Router.Builder other) {
    return new renamingIssue.encoders.relay.Router.Builder(other);
  }
   ...
   * @return A new Router RecordBuilder
   */
  public static renamingIssue.encoders.relay.Router.Builder newBuilder(renamingIssue.encoders.relay.Router other) {
    return new renamingIssue.encoders.relay.Router.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Router>
    ...
    private Builder() {
      super(renamingIssue.encoders.relay.Router.SCHEMA$);
    }
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(renamingIssue.encoders.relay.Router.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(renamingIssue.encoders.relay.Router other) {
            super(renamingIssue.encoders.relay.Router.SCHEMA$);
      if (isValidValue(fields()[0], other.nickname)) {
        this.nickname = data().deepCopy(fields()[0].schema(), other.nickname);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relay.Router.Builder setNickname(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relay.Router.Builder clearNickname() {
      nickname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relay.Router.Builder setAddress(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relay.Router.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relay.Router.Builder setOrPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relay.Router.Builder clearOrPort() {
      or_port = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relay.Router.Builder setSocksPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relay.Router.Builder clearSocksPort() {
      socks_port = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relay.Router.Builder setDirPort(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public renamingIssue.encoders.relay.Router.Builder clearDirPort() {
      dir_port = null;
